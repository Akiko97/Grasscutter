...
public final class BuoyantCombatGallerySettleInfoOuterClass {
  ...
  public interface BuoyantCombatGallerySettleInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_HLFHLPEKOML = 7;</code>
     * @return The unk3250HLFHLPEKOML.
     */
    int getUnk3250HLFHLPEKOML();
    ...
    /**
     * <code>uint32 Unk3250_KPCJBOOGEMG = 10;</code>
     * @return The unk3250KPCJBOOGEMG.
     */
    int getUnk3250KPCJBOOGEMG();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250HLFHLPEKOML_ = input.readUInt32();
              break;
            }
            case 72: {
            ...
            case 80: {
              ...
              unk3250KPCJBOOGEMG_ = input.readUInt32();
              break;
            }
            case 88: {
    ...
    public static final int UNK3250_HLFHLPEKOML_FIELD_NUMBER = 7;
    private int unk3250HLFHLPEKOML_;
    /**
     * <code>uint32 Unk3250_HLFHLPEKOML = 7;</code>
     * @return The unk3250HLFHLPEKOML.
     */
    @java.lang.Override
    public int getUnk3250HLFHLPEKOML() {
      return unk3250HLFHLPEKOML_;
    }
    ...
    public static final int UNK3250_KPCJBOOGEMG_FIELD_NUMBER = 10;
    private int unk3250KPCJBOOGEMG_;
    /**
     * <code>uint32 Unk3250_KPCJBOOGEMG = 10;</code>
     * @return The unk3250KPCJBOOGEMG.
     */
    @java.lang.Override
    public int getUnk3250KPCJBOOGEMG() {
      return unk3250KPCJBOOGEMG_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250HLFHLPEKOML_ != 0) {
        output.writeUInt32(7, unk3250HLFHLPEKOML_);
      }
      if (killSpecialMonsterCount_ != 0) {
        output.writeUInt32(9, killSpecialMonsterCount_);
      }
      if (unk3250KPCJBOOGEMG_ != 0) {
        output.writeUInt32(10, unk3250KPCJBOOGEMG_);
      }
      if (galleryLevel_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250HLFHLPEKOML_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250HLFHLPEKOML_);
      }
      if (killSpecialMonsterCount_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250KPCJBOOGEMG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250KPCJBOOGEMG_);
      }
      if (galleryLevel_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250HLFHLPEKOML()
          != other.getUnk3250HLFHLPEKOML()) return false;
      if (getGalleryId()
          != other.getGalleryId()) return false;
      if (getUnk3250KPCJBOOGEMG()
          != other.getUnk3250KPCJBOOGEMG()) return false;
      if (getFinalScore()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_HLFHLPEKOML_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250HLFHLPEKOML();
      hash = (37 * hash) + GALLERY_ID_FIELD_NUMBER;
      hash = (53 * hash) + getGalleryId();
      hash = (37 * hash) + UNK3250_KPCJBOOGEMG_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250KPCJBOOGEMG();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250HLFHLPEKOML_ = 0;

        galleryId_ = 0;

        unk3250KPCJBOOGEMG_ = 0;
      ...
      public emu.grasscutter.net.proto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo buildPartial() {
        ...
        result.unk3250HLFHLPEKOML_ = unk3250HLFHLPEKOML_;
        result.galleryId_ = galleryId_;
        result.unk3250KPCJBOOGEMG_ = unk3250KPCJBOOGEMG_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo other) {
        ...
        if (other.getUnk3250HLFHLPEKOML() != 0) {
          setUnk3250HLFHLPEKOML(other.getUnk3250HLFHLPEKOML());
        }
        if (other.getGalleryId() != 0) {
          setGalleryId(other.getGalleryId());
        }
        if (other.getUnk3250KPCJBOOGEMG() != 0) {
          setUnk3250KPCJBOOGEMG(other.getUnk3250KPCJBOOGEMG());
        }
      ...
      /**
       * <code>uint32 Unk3250_HLFHLPEKOML = 7;</code>
       * @param value The unk3250HLFHLPEKOML to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250HLFHLPEKOML(int value) {
        
        unk3250HLFHLPEKOML_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250HLFHLPEKOML() {
      ...
      /**
       * <code>uint32 Unk3250_KPCJBOOGEMG = 10;</code>
       * @param value The unk3250KPCJBOOGEMG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250KPCJBOOGEMG(int value) {
        
        unk3250KPCJBOOGEMG_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250KPCJBOOGEMG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\033\n\023Unk3250_HLFHLPEKOML\030\007 \001(\r\022\022\n\ngallery" +
      "_id\030\002 \001(\r\022\033\n\023Unk3250_KPCJBOOGEMG\030\n \001(\r\022\023" +
    ...
    internal_static_BuoyantCombatGallerySettleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BuoyantCombatGallerySettleInfo_descriptor,
        new java.lang.String[] { "GalleryLevel", "KillMonsterCount", "KillSpecialMonsterCount", "Unk3250HLFHLPEKOML", "GalleryId", "Unk3250KPCJBOOGEMG", "FinalScore", });
  }
