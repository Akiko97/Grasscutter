...
public final class EvtAvatarStandUpNotifyOuterClass {
  ...
  public interface EvtAvatarStandUpNotifyOrBuilder extends
    ...
    /**
     * <code>int32 Unk3250_EBPACPNPKKJ = 13;</code>
     * @return The unk3250EBPACPNPKKJ.
     */
    int getUnk3250EBPACPNPKKJ();
    ...
    /**
     * <code>int32 Unk3250_IMNGNLLMEFJ = 11;</code>
     * @return The unk3250IMNGNLLMEFJ.
     */
    int getUnk3250IMNGNLLMEFJ();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 88: {
              ...
              unk3250IMNGNLLMEFJ_ = input.readInt32();
              break;
            }
            case 104: {

              unk3250EBPACPNPKKJ_ = input.readInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_EBPACPNPKKJ_FIELD_NUMBER = 13;
    private int unk3250EBPACPNPKKJ_;
    /**
     * <code>int32 Unk3250_EBPACPNPKKJ = 13;</code>
     * @return The unk3250EBPACPNPKKJ.
     */
    @java.lang.Override
    public int getUnk3250EBPACPNPKKJ() {
      return unk3250EBPACPNPKKJ_;
    }
    ...
    public static final int UNK3250_IMNGNLLMEFJ_FIELD_NUMBER = 11;
    private int unk3250IMNGNLLMEFJ_;
    /**
     * <code>int32 Unk3250_IMNGNLLMEFJ = 11;</code>
     * @return The unk3250IMNGNLLMEFJ.
     */
    @java.lang.Override
    public int getUnk3250IMNGNLLMEFJ() {
      return unk3250IMNGNLLMEFJ_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250IMNGNLLMEFJ_ != 0) {
        output.writeInt32(11, unk3250IMNGNLLMEFJ_);
      }
      if (unk3250EBPACPNPKKJ_ != 0) {
        output.writeInt32(13, unk3250EBPACPNPKKJ_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250IMNGNLLMEFJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(11, unk3250IMNGNLLMEFJ_);
      }
      if (unk3250EBPACPNPKKJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(13, unk3250EBPACPNPKKJ_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250EBPACPNPKKJ()
          != other.getUnk3250EBPACPNPKKJ()) return false;
      if (getChairId()
          != other.getChairId()) return false;
      if (getEntityId()
          != other.getEntityId()) return false;
      if (getUnk3250IMNGNLLMEFJ()
          != other.getUnk3250IMNGNLLMEFJ()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_EBPACPNPKKJ_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250EBPACPNPKKJ();
      hash = (37 * hash) + CHAIR_ID_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getChairId());
      hash = (37 * hash) + ENTITY_ID_FIELD_NUMBER;
      hash = (53 * hash) + getEntityId();
      hash = (37 * hash) + UNK3250_IMNGNLLMEFJ_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IMNGNLLMEFJ();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250EBPACPNPKKJ_ = 0;

        chairId_ = 0L;

        entityId_ = 0;

        unk3250IMNGNLLMEFJ_ = 0;
      ...
      public emu.grasscutter.net.proto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify buildPartial() {
        ...
        result.unk3250EBPACPNPKKJ_ = unk3250EBPACPNPKKJ_;
        result.chairId_ = chairId_;
        result.entityId_ = entityId_;
        result.unk3250IMNGNLLMEFJ_ = unk3250IMNGNLLMEFJ_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify other) {
        ...
        if (other.getUnk3250EBPACPNPKKJ() != 0) {
          setUnk3250EBPACPNPKKJ(other.getUnk3250EBPACPNPKKJ());
        }
        ...
        if (other.getUnk3250IMNGNLLMEFJ() != 0) {
          setUnk3250IMNGNLLMEFJ(other.getUnk3250IMNGNLLMEFJ());
        }
      ...
      /**
       * <code>int32 Unk3250_EBPACPNPKKJ = 13;</code>
       * @param value The unk3250EBPACPNPKKJ to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250EBPACPNPKKJ(int value) {
        
        unk3250EBPACPNPKKJ_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250EBPACPNPKKJ() {
      ...
      /**
       * <code>int32 Unk3250_IMNGNLLMEFJ = 11;</code>
       * @param value The unk3250IMNGNLLMEFJ to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IMNGNLLMEFJ(int value) {
        
        unk3250IMNGNLLMEFJ_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IMNGNLLMEFJ() {
  ...
  static {
    ...
    internal_static_EvtAvatarStandUpNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EvtAvatarStandUpNotify_descriptor,
        new java.lang.String[] { "Unk3250EBPACPNPKKJ", "ChairId", "EntityId", "Unk3250IMNGNLLMEFJ", });
  }
