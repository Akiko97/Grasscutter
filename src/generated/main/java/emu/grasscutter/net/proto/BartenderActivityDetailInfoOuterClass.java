...
public final class BartenderActivityDetailInfoOuterClass {
  ...
  public interface BartenderActivityDetailInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
     * @return A list containing the unk3250BPCBOANPBHF.
     */
    java.util.List<java.lang.Integer> getUnk3250BPCBOANPBHFList();
    /**
     * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
     * @return The count of unk3250BPCBOANPBHF.
     */
    int getUnk3250BPCBOANPBHFCount();
    /**
     * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
     * @param index The index of the element to return.
     * @return The unk3250BPCBOANPBHF at the given index.
     */
    int getUnk3250BPCBOANPBHF(int index);

    /**
     * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
     * @return A list containing the unk3250OGPLCBFDHCF.
     */
    java.util.List<java.lang.Integer> getUnk3250OGPLCBFDHCFList();
    /**
     * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
     * @return The count of unk3250OGPLCBFDHCF.
     */
    int getUnk3250OGPLCBFDHCFCount();
    /**
     * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
     * @param index The index of the element to return.
     * @return The unk3250OGPLCBFDHCF at the given index.
     */
    int getUnk3250OGPLCBFDHCF(int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    private BartenderActivityDetailInfo() {
      ...
      unk3250BPCBOANPBHF_ = emptyIntList();
      unk3250OGPLCBFDHCF_ = emptyIntList();
    ...
    private BartenderActivityDetailInfo(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 24: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                unk3250BPCBOANPBHF_ = newIntList();
                mutable_bitField0_ |= 0x00000002;
              }
              unk3250BPCBOANPBHF_.addInt(input.readUInt32());
              break;
            }
            case 26: {
            ...
            case 48: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                unk3250OGPLCBFDHCF_ = newIntList();
                mutable_bitField0_ |= 0x00000004;
              }
              unk3250OGPLCBFDHCF_.addInt(input.readUInt32());
              break;
            }
            case 50: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000002) != 0)) {
          unk3250BPCBOANPBHF_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000008) != 0)) {
          unlockTaskList_ = java.util.Collections.unmodifiableList(unlockTaskList_);
        }
        if (((mutable_bitField0_ & 0x00000004) != 0)) {
          unk3250OGPLCBFDHCF_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
    ...
    public static final int UNK3250_BPCBOANPBHF_FIELD_NUMBER = 3;
    private com.google.protobuf.Internal.IntList unk3250BPCBOANPBHF_;
    /**
     * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
     * @return A list containing the unk3250BPCBOANPBHF.
     */
    ...
    public java.util.List<java.lang.Integer>
        getUnk3250BPCBOANPBHFList() {
      return unk3250BPCBOANPBHF_;
    }
    /**
     * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
     * @return The count of unk3250BPCBOANPBHF.
     */
    public int getUnk3250BPCBOANPBHFCount() {
      return unk3250BPCBOANPBHF_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
     * @param index The index of the element to return.
     * @return The unk3250BPCBOANPBHF at the given index.
     */
    public int getUnk3250BPCBOANPBHF(int index) {
      return unk3250BPCBOANPBHF_.getInt(index);
    }
    private int unk3250BPCBOANPBHFMemoizedSerializedSize = -1;

    public static final int UNK3250_OGPLCBFDHCF_FIELD_NUMBER = 6;
    private com.google.protobuf.Internal.IntList unk3250OGPLCBFDHCF_;
    /**
     * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
     * @return A list containing the unk3250OGPLCBFDHCF.
     */
    @java.lang.Override
    public java.util.List<java.lang.Integer>
        getUnk3250OGPLCBFDHCFList() {
      return unk3250OGPLCBFDHCF_;
    }
    /**
     * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
     * @return The count of unk3250OGPLCBFDHCF.
     */
    public int getUnk3250OGPLCBFDHCFCount() {
      return unk3250OGPLCBFDHCF_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
     * @param index The index of the element to return.
     * @return The unk3250OGPLCBFDHCF at the given index.
     */
    public int getUnk3250OGPLCBFDHCF(int index) {
      return unk3250OGPLCBFDHCF_.getInt(index);
    }
    private int unk3250OGPLCBFDHCFMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (getUnk3250BPCBOANPBHFList().size() > 0) {
        output.writeUInt32NoTag(26);
        output.writeUInt32NoTag(unk3250BPCBOANPBHFMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250BPCBOANPBHF_.size(); i++) {
        output.writeUInt32NoTag(unk3250BPCBOANPBHF_.getInt(i));
      }
      for (int i = 0; i < unlockTaskList_.size(); i++) {
        output.writeMessage(5, unlockTaskList_.get(i));
      }
      if (getUnk3250OGPLCBFDHCFList().size() > 0) {
        output.writeUInt32NoTag(50);
        output.writeUInt32NoTag(unk3250OGPLCBFDHCFMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250OGPLCBFDHCF_.size(); i++) {
        output.writeUInt32NoTag(unk3250OGPLCBFDHCF_.getInt(i));
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < unk3250BPCBOANPBHF_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250BPCBOANPBHF_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250BPCBOANPBHFList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250BPCBOANPBHFMemoizedSerializedSize = dataSize;
      }
      for (int i = 0; i < unlockTaskList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      }
      {
        ...
        for (int i = 0; i < unk3250OGPLCBFDHCF_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250OGPLCBFDHCF_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250OGPLCBFDHCFList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250OGPLCBFDHCFMemoizedSerializedSize = dataSize;
      }
      if (isDevelopModuleOpen_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getUnk3250BPCBOANPBHFList()
          .equals(other.getUnk3250BPCBOANPBHFList())) return false;
      if (!getUnk3250OGPLCBFDHCFList()
          .equals(other.getUnk3250OGPLCBFDHCFList())) return false;
    ...
    public int hashCode() {
      ...
      if (getUnk3250BPCBOANPBHFCount() > 0) {
        hash = (37 * hash) + UNK3250_BPCBOANPBHF_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250BPCBOANPBHFList().hashCode();
      }
      if (getUnk3250OGPLCBFDHCFCount() > 0) {
        hash = (37 * hash) + UNK3250_OGPLCBFDHCF_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250OGPLCBFDHCFList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo buildPartial() {
        ...
        if (((bitField0_ & 0x00000002) != 0)) {
          unk3250BPCBOANPBHF_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000002);
        }
        result.unk3250BPCBOANPBHF_ = unk3250BPCBOANPBHF_;
        if (((bitField0_ & 0x00000004) != 0)) {
          unk3250OGPLCBFDHCF_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000004);
        }
        result.unk3250OGPLCBFDHCF_ = unk3250OGPLCBFDHCF_;
        if (unlockTaskListBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BartenderActivityDetailInfoOuterClass.BartenderActivityDetailInfo other) {
        ...
        if (!other.unk3250BPCBOANPBHF_.isEmpty()) {
          if (unk3250BPCBOANPBHF_.isEmpty()) {
            unk3250BPCBOANPBHF_ = other.unk3250BPCBOANPBHF_;
            bitField0_ = (bitField0_ & ~0x00000002);
          } else {
            ensureUnk3250BPCBOANPBHFIsMutable();
            unk3250BPCBOANPBHF_.addAll(other.unk3250BPCBOANPBHF_);
          }
          onChanged();
        }
        if (!other.unk3250OGPLCBFDHCF_.isEmpty()) {
          if (unk3250OGPLCBFDHCF_.isEmpty()) {
            unk3250OGPLCBFDHCF_ = other.unk3250OGPLCBFDHCF_;
            bitField0_ = (bitField0_ & ~0x00000004);
          } else {
            ensureUnk3250OGPLCBFDHCFIsMutable();
            unk3250OGPLCBFDHCF_.addAll(other.unk3250OGPLCBFDHCF_);
          }
          onChanged();
        }
        if (unlockTaskListBuilder_ == null) {
      ...
      private com.google.protobuf.Internal.IntList unk3250BPCBOANPBHF_ = emptyIntList();
      private void ensureUnk3250BPCBOANPBHFIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          unk3250BPCBOANPBHF_ = mutableCopy(unk3250BPCBOANPBHF_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000002) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250BPCBOANPBHF_) : unk3250BPCBOANPBHF_;
      }
      /**
       * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
       * @return The count of unk3250BPCBOANPBHF.
       ...
       * @param value The unk3250BPCBOANPBHF to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250BPCBOANPBHF(
          int index, int value) {
        ensureUnk3250BPCBOANPBHFIsMutable();
        unk3250BPCBOANPBHF_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
       * @param value The unk3250BPCBOANPBHF to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250BPCBOANPBHF(int value) {
        ensureUnk3250BPCBOANPBHFIsMutable();
        unk3250BPCBOANPBHF_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_BPCBOANPBHF = 3;</code>
       * @param values The unk3250BPCBOANPBHF to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250BPCBOANPBHF(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250BPCBOANPBHFIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250BPCBOANPBHF_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250BPCBOANPBHF() {
        unk3250BPCBOANPBHF_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000002);
        onChanged();
        return this;
      ...
      private com.google.protobuf.Internal.IntList unk3250OGPLCBFDHCF_ = emptyIntList();
      private void ensureUnk3250OGPLCBFDHCFIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          unk3250OGPLCBFDHCF_ = mutableCopy(unk3250OGPLCBFDHCF_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000004) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250OGPLCBFDHCF_) : unk3250OGPLCBFDHCF_;
      }
      /**
       * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
       * @return The count of unk3250OGPLCBFDHCF.
       ...
       * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
       * @param index The index to set the value at.
       * @param value The unk3250OGPLCBFDHCF to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250OGPLCBFDHCF(
          int index, int value) {
        ensureUnk3250OGPLCBFDHCFIsMutable();
        unk3250OGPLCBFDHCF_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
       * @param value The unk3250OGPLCBFDHCF to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250OGPLCBFDHCF(int value) {
        ensureUnk3250OGPLCBFDHCFIsMutable();
        unk3250OGPLCBFDHCF_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_OGPLCBFDHCF = 6;</code>
       * @param values The unk3250OGPLCBFDHCF to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250OGPLCBFDHCF(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250OGPLCBFDHCFIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250OGPLCBFDHCF_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250OGPLCBFDHCF() {
        unk3250OGPLCBFDHCF_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000004);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "3250_BPCBOANPBHF\030\003 \003(\r\022\033\n\023Unk3250_OGPLCB" +
    ...
    internal_static_BartenderActivityDetailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BartenderActivityDetailInfo_descriptor,
        new java.lang.String[] { "IsContentClosed", "UnlockLevelList", "Unk3250BPCBOANPBHF", "Unk3250OGPLCBFDHCF", "UnlockTaskList", "IsDevelopModuleOpen", });
    emu.grasscutter.net.proto.BartenderLevelInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.BartenderTaskInfoOuterClass.getDescriptor();
  }
