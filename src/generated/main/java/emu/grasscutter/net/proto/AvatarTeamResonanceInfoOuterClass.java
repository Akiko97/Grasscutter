...
public final class AvatarTeamResonanceInfoOuterClass {
  ...
  public interface AvatarTeamResonanceInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
     * @return A list containing the unk3250MBJEEEEEJCE.
     */
    java.util.List<java.lang.Integer> getUnk3250MBJEEEEEJCEList();
    /**
     * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
     * @return The count of unk3250MBJEEEEEJCE.
     */
    int getUnk3250MBJEEEEEJCECount();
    /**
     * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
     * @param index The index of the element to return.
     * @return The unk3250MBJEEEEEJCE at the given index.
     */
    int getUnk3250MBJEEEEEJCE(int index);

    /**
     * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
     * @return A list containing the unk3250LPAKGGBBDNJ.
     */
    java.util.List<java.lang.Integer> getUnk3250LPAKGGBBDNJList();
    /**
     * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
     * @return The count of unk3250LPAKGGBBDNJ.
     */
    int getUnk3250LPAKGGBBDNJCount();
    /**
     * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
     * @param index The index of the element to return.
     * @return The unk3250LPAKGGBBDNJ at the given index.
     */
    int getUnk3250LPAKGGBBDNJ(int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private AvatarTeamResonanceInfo() {
      unk3250MBJEEEEEJCE_ = emptyIntList();
      unk3250LPAKGGBBDNJ_ = emptyIntList();
    }
    ...
    private AvatarTeamResonanceInfo(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 104: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                unk3250LPAKGGBBDNJ_ = newIntList();
                mutable_bitField0_ |= 0x00000002;
              }
              unk3250LPAKGGBBDNJ_.addInt(input.readUInt32());
              break;
            }
            case 106: {
            ...
            case 120: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                unk3250MBJEEEEEJCE_ = newIntList();
                mutable_bitField0_ |= 0x00000001;
              }
              unk3250MBJEEEEEJCE_.addInt(input.readUInt32());
              break;
            }
            case 122: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000002) != 0)) {
          unk3250LPAKGGBBDNJ_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          unk3250MBJEEEEEJCE_.makeImmutable(); // C
        }
    ...
    public static final int UNK3250_MBJEEEEEJCE_FIELD_NUMBER = 15;
    private com.google.protobuf.Internal.IntList unk3250MBJEEEEEJCE_;
    /**
     * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
     * @return A list containing the unk3250MBJEEEEEJCE.
     */
    ...
    public java.util.List<java.lang.Integer>
        getUnk3250MBJEEEEEJCEList() {
      return unk3250MBJEEEEEJCE_;
    }
    /**
     * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
     * @return The count of unk3250MBJEEEEEJCE.
     */
    public int getUnk3250MBJEEEEEJCECount() {
      return unk3250MBJEEEEEJCE_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
     * @param index The index of the element to return.
     * @return The unk3250MBJEEEEEJCE at the given index.
     */
    public int getUnk3250MBJEEEEEJCE(int index) {
      return unk3250MBJEEEEEJCE_.getInt(index);
    }
    private int unk3250MBJEEEEEJCEMemoizedSerializedSize = -1;

    public static final int UNK3250_LPAKGGBBDNJ_FIELD_NUMBER = 13;
    private com.google.protobuf.Internal.IntList unk3250LPAKGGBBDNJ_;
    /**
     * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
     * @return A list containing the unk3250LPAKGGBBDNJ.
     */
    @java.lang.Override
    public java.util.List<java.lang.Integer>
        getUnk3250LPAKGGBBDNJList() {
      return unk3250LPAKGGBBDNJ_;
    }
    /**
     * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
     * @return The count of unk3250LPAKGGBBDNJ.
     */
    public int getUnk3250LPAKGGBBDNJCount() {
      return unk3250LPAKGGBBDNJ_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
     * @param index The index of the element to return.
     * @return The unk3250LPAKGGBBDNJ at the given index.
     */
    public int getUnk3250LPAKGGBBDNJ(int index) {
      return unk3250LPAKGGBBDNJ_.getInt(index);
    }
    private int unk3250LPAKGGBBDNJMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (getUnk3250LPAKGGBBDNJList().size() > 0) {
        output.writeUInt32NoTag(106);
        output.writeUInt32NoTag(unk3250LPAKGGBBDNJMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250LPAKGGBBDNJ_.size(); i++) {
        output.writeUInt32NoTag(unk3250LPAKGGBBDNJ_.getInt(i));
      }
      if (getUnk3250MBJEEEEEJCEList().size() > 0) {
        output.writeUInt32NoTag(122);
        output.writeUInt32NoTag(unk3250MBJEEEEEJCEMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250MBJEEEEEJCE_.size(); i++) {
        output.writeUInt32NoTag(unk3250MBJEEEEEJCE_.getInt(i));
      }
      ...
      }
      {
        ...
        for (int i = 0; i < unk3250LPAKGGBBDNJ_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250LPAKGGBBDNJ_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250LPAKGGBBDNJList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250LPAKGGBBDNJMemoizedSerializedSize = dataSize;
      }
      {
        int dataSize = 0;
        for (int i = 0; i < unk3250MBJEEEEEJCE_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250MBJEEEEEJCE_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250MBJEEEEEJCEList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250MBJEEEEEJCEMemoizedSerializedSize = dataSize;
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getUnk3250MBJEEEEEJCEList()
          .equals(other.getUnk3250MBJEEEEEJCEList())) return false;
      if (!getUnk3250LPAKGGBBDNJList()
          .equals(other.getUnk3250LPAKGGBBDNJList())) return false;
    ...
    public int hashCode() {
      ...
      if (getUnk3250MBJEEEEEJCECount() > 0) {
        hash = (37 * hash) + UNK3250_MBJEEEEEJCE_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250MBJEEEEEJCEList().hashCode();
      }
      if (getUnk3250LPAKGGBBDNJCount() > 0) {
        hash = (37 * hash) + UNK3250_LPAKGGBBDNJ_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250LPAKGGBBDNJList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.AvatarTeamResonanceInfoOuterClass.AvatarTeamResonanceInfo buildPartial() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
          unk3250MBJEEEEEJCE_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.unk3250MBJEEEEEJCE_ = unk3250MBJEEEEEJCE_;
        if (((bitField0_ & 0x00000002) != 0)) {
          unk3250LPAKGGBBDNJ_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000002);
        }
        result.unk3250LPAKGGBBDNJ_ = unk3250LPAKGGBBDNJ_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AvatarTeamResonanceInfoOuterClass.AvatarTeamResonanceInfo other) {
        ...
        if (!other.unk3250MBJEEEEEJCE_.isEmpty()) {
          if (unk3250MBJEEEEEJCE_.isEmpty()) {
            unk3250MBJEEEEEJCE_ = other.unk3250MBJEEEEEJCE_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureUnk3250MBJEEEEEJCEIsMutable();
            unk3250MBJEEEEEJCE_.addAll(other.unk3250MBJEEEEEJCE_);
          }
          onChanged();
        }
        if (!other.unk3250LPAKGGBBDNJ_.isEmpty()) {
          if (unk3250LPAKGGBBDNJ_.isEmpty()) {
            unk3250LPAKGGBBDNJ_ = other.unk3250LPAKGGBBDNJ_;
            bitField0_ = (bitField0_ & ~0x00000002);
          } else {
            ensureUnk3250LPAKGGBBDNJIsMutable();
            unk3250LPAKGGBBDNJ_.addAll(other.unk3250LPAKGGBBDNJ_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList unk3250MBJEEEEEJCE_ = emptyIntList();
      private void ensureUnk3250MBJEEEEEJCEIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          unk3250MBJEEEEEJCE_ = mutableCopy(unk3250MBJEEEEEJCE_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250MBJEEEEEJCE_) : unk3250MBJEEEEEJCE_;
      }
      /**
       * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
       * @return The count of unk3250MBJEEEEEJCE.
       ...
       * @param value The unk3250MBJEEEEEJCE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250MBJEEEEEJCE(
          int index, int value) {
        ensureUnk3250MBJEEEEEJCEIsMutable();
        unk3250MBJEEEEEJCE_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
       * @param value The unk3250MBJEEEEEJCE to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250MBJEEEEEJCE(int value) {
        ensureUnk3250MBJEEEEEJCEIsMutable();
        unk3250MBJEEEEEJCE_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_MBJEEEEEJCE = 15;</code>
       * @param values The unk3250MBJEEEEEJCE to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250MBJEEEEEJCE(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250MBJEEEEEJCEIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250MBJEEEEEJCE_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250MBJEEEEEJCE() {
        unk3250MBJEEEEEJCE_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
        return this;
      ...
      private com.google.protobuf.Internal.IntList unk3250LPAKGGBBDNJ_ = emptyIntList();
      private void ensureUnk3250LPAKGGBBDNJIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          unk3250LPAKGGBBDNJ_ = mutableCopy(unk3250LPAKGGBBDNJ_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000002) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250LPAKGGBBDNJ_) : unk3250LPAKGGBBDNJ_;
      }
      /**
       * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
       * @return The count of unk3250LPAKGGBBDNJ.
       ...
       * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
       * @param index The index to set the value at.
       * @param value The unk3250LPAKGGBBDNJ to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LPAKGGBBDNJ(
          int index, int value) {
        ensureUnk3250LPAKGGBBDNJIsMutable();
        unk3250LPAKGGBBDNJ_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
       * @param value The unk3250LPAKGGBBDNJ to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250LPAKGGBBDNJ(int value) {
        ensureUnk3250LPAKGGBBDNJIsMutable();
        unk3250LPAKGGBBDNJ_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_LPAKGGBBDNJ = 13;</code>
       * @param values The unk3250LPAKGGBBDNJ to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250LPAKGGBBDNJ(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250LPAKGGBBDNJIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250LPAKGGBBDNJ_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LPAKGGBBDNJ() {
        unk3250LPAKGGBBDNJ_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000002);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\021\n\tentity_id\030\010 \001(\r\022\033\n\023Unk3250_MBJEEEEEJC" +
      "E\030\017 \003(\r\022\033\n\023Unk3250_LPAKGGBBDNJ\030\r \003(\rB\033\n\031" +
    ...
    internal_static_AvatarTeamResonanceInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AvatarTeamResonanceInfo_descriptor,
        new java.lang.String[] { "AvatarGuid", "EntityId", "Unk3250MBJEEEEEJCE", "Unk3250LPAKGGBBDNJ", });
  }
