...
public final class AbilityIdentifierOuterClass {
  ...
  public interface AbilityIdentifierOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_IHCKJKLCICI = 10;</code>
     * @return The unk3250IHCKJKLCICI.
     */
    int getUnk3250IHCKJKLCICI();
    ...
    /**
     * <code>uint32 Unk3250_OOOLELPBDHJ = 1;</code>
     * @return The unk3250OOOLELPBDHJ.
     */
    int getUnk3250OOOLELPBDHJ();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              unk3250OOOLELPBDHJ_ = input.readUInt32();
              break;
            }
            case 32: {
            ...
            case 80: {
              ...
              unk3250IHCKJKLCICI_ = input.readUInt32();
              break;
            }
            case 112: {
    ...
    public static final int UNK3250_IHCKJKLCICI_FIELD_NUMBER = 10;
    private int unk3250IHCKJKLCICI_;
    /**
     * <code>uint32 Unk3250_IHCKJKLCICI = 10;</code>
     * @return The unk3250IHCKJKLCICI.
     */
    @java.lang.Override
    public int getUnk3250IHCKJKLCICI() {
      return unk3250IHCKJKLCICI_;
    }
    ...
    public static final int UNK3250_OOOLELPBDHJ_FIELD_NUMBER = 1;
    private int unk3250OOOLELPBDHJ_;
    /**
     * <code>uint32 Unk3250_OOOLELPBDHJ = 1;</code>
     * @return The unk3250OOOLELPBDHJ.
     */
    @java.lang.Override
    public int getUnk3250OOOLELPBDHJ() {
      return unk3250OOOLELPBDHJ_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250OOOLELPBDHJ_ != 0) {
        output.writeUInt32(1, unk3250OOOLELPBDHJ_);
      }
      ...
      if (unk3250IHCKJKLCICI_ != 0) {
        output.writeUInt32(10, unk3250IHCKJKLCICI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250OOOLELPBDHJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, unk3250OOOLELPBDHJ_);
      }
      if (instancedAbilityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250IHCKJKLCICI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250IHCKJKLCICI_);
      }
      if (isServerbuffModifier_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250IHCKJKLCICI()
          != other.getUnk3250IHCKJKLCICI()) return false;
      if (getIsServerbuffModifier()
          != other.getIsServerbuffModifier()) return false;
      if (getLocalId()
          != other.getLocalId()) return false;
      if (getUnk3250OOOLELPBDHJ()
          != other.getUnk3250OOOLELPBDHJ()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_IHCKJKLCICI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IHCKJKLCICI();
      ...
      hash = (37 * hash) + UNK3250_OOOLELPBDHJ_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250OOOLELPBDHJ();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250IHCKJKLCICI_ = 0;

        isServerbuffModifier_ = false;

        localId_ = 0;

        unk3250OOOLELPBDHJ_ = 0;
      ...
      public emu.grasscutter.net.proto.AbilityIdentifierOuterClass.AbilityIdentifier buildPartial() {
        ...
        result.unk3250IHCKJKLCICI_ = unk3250IHCKJKLCICI_;
        result.isServerbuffModifier_ = isServerbuffModifier_;
        result.localId_ = localId_;
        result.unk3250OOOLELPBDHJ_ = unk3250OOOLELPBDHJ_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AbilityIdentifierOuterClass.AbilityIdentifier other) {
        ...
        if (other.getUnk3250IHCKJKLCICI() != 0) {
          setUnk3250IHCKJKLCICI(other.getUnk3250IHCKJKLCICI());
        }
        ...
        if (other.getUnk3250OOOLELPBDHJ() != 0) {
          setUnk3250OOOLELPBDHJ(other.getUnk3250OOOLELPBDHJ());
        }
      ...
      /**
       * <code>uint32 Unk3250_IHCKJKLCICI = 10;</code>
       * @param value The unk3250IHCKJKLCICI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IHCKJKLCICI(int value) {
        
        unk3250IHCKJKLCICI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IHCKJKLCICI() {
      ...
      /**
       * <code>uint32 Unk3250_OOOLELPBDHJ = 1;</code>
       * @param value The unk3250OOOLELPBDHJ to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250OOOLELPBDHJ(int value) {
        
        unk3250OOOLELPBDHJ_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250OOOLELPBDHJ() {
  ...
  static {
    ...
    internal_static_AbilityIdentifier_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityIdentifier_descriptor,
        new java.lang.String[] { "InstancedAbilityId", "Unk3250IHCKJKLCICI", "IsServerbuffModifier", "LocalId", "Unk3250OOOLELPBDHJ", "InstancedModifierId", });
  }
