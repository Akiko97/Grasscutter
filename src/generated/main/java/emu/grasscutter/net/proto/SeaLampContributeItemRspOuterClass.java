...
public final class SeaLampContributeItemRspOuterClass {
  ...
  public interface SeaLampContributeItemRspOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_AIINHBHNHOI = 11;</code>
     * @return The unk3250AIINHBHNHOI.
     */
    int getUnk3250AIINHBHNHOI();
    ...
    /**
     * <code>uint32 Unk3250_LPHALOGLGAL = 9;</code>
     * @return The unk3250LPHALOGLGAL.
     */
    int getUnk3250LPHALOGLGAL();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 72: {
              ...
              unk3250LPHALOGLGAL_ = input.readUInt32();
              break;
            }
            case 88: {

              unk3250AIINHBHNHOI_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_AIINHBHNHOI_FIELD_NUMBER = 11;
    private int unk3250AIINHBHNHOI_;
    /**
     * <code>uint32 Unk3250_AIINHBHNHOI = 11;</code>
     * @return The unk3250AIINHBHNHOI.
     */
    @java.lang.Override
    public int getUnk3250AIINHBHNHOI() {
      return unk3250AIINHBHNHOI_;
    }
    ...
    public static final int UNK3250_LPHALOGLGAL_FIELD_NUMBER = 9;
    private int unk3250LPHALOGLGAL_;
    /**
     * <code>uint32 Unk3250_LPHALOGLGAL = 9;</code>
     * @return The unk3250LPHALOGLGAL.
     */
    @java.lang.Override
    public int getUnk3250LPHALOGLGAL() {
      return unk3250LPHALOGLGAL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250LPHALOGLGAL_ != 0) {
        output.writeUInt32(9, unk3250LPHALOGLGAL_);
      }
      if (unk3250AIINHBHNHOI_ != 0) {
        output.writeUInt32(11, unk3250AIINHBHNHOI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250LPHALOGLGAL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, unk3250LPHALOGLGAL_);
      }
      if (unk3250AIINHBHNHOI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, unk3250AIINHBHNHOI_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250AIINHBHNHOI()
          != other.getUnk3250AIINHBHNHOI()) return false;
      if (getAddProgress()
          != other.getAddProgress()) return false;
      if (getUnk3250LPHALOGLGAL()
          != other.getUnk3250LPHALOGLGAL()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_AIINHBHNHOI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250AIINHBHNHOI();
      hash = (37 * hash) + ADD_PROGRESS_FIELD_NUMBER;
      hash = (53 * hash) + getAddProgress();
      hash = (37 * hash) + UNK3250_LPHALOGLGAL_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LPHALOGLGAL();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250AIINHBHNHOI_ = 0;

        addProgress_ = 0;

        unk3250LPHALOGLGAL_ = 0;
      ...
      public emu.grasscutter.net.proto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp buildPartial() {
        ...
        result.unk3250AIINHBHNHOI_ = unk3250AIINHBHNHOI_;
        result.addProgress_ = addProgress_;
        result.unk3250LPHALOGLGAL_ = unk3250LPHALOGLGAL_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp other) {
        ...
        if (other.getUnk3250AIINHBHNHOI() != 0) {
          setUnk3250AIINHBHNHOI(other.getUnk3250AIINHBHNHOI());
        }
        if (other.getAddProgress() != 0) {
          setAddProgress(other.getAddProgress());
        }
        if (other.getUnk3250LPHALOGLGAL() != 0) {
          setUnk3250LPHALOGLGAL(other.getUnk3250LPHALOGLGAL());
        }
      ...
      /**
       * <code>uint32 Unk3250_AIINHBHNHOI = 11;</code>
       * @param value The unk3250AIINHBHNHOI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250AIINHBHNHOI(int value) {
        
        unk3250AIINHBHNHOI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250AIINHBHNHOI() {
      ...
      /**
       * <code>uint32 Unk3250_LPHALOGLGAL = 9;</code>
       * @param value The unk3250LPHALOGLGAL to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LPHALOGLGAL(int value) {
        
        unk3250LPHALOGLGAL_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LPHALOGLGAL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\023Unk3250_AIINHBHNHOI\030\013 \001(\r\022\024\n\014add_progre" +
      "ss\030\005 \001(\r\022\033\n\023Unk3250_LPHALOGLGAL\030\t \001(\rB\033\n" +
    ...
    internal_static_SeaLampContributeItemRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SeaLampContributeItemRsp_descriptor,
        new java.lang.String[] { "Retcode", "Unk3250AIINHBHNHOI", "AddProgress", "Unk3250LPHALOGLGAL", });
  }
