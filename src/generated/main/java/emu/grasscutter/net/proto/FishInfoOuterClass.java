...
public final class FishInfoOuterClass {
  ...
  public interface FishInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_AKFBFEDCELN = 14;</code>
     * @return The unk3250AKFBFEDCELN.
     */
    int getUnk3250AKFBFEDCELN();

    /**
     * <code>uint32 Unk3250_FIICLBEFHLL = 7;</code>
     * @return The unk3250FIICLBEFHLL.
     */
    int getUnk3250FIICLBEFHLL();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250FIICLBEFHLL_ = input.readUInt32();
              break;
            }
            case 112: {

              unk3250AKFBFEDCELN_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_AKFBFEDCELN_FIELD_NUMBER = 14;
    private int unk3250AKFBFEDCELN_;
    /**
     * <code>uint32 Unk3250_AKFBFEDCELN = 14;</code>
     * @return The unk3250AKFBFEDCELN.
     */
    @java.lang.Override
    public int getUnk3250AKFBFEDCELN() {
      return unk3250AKFBFEDCELN_;
    }

    public static final int UNK3250_FIICLBEFHLL_FIELD_NUMBER = 7;
    private int unk3250FIICLBEFHLL_;
    /**
     * <code>uint32 Unk3250_FIICLBEFHLL = 7;</code>
     * @return The unk3250FIICLBEFHLL.
     */
    @java.lang.Override
    public int getUnk3250FIICLBEFHLL() {
      return unk3250FIICLBEFHLL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250FIICLBEFHLL_ != 0) {
        output.writeUInt32(7, unk3250FIICLBEFHLL_);
      }
      if (unk3250AKFBFEDCELN_ != 0) {
        output.writeUInt32(14, unk3250AKFBFEDCELN_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250FIICLBEFHLL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250FIICLBEFHLL_);
      }
      if (unk3250AKFBFEDCELN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, unk3250AKFBFEDCELN_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250AKFBFEDCELN()
          != other.getUnk3250AKFBFEDCELN()) return false;
      if (getUnk3250FIICLBEFHLL()
          != other.getUnk3250FIICLBEFHLL()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_AKFBFEDCELN_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250AKFBFEDCELN();
      hash = (37 * hash) + UNK3250_FIICLBEFHLL_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250FIICLBEFHLL();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250AKFBFEDCELN_ = 0;

        unk3250FIICLBEFHLL_ = 0;
      ...
      public emu.grasscutter.net.proto.FishInfoOuterClass.FishInfo buildPartial() {
        ...
        result.unk3250AKFBFEDCELN_ = unk3250AKFBFEDCELN_;
        result.unk3250FIICLBEFHLL_ = unk3250FIICLBEFHLL_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FishInfoOuterClass.FishInfo other) {
        ...
        if (other.getUnk3250AKFBFEDCELN() != 0) {
          setUnk3250AKFBFEDCELN(other.getUnk3250AKFBFEDCELN());
        }
        if (other.getUnk3250FIICLBEFHLL() != 0) {
          setUnk3250FIICLBEFHLL(other.getUnk3250FIICLBEFHLL());
        }
      ...
      /**
       * <code>uint32 Unk3250_AKFBFEDCELN = 14;</code>
       * @param value The unk3250AKFBFEDCELN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250AKFBFEDCELN(int value) {
        
        unk3250AKFBFEDCELN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250AKFBFEDCELN() {
      ...
      /**
       * <code>uint32 Unk3250_FIICLBEFHLL = 7;</code>
       * @param value The unk3250FIICLBEFHLL to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250FIICLBEFHLL(int value) {
        
        unk3250FIICLBEFHLL_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250FIICLBEFHLL() {
  ...
  static {
    ...
    internal_static_FishInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FishInfo_descriptor,
        new java.lang.String[] { "Unk3250AKFBFEDCELN", "Unk3250FIICLBEFHLL", });
  }
