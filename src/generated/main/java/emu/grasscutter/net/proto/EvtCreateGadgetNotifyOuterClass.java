...
public final class EvtCreateGadgetNotifyOuterClass {
  ...
  public interface EvtCreateGadgetNotifyOrBuilder extends
    ...
    /**
     * <code>bool Unk3250_DLBIJFOONBA = 15;</code>
     * @return The unk3250DLBIJFOONBA.
     */
    boolean getUnk3250DLBIJFOONBA();
    ...
    /**
     * <code>bool Unk3250_OJHDJGAFDNN = 1433;</code>
     * @return The unk3250OJHDJGAFDNN.
     */
    boolean getUnk3250OJHDJGAFDNN();
    ...
    /**
     * <code>bool Unk3250_EJNBIGLGMII = 8;</code>
     * @return The unk3250EJNBIGLGMII.
     */
    boolean getUnk3250EJNBIGLGMII();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 64: {
              ...
              unk3250EJNBIGLGMII_ = input.readBool();
              break;
            }
            case 74: {
            ...
            case 120: {
              ...
              unk3250DLBIJFOONBA_ = input.readBool();
              break;
            }
            case 3312: {
            ...
            case 11464: {
              ...
              unk3250OJHDJGAFDNN_ = input.readBool();
              break;
            }
            case 13216: {
    ...
    public static final int UNK3250_DLBIJFOONBA_FIELD_NUMBER = 15;
    private boolean unk3250DLBIJFOONBA_;
    /**
     * <code>bool Unk3250_DLBIJFOONBA = 15;</code>
     * @return The unk3250DLBIJFOONBA.
     */
    @java.lang.Override
    public boolean getUnk3250DLBIJFOONBA() {
      return unk3250DLBIJFOONBA_;
    }
    ...
    public static final int UNK3250_OJHDJGAFDNN_FIELD_NUMBER = 1433;
    private boolean unk3250OJHDJGAFDNN_;
    /**
     * <code>bool Unk3250_OJHDJGAFDNN = 1433;</code>
     * @return The unk3250OJHDJGAFDNN.
     */
    @java.lang.Override
    public boolean getUnk3250OJHDJGAFDNN() {
      return unk3250OJHDJGAFDNN_;
    }
    ...
    public static final int UNK3250_EJNBIGLGMII_FIELD_NUMBER = 8;
    private boolean unk3250EJNBIGLGMII_;
    /**
     * <code>bool Unk3250_EJNBIGLGMII = 8;</code>
     * @return The unk3250EJNBIGLGMII.
     */
    @java.lang.Override
    public boolean getUnk3250EJNBIGLGMII() {
      return unk3250EJNBIGLGMII_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250EJNBIGLGMII_ != false) {
        output.writeBool(8, unk3250EJNBIGLGMII_);
      }
      if (initPos_ != null) {
      ...
      if (unk3250DLBIJFOONBA_ != false) {
        output.writeBool(15, unk3250DLBIJFOONBA_);
      }
      ...
      if (unk3250OJHDJGAFDNN_ != false) {
        output.writeBool(1433, unk3250OJHDJGAFDNN_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250EJNBIGLGMII_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, unk3250EJNBIGLGMII_);
      }
      if (initPos_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250DLBIJFOONBA_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(15, unk3250DLBIJFOONBA_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < targetLockPointIndexList_.size(); i++) {
      ...
      if (unk3250OJHDJGAFDNN_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(1433, unk3250OJHDJGAFDNN_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < targetEntityIdList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250DLBIJFOONBA()
          != other.getUnk3250DLBIJFOONBA()) return false;
      if (getOwnerEntityId()
      ...
      if (getUnk3250OJHDJGAFDNN()
          != other.getUnk3250OJHDJGAFDNN()) return false;
      if (getCampId()
          != other.getCampId()) return false;
      if (getUnk3250EJNBIGLGMII()
          != other.getUnk3250EJNBIGLGMII()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_DLBIJFOONBA_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getUnk3250DLBIJFOONBA());
      ...
      hash = (37 * hash) + UNK3250_OJHDJGAFDNN_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getUnk3250OJHDJGAFDNN());
      hash = (37 * hash) + CAMP_ID_FIELD_NUMBER;
      hash = (53 * hash) + getCampId();
      hash = (37 * hash) + UNK3250_EJNBIGLGMII_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getUnk3250EJNBIGLGMII());
      if (hasInitEulerAngles()) {
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250OJHDJGAFDNN_ = false;

        campId_ = 0;

        unk3250EJNBIGLGMII_ = false;
      ...
      public emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify buildPartial() {
        ...
        result.unk3250DLBIJFOONBA_ = unk3250DLBIJFOONBA_;
        ...
        result.unk3250OJHDJGAFDNN_ = unk3250OJHDJGAFDNN_;
        result.campId_ = campId_;
        result.unk3250EJNBIGLGMII_ = unk3250EJNBIGLGMII_;
        if (initEulerAnglesBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify other) {
        ...
        if (other.getUnk3250DLBIJFOONBA() != false) {
          setUnk3250DLBIJFOONBA(other.getUnk3250DLBIJFOONBA());
        }
        ...
        if (other.getUnk3250OJHDJGAFDNN() != false) {
          setUnk3250OJHDJGAFDNN(other.getUnk3250OJHDJGAFDNN());
        }
        if (other.getCampId() != 0) {
          setCampId(other.getCampId());
        }
        if (other.getUnk3250EJNBIGLGMII() != false) {
          setUnk3250EJNBIGLGMII(other.getUnk3250EJNBIGLGMII());
        }
      ...
      /**
       * <code>bool Unk3250_DLBIJFOONBA = 15;</code>
       * @param value The unk3250DLBIJFOONBA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250DLBIJFOONBA(boolean value) {
        
        unk3250DLBIJFOONBA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250DLBIJFOONBA() {
      ...
      /**
       * <code>bool Unk3250_OJHDJGAFDNN = 1433;</code>
       * @param value The unk3250OJHDJGAFDNN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250OJHDJGAFDNN(boolean value) {
        
        unk3250OJHDJGAFDNN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250OJHDJGAFDNN() {
      ...
      /**
       * <code>bool Unk3250_EJNBIGLGMII = 8;</code>
       * @param value The unk3250EJNBIGLGMII to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250EJNBIGLGMII(boolean value) {
        
        unk3250EJNBIGLGMII_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250EJNBIGLGMII() {
  ...
  static {
    ...
    internal_static_EvtCreateGadgetNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EvtCreateGadgetNotify_descriptor,
        new java.lang.String[] { "TargetEntityIdList", "InitPos", "Unk3250DLBIJFOONBA", "OwnerEntityId", "ForwardType", "TargetLockPointIndexList", "PropOwnerEntityId", "TargetLockPointIndex", "Unk3250OJHDJGAFDNN", "CampId", "Unk3250EJNBIGLGMII", "InitEulerAngles", "IsPeerIdFromPlayer", "RoomId", "ConfigId", "CampType", "Guid", "EntityId", "TargetEntityId", });
    emu.grasscutter.net.proto.ForwardTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
