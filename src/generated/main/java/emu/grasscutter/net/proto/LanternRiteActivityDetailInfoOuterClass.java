...
public final class LanternRiteActivityDetailInfoOuterClass {
  ...
  public interface LanternRiteActivityDetailInfoOrBuilder extends
    ...
    /**
     * <code>bool Unk3250_PDFJNCDGKGH = 11;</code>
     * @return The unk3250PDFJNCDGKGH.
     */
    boolean getUnk3250PDFJNCDGKGH();
    ...
    /**
     * <code>bool Unk3250_DKBJLCIMBAL = 8;</code>
     * @return The unk3250DKBJLCIMBAL.
     */
    boolean getUnk3250DKBJLCIMBAL();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 64: {
              ...
              unk3250DKBJLCIMBAL_ = input.readBool();
              break;
            }
            case 88: {

              unk3250PDFJNCDGKGH_ = input.readBool();
              break;
            }
            case 112: {
    ...
    public static final int UNK3250_PDFJNCDGKGH_FIELD_NUMBER = 11;
    private boolean unk3250PDFJNCDGKGH_;
    /**
     * <code>bool Unk3250_PDFJNCDGKGH = 11;</code>
     * @return The unk3250PDFJNCDGKGH.
     */
    @java.lang.Override
    public boolean getUnk3250PDFJNCDGKGH() {
      return unk3250PDFJNCDGKGH_;
    }
    ...
    public static final int UNK3250_DKBJLCIMBAL_FIELD_NUMBER = 8;
    private boolean unk3250DKBJLCIMBAL_;
    /**
     * <code>bool Unk3250_DKBJLCIMBAL = 8;</code>
     * @return The unk3250DKBJLCIMBAL.
     */
    @java.lang.Override
    public boolean getUnk3250DKBJLCIMBAL() {
      return unk3250DKBJLCIMBAL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250DKBJLCIMBAL_ != false) {
        output.writeBool(8, unk3250DKBJLCIMBAL_);
      }
      if (unk3250PDFJNCDGKGH_ != false) {
        output.writeBool(11, unk3250PDFJNCDGKGH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250DKBJLCIMBAL_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, unk3250DKBJLCIMBAL_);
      }
      if (unk3250PDFJNCDGKGH_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(11, unk3250PDFJNCDGKGH_);
      }
      if (isContentClosed_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250PDFJNCDGKGH()
          != other.getUnk3250PDFJNCDGKGH()) return false;
      ...
      if (getUnk3250DKBJLCIMBAL()
          != other.getUnk3250DKBJLCIMBAL()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_PDFJNCDGKGH_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getUnk3250PDFJNCDGKGH());
      if (hasProjectionInfo()) {
        hash = (37 * hash) + PROJECTION_INFO_FIELD_NUMBER;
        hash = (53 * hash) + getProjectionInfo().hashCode();
      }
      hash = (37 * hash) + UNK3250_DKBJLCIMBAL_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getUnk3250DKBJLCIMBAL());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.LanternRiteActivityDetailInfoOuterClass.LanternRiteActivityDetailInfo buildPartial() {
        ...
        result.unk3250PDFJNCDGKGH_ = unk3250PDFJNCDGKGH_;
        if (projectionInfoBuilder_ == null) {
          result.projectionInfo_ = projectionInfo_;
        } else {
          result.projectionInfo_ = projectionInfoBuilder_.build();
        }
        result.unk3250DKBJLCIMBAL_ = unk3250DKBJLCIMBAL_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.LanternRiteActivityDetailInfoOuterClass.LanternRiteActivityDetailInfo other) {
        ...
        if (other.getUnk3250PDFJNCDGKGH() != false) {
          setUnk3250PDFJNCDGKGH(other.getUnk3250PDFJNCDGKGH());
        }
        if (other.hasProjectionInfo()) {
          mergeProjectionInfo(other.getProjectionInfo());
        }
        if (other.getUnk3250DKBJLCIMBAL() != false) {
          setUnk3250DKBJLCIMBAL(other.getUnk3250DKBJLCIMBAL());
        }
      ...
      /**
       * <code>bool Unk3250_PDFJNCDGKGH = 11;</code>
       * @param value The unk3250PDFJNCDGKGH to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PDFJNCDGKGH(boolean value) {
        
        unk3250PDFJNCDGKGH_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PDFJNCDGKGH() {
      ...
      /**
       * <code>bool Unk3250_DKBJLCIMBAL = 8;</code>
       * @param value The unk3250DKBJLCIMBAL to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250DKBJLCIMBAL(boolean value) {
        
        unk3250DKBJLCIMBAL_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250DKBJLCIMBAL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "reworksInfo\022\033\n\023Unk3250_PDFJNCDGKGH\030\013 \001(\010" +
      "\022/\n\017projection_info\030\003 \001(\0132\026.LanternProje" +
      "ctionInfo\022\033\n\023Unk3250_DKBJLCIMBAL\030\010 \001(\010\022\031" +
    ...
    internal_static_LanternRiteActivityDetailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_LanternRiteActivityDetailInfo_descriptor,
        new java.lang.String[] { "StageInfoList", "FireworksInfo", "Unk3250PDFJNCDGKGH", "ProjectionInfo", "Unk3250DKBJLCIMBAL", "IsContentClosed", });
    emu.grasscutter.net.proto.LanternProjectionInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.LanternRiteFireworksInfoOuterClass.getDescriptor();
    emu.grasscutter.net.proto.SalvageStageInfoOuterClass.getDescriptor();
  }
