...
public final class HomePlantSubFieldDataOuterClass {
  ...
  public interface HomePlantSubFieldDataOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_IELHEAAMAKG = 7;</code>
     * @return The unk3250IELHEAAMAKG.
     */
    int getUnk3250IELHEAAMAKG();
    ...
    /**
     * <code>uint32 Unk3250_GAJHLGKLBBK = 9;</code>
     * @return The unk3250GAJHLGKLBBK.
     */
    int getUnk3250GAJHLGKLBBK();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250IELHEAAMAKG_ = input.readUInt32();
              break;
            }
            case 72: {

              unk3250GAJHLGKLBBK_ = input.readUInt32();
              break;
            }
            case 96: {
    ...
    public static final int UNK3250_IELHEAAMAKG_FIELD_NUMBER = 7;
    private int unk3250IELHEAAMAKG_;
    /**
     * <code>uint32 Unk3250_IELHEAAMAKG = 7;</code>
     * @return The unk3250IELHEAAMAKG.
     */
    @java.lang.Override
    public int getUnk3250IELHEAAMAKG() {
      return unk3250IELHEAAMAKG_;
    }
    ...
    public static final int UNK3250_GAJHLGKLBBK_FIELD_NUMBER = 9;
    private int unk3250GAJHLGKLBBK_;
    /**
     * <code>uint32 Unk3250_GAJHLGKLBBK = 9;</code>
     * @return The unk3250GAJHLGKLBBK.
     */
    @java.lang.Override
    public int getUnk3250GAJHLGKLBBK() {
      return unk3250GAJHLGKLBBK_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250IELHEAAMAKG_ != 0) {
        output.writeUInt32(7, unk3250IELHEAAMAKG_);
      }
      if (unk3250GAJHLGKLBBK_ != 0) {
        output.writeUInt32(9, unk3250GAJHLGKLBBK_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250IELHEAAMAKG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250IELHEAAMAKG_);
      }
      if (unk3250GAJHLGKLBBK_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, unk3250GAJHLGKLBBK_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < entityIdList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250IELHEAAMAKG()
          != other.getUnk3250IELHEAAMAKG()) return false;
      if (!getEntityIdListList()
          .equals(other.getEntityIdListList())) return false;
      if (getEndTime()
          != other.getEndTime()) return false;
      if (getUnk3250GAJHLGKLBBK()
          != other.getUnk3250GAJHLGKLBBK()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_IELHEAAMAKG_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IELHEAAMAKG();
      ...
      hash = (37 * hash) + UNK3250_GAJHLGKLBBK_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250GAJHLGKLBBK();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250IELHEAAMAKG_ = 0;

        entityIdList_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        endTime_ = 0;

        unk3250GAJHLGKLBBK_ = 0;
      ...
      public emu.grasscutter.net.proto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData buildPartial() {
        ...
        result.unk3250IELHEAAMAKG_ = unk3250IELHEAAMAKG_;
        ...
        result.unk3250GAJHLGKLBBK_ = unk3250GAJHLGKLBBK_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData other) {
        ...
        if (other.getUnk3250IELHEAAMAKG() != 0) {
          setUnk3250IELHEAAMAKG(other.getUnk3250IELHEAAMAKG());
        }
        ...
        if (other.getUnk3250GAJHLGKLBBK() != 0) {
          setUnk3250GAJHLGKLBBK(other.getUnk3250GAJHLGKLBBK());
        }
      ...
      /**
       * <code>uint32 Unk3250_IELHEAAMAKG = 7;</code>
       * @param value The unk3250IELHEAAMAKG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IELHEAAMAKG(int value) {
        
        unk3250IELHEAAMAKG_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IELHEAAMAKG() {
      ...
      /**
       * <code>uint32 Unk3250_GAJHLGKLBBK = 9;</code>
       * @param value The unk3250GAJHLGKLBBK to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250GAJHLGKLBBK(int value) {
        
        unk3250GAJHLGKLBBK_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250GAJHLGKLBBK() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ldStatus\022\033\n\023Unk3250_IELHEAAMAKG\030\007 \001(\r\022\026\n" +
      "\016entity_id_list\030\014 \003(\r\022\020\n\010end_time\030\006 \001(\007\022" +
      "\033\n\023Unk3250_GAJHLGKLBBK\030\t \001(\rB\033\n\031emu.gras" +
    ...
    internal_static_HomePlantSubFieldData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomePlantSubFieldData_descriptor,
        new java.lang.String[] { "FieldStatus", "Unk3250IELHEAAMAKG", "EntityIdList", "EndTime", "Unk3250GAJHLGKLBBK", });
    emu.grasscutter.net.proto.HomePlantFieldStatusOuterClass.getDescriptor();
  }
