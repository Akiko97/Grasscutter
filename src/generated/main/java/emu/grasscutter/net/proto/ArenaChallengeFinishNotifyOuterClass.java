...
public final class ArenaChallengeFinishNotifyOuterClass {
  ...
  public interface ArenaChallengeFinishNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_FDFNFLAKONG = 3;</code>
     * @return The unk3250FDFNFLAKONG.
     */
    int getUnk3250FDFNFLAKONG();
    ...
    /**
     * <code>uint32 Unk3250_DBHAGHMMLAI = 10;</code>
     * @return The unk3250DBHAGHMMLAI.
     */
    int getUnk3250DBHAGHMMLAI();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 24: {
              ...
              unk3250FDFNFLAKONG_ = input.readUInt32();
              break;
            }
            case 64: {
            ...
            case 80: {
              ...
              unk3250DBHAGHMMLAI_ = input.readUInt32();
              break;
            }
            case 114: {
    ...
    public static final int UNK3250_FDFNFLAKONG_FIELD_NUMBER = 3;
    private int unk3250FDFNFLAKONG_;
    /**
     * <code>uint32 Unk3250_FDFNFLAKONG = 3;</code>
     * @return The unk3250FDFNFLAKONG.
     */
    @java.lang.Override
    public int getUnk3250FDFNFLAKONG() {
      return unk3250FDFNFLAKONG_;
    }
    ...
    public static final int UNK3250_DBHAGHMMLAI_FIELD_NUMBER = 10;
    private int unk3250DBHAGHMMLAI_;
    /**
     * <code>uint32 Unk3250_DBHAGHMMLAI = 10;</code>
     * @return The unk3250DBHAGHMMLAI.
     */
    @java.lang.Override
    public int getUnk3250DBHAGHMMLAI() {
      return unk3250DBHAGHMMLAI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250FDFNFLAKONG_ != 0) {
        output.writeUInt32(3, unk3250FDFNFLAKONG_);
      }
      if (isSuccess_ != false) {
        output.writeBool(8, isSuccess_);
      }
      if (unk3250DBHAGHMMLAI_ != 0) {
        output.writeUInt32(10, unk3250DBHAGHMMLAI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250FDFNFLAKONG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, unk3250FDFNFLAKONG_);
      }
      if (isSuccess_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250DBHAGHMMLAI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250DBHAGHMMLAI_);
      }
      for (int i = 0; i < childChallengeList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250FDFNFLAKONG()
          != other.getUnk3250FDFNFLAKONG()) return false;
      if (!getChildChallengeListList()
          .equals(other.getChildChallengeListList())) return false;
      if (getUnk3250DBHAGHMMLAI()
          != other.getUnk3250DBHAGHMMLAI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsSuccess());
      hash = (37 * hash) + UNK3250_FDFNFLAKONG_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250FDFNFLAKONG();
      ...
      hash = (37 * hash) + UNK3250_DBHAGHMMLAI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250DBHAGHMMLAI();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ArenaChallengeFinishNotifyOuterClass.ArenaChallengeFinishNotify buildPartial() {
        ...
        result.unk3250FDFNFLAKONG_ = unk3250FDFNFLAKONG_;
        if (childChallengeListBuilder_ == null) {
        ...
        result.unk3250DBHAGHMMLAI_ = unk3250DBHAGHMMLAI_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ArenaChallengeFinishNotifyOuterClass.ArenaChallengeFinishNotify other) {
        ...
        if (other.getUnk3250FDFNFLAKONG() != 0) {
          setUnk3250FDFNFLAKONG(other.getUnk3250FDFNFLAKONG());
        }
        if (childChallengeListBuilder_ == null) {
        ...
        if (other.getUnk3250DBHAGHMMLAI() != 0) {
          setUnk3250DBHAGHMMLAI(other.getUnk3250DBHAGHMMLAI());
        }
      ...
      /**
       * <code>uint32 Unk3250_FDFNFLAKONG = 3;</code>
       * @param value The unk3250FDFNFLAKONG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250FDFNFLAKONG(int value) {
        
        unk3250FDFNFLAKONG_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250FDFNFLAKONG() {
      ...
      /**
       * <code>uint32 Unk3250_DBHAGHMMLAI = 10;</code>
       * @param value The unk3250DBHAGHMMLAI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250DBHAGHMMLAI(int value) {
        
        unk3250DBHAGHMMLAI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250DBHAGHMMLAI() {
  ...
  static {
    ...
    internal_static_ArenaChallengeFinishNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ArenaChallengeFinishNotify_descriptor,
        new java.lang.String[] { "IsSuccess", "Unk3250FDFNFLAKONG", "ChildChallengeList", "Unk3250DBHAGHMMLAI", });
    emu.grasscutter.net.proto.ArenaChallengeChildChallengeInfoOuterClass.getDescriptor();
  }
