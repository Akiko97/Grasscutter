...
public final class ChannelerSlabBuffSchemeInfoOuterClass {
  ...
  public interface ChannelerSlabBuffSchemeInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_NCMDDAFNENO = 9;</code>
     * @return The unk3250NCMDDAFNENO.
     */
    int getUnk3250NCMDDAFNENO();
    ...
    /**
     * <code>uint32 Unk3250_CKMNFOCNMGL = 5;</code>
     * @return The unk3250CKMNFOCNMGL.
     */
    int getUnk3250CKMNFOCNMGL();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              unk3250CKMNFOCNMGL_ = input.readUInt32();
              break;
            }
            case 72: {

              unk3250NCMDDAFNENO_ = input.readUInt32();
              break;
            }
            case 90: {
    ...
    public static final int UNK3250_NCMDDAFNENO_FIELD_NUMBER = 9;
    private int unk3250NCMDDAFNENO_;
    /**
     * <code>uint32 Unk3250_NCMDDAFNENO = 9;</code>
     * @return The unk3250NCMDDAFNENO.
     */
    @java.lang.Override
    public int getUnk3250NCMDDAFNENO() {
      return unk3250NCMDDAFNENO_;
    }
    ...
    public static final int UNK3250_CKMNFOCNMGL_FIELD_NUMBER = 5;
    private int unk3250CKMNFOCNMGL_;
    /**
     * <code>uint32 Unk3250_CKMNFOCNMGL = 5;</code>
     * @return The unk3250CKMNFOCNMGL.
     */
    @java.lang.Override
    public int getUnk3250CKMNFOCNMGL() {
      return unk3250CKMNFOCNMGL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250CKMNFOCNMGL_ != 0) {
        output.writeUInt32(5, unk3250CKMNFOCNMGL_);
      }
      if (unk3250NCMDDAFNENO_ != 0) {
        output.writeUInt32(9, unk3250NCMDDAFNENO_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250CKMNFOCNMGL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, unk3250CKMNFOCNMGL_);
      }
      if (unk3250NCMDDAFNENO_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, unk3250NCMDDAFNENO_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250NCMDDAFNENO()
          != other.getUnk3250NCMDDAFNENO()) return false;
      if (!internalGetSlotMap().equals(
          other.internalGetSlotMap())) return false;
      if (getUnk3250CKMNFOCNMGL()
          != other.getUnk3250CKMNFOCNMGL()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_NCMDDAFNENO_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250NCMDDAFNENO();
      if (!internalGetSlotMap().getMap().isEmpty()) {
        hash = (37 * hash) + SLOT_MAP_FIELD_NUMBER;
        hash = (53 * hash) + internalGetSlotMap().hashCode();
      }
      hash = (37 * hash) + UNK3250_CKMNFOCNMGL_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250CKMNFOCNMGL();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250NCMDDAFNENO_ = 0;

        internalGetMutableSlotMap().clear();
        unk3250CKMNFOCNMGL_ = 0;
      ...
      public emu.grasscutter.net.proto.ChannelerSlabBuffSchemeInfoOuterClass.ChannelerSlabBuffSchemeInfo buildPartial() {
        ...
        result.unk3250NCMDDAFNENO_ = unk3250NCMDDAFNENO_;
        result.slotMap_ = internalGetSlotMap();
        result.slotMap_.makeImmutable();
        result.unk3250CKMNFOCNMGL_ = unk3250CKMNFOCNMGL_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ChannelerSlabBuffSchemeInfoOuterClass.ChannelerSlabBuffSchemeInfo other) {
        ...
        if (other.getUnk3250NCMDDAFNENO() != 0) {
          setUnk3250NCMDDAFNENO(other.getUnk3250NCMDDAFNENO());
        }
        internalGetMutableSlotMap().mergeFrom(
            other.internalGetSlotMap());
        if (other.getUnk3250CKMNFOCNMGL() != 0) {
          setUnk3250CKMNFOCNMGL(other.getUnk3250CKMNFOCNMGL());
        }
      ...
      /**
       * <code>uint32 Unk3250_NCMDDAFNENO = 9;</code>
       * @param value The unk3250NCMDDAFNENO to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NCMDDAFNENO(int value) {
        
        unk3250NCMDDAFNENO_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NCMDDAFNENO() {
      ...
      /**
       * <code>uint32 Unk3250_CKMNFOCNMGL = 5;</code>
       * @param value The unk3250CKMNFOCNMGL to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250CKMNFOCNMGL(int value) {
        
        unk3250CKMNFOCNMGL_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250CKMNFOCNMGL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\023Unk3250_CKMNFOCNMGL\030\005 \001(\r\032.\n\014SlotMapEnt" +
    ...
    internal_static_ChannelerSlabBuffSchemeInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ChannelerSlabBuffSchemeInfo_descriptor,
        new java.lang.String[] { "Unk3250NCMDDAFNENO", "SlotMap", "Unk3250CKMNFOCNMGL", });
    internal_static_ChannelerSlabBuffSchemeInfo_SlotMapEntry_descriptor =
