...
public final class HitCollisionOuterClass {
  ...
  public interface HitCollisionOrBuilder extends
    ...
    /**
     * <code>float Unk3250_LNHIOLFMGCN = 7;</code>
     * @return The unk3250LNHIOLFMGCN.
     */
    float getUnk3250LNHIOLFMGCN();
    ...
    /**
     * <code>float Unk3250_OJHBMLIAPJN = 10;</code>
     * @return The unk3250OJHBMLIAPJN.
     */
    float getUnk3250OJHBMLIAPJN();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 61: {
              ...
              unk3250LNHIOLFMGCN_ = input.readFloat();
              break;
            }
            case 64: {
            ...
            case 85: {
              ...
              unk3250OJHBMLIAPJN_ = input.readFloat();
              break;
            }
            case 114: {
              emu.grasscutter.net.proto.VectorOuterClass.Vector.Builder subBuilder = null;
    ...
    public static final int UNK3250_LNHIOLFMGCN_FIELD_NUMBER = 7;
    private float unk3250LNHIOLFMGCN_;
    /**
     * <code>float Unk3250_LNHIOLFMGCN = 7;</code>
     * @return The unk3250LNHIOLFMGCN.
     */
    @java.lang.Override
    public float getUnk3250LNHIOLFMGCN() {
      return unk3250LNHIOLFMGCN_;
    }
    ...
    public static final int UNK3250_OJHBMLIAPJN_FIELD_NUMBER = 10;
    private float unk3250OJHBMLIAPJN_;
    /**
     * <code>float Unk3250_OJHBMLIAPJN = 10;</code>
     * @return The unk3250OJHBMLIAPJN.
     */
    @java.lang.Override
    public float getUnk3250OJHBMLIAPJN() {
      return unk3250OJHBMLIAPJN_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250LNHIOLFMGCN_ != 0F) {
        output.writeFloat(7, unk3250LNHIOLFMGCN_);
      }
      if (hitBoxIndex_ != 0) {
        output.writeInt32(8, hitBoxIndex_);
      }
      if (unk3250OJHBMLIAPJN_ != 0F) {
        output.writeFloat(10, unk3250OJHBMLIAPJN_);
      }
      if (hitPoint_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250LNHIOLFMGCN_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(7, unk3250LNHIOLFMGCN_);
      }
      if (hitBoxIndex_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250OJHBMLIAPJN_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(10, unk3250OJHBMLIAPJN_);
      }
      if (hitPoint_ != null) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (java.lang.Float.floatToIntBits(getUnk3250LNHIOLFMGCN())
          != java.lang.Float.floatToIntBits(
              other.getUnk3250LNHIOLFMGCN())) return false;
      ...
      if (java.lang.Float.floatToIntBits(getUnk3250OJHBMLIAPJN())
          != java.lang.Float.floatToIntBits(
              other.getUnk3250OJHBMLIAPJN())) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_LNHIOLFMGCN_FIELD_NUMBER;
      hash = (53 * hash) + java.lang.Float.floatToIntBits(
          getUnk3250LNHIOLFMGCN());
      if (hasHitDir()) {
      ...
      hash = (37 * hash) + UNK3250_OJHBMLIAPJN_FIELD_NUMBER;
      hash = (53 * hash) + java.lang.Float.floatToIntBits(
          getUnk3250OJHBMLIAPJN());
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.HitCollisionOuterClass.HitCollision buildPartial() {
        ...
        result.unk3250LNHIOLFMGCN_ = unk3250LNHIOLFMGCN_;
        if (hitDirBuilder_ == null) {
        ...
        result.unk3250OJHBMLIAPJN_ = unk3250OJHBMLIAPJN_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.HitCollisionOuterClass.HitCollision other) {
        ...
        if (other.getUnk3250LNHIOLFMGCN() != 0F) {
          setUnk3250LNHIOLFMGCN(other.getUnk3250LNHIOLFMGCN());
        }
        if (other.hasHitDir()) {
        ...
        if (other.getUnk3250OJHBMLIAPJN() != 0F) {
          setUnk3250OJHBMLIAPJN(other.getUnk3250OJHBMLIAPJN());
        }
      ...
      /**
       * <code>float Unk3250_LNHIOLFMGCN = 7;</code>
       * @param value The unk3250LNHIOLFMGCN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LNHIOLFMGCN(float value) {
        
        unk3250LNHIOLFMGCN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LNHIOLFMGCN() {
      ...
      /**
       * <code>float Unk3250_OJHBMLIAPJN = 10;</code>
       * @param value The unk3250OJHBMLIAPJN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250OJHBMLIAPJN(float value) {
        
        unk3250OJHBMLIAPJN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250OJHBMLIAPJN() {
  ...
  static {
    ...
    internal_static_HitCollision_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HitCollision_descriptor,
        new java.lang.String[] { "HitBoxIndex", "HitColliderType", "Unk3250LNHIOLFMGCN", "HitDir", "HitPoint", "Unk3250OJHBMLIAPJN", });
    emu.grasscutter.net.proto.HitColliderTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
