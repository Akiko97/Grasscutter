...
public final class ExpeditionPathInfoOuterClass {
  ...
  public interface ExpeditionPathInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_AIEJKADFLKG = 6;</code>
     * @return The unk3250AIEJKADFLKG.
     */
    int getUnk3250AIEJKADFLKG();

    /**
     * <code>uint32 Unk3250_LKAHOEBNBBI = 14;</code>
     * @return The unk3250LKAHOEBNBBI.
     */
    int getUnk3250LKAHOEBNBBI();

    /**
     * <code>uint32 Unk3250_AFGPGIIGAKA = 7;</code>
     * @return The unk3250AFGPGIIGAKA.
     */
    int getUnk3250AFGPGIIGAKA();

    /**
     * <code>uint32 Unk3250_LFIFDGAGFDC = 5;</code>
     * @return The unk3250LFIFDGAGFDC.
     */
    int getUnk3250LFIFDGAGFDC();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              unk3250LFIFDGAGFDC_ = input.readUInt32();
              break;
            }
            case 48: {

              unk3250AIEJKADFLKG_ = input.readUInt32();
              break;
            }
            case 56: {

              unk3250AFGPGIIGAKA_ = input.readUInt32();
              break;
            }
            case 64: {
            ...
            case 112: {
              ...
              unk3250LKAHOEBNBBI_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_AIEJKADFLKG_FIELD_NUMBER = 6;
    private int unk3250AIEJKADFLKG_;
    /**
     * <code>uint32 Unk3250_AIEJKADFLKG = 6;</code>
     * @return The unk3250AIEJKADFLKG.
     */
    @java.lang.Override
    public int getUnk3250AIEJKADFLKG() {
      return unk3250AIEJKADFLKG_;
    }

    public static final int UNK3250_LKAHOEBNBBI_FIELD_NUMBER = 14;
    private int unk3250LKAHOEBNBBI_;
    /**
     * <code>uint32 Unk3250_LKAHOEBNBBI = 14;</code>
     * @return The unk3250LKAHOEBNBBI.
     */
    @java.lang.Override
    public int getUnk3250LKAHOEBNBBI() {
      return unk3250LKAHOEBNBBI_;
    }

    public static final int UNK3250_AFGPGIIGAKA_FIELD_NUMBER = 7;
    private int unk3250AFGPGIIGAKA_;
    /**
     * <code>uint32 Unk3250_AFGPGIIGAKA = 7;</code>
     * @return The unk3250AFGPGIIGAKA.
     */
    @java.lang.Override
    public int getUnk3250AFGPGIIGAKA() {
      return unk3250AFGPGIIGAKA_;
    }

    public static final int UNK3250_LFIFDGAGFDC_FIELD_NUMBER = 5;
    private int unk3250LFIFDGAGFDC_;
    /**
     * <code>uint32 Unk3250_LFIFDGAGFDC = 5;</code>
     * @return The unk3250LFIFDGAGFDC.
     */
    @java.lang.Override
    public int getUnk3250LFIFDGAGFDC() {
      return unk3250LFIFDGAGFDC_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (unk3250LFIFDGAGFDC_ != 0) {
        output.writeUInt32(5, unk3250LFIFDGAGFDC_);
      }
      if (unk3250AIEJKADFLKG_ != 0) {
        output.writeUInt32(6, unk3250AIEJKADFLKG_);
      }
      if (unk3250AFGPGIIGAKA_ != 0) {
        output.writeUInt32(7, unk3250AFGPGIIGAKA_);
      }
      ...
      if (unk3250LKAHOEBNBBI_ != 0) {
        output.writeUInt32(14, unk3250LKAHOEBNBBI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250LFIFDGAGFDC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, unk3250LFIFDGAGFDC_);
      }
      if (unk3250AIEJKADFLKG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, unk3250AIEJKADFLKG_);
      }
      if (unk3250AFGPGIIGAKA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250AFGPGIIGAKA_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < avatarIdList_.size(); i++) {
      ...
      if (unk3250LKAHOEBNBBI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, unk3250LKAHOEBNBBI_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250AIEJKADFLKG()
          != other.getUnk3250AIEJKADFLKG()) return false;
      if (getUnk3250LKAHOEBNBBI()
          != other.getUnk3250LKAHOEBNBBI()) return false;
      if (getUnk3250AFGPGIIGAKA()
          != other.getUnk3250AFGPGIIGAKA()) return false;
      if (getUnk3250LFIFDGAGFDC()
          != other.getUnk3250LFIFDGAGFDC()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_AIEJKADFLKG_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250AIEJKADFLKG();
      hash = (37 * hash) + UNK3250_LKAHOEBNBBI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LKAHOEBNBBI();
      hash = (37 * hash) + UNK3250_AFGPGIIGAKA_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250AFGPGIIGAKA();
      hash = (37 * hash) + UNK3250_LFIFDGAGFDC_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LFIFDGAGFDC();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250AIEJKADFLKG_ = 0;

        unk3250LKAHOEBNBBI_ = 0;

        unk3250AFGPGIIGAKA_ = 0;

        unk3250LFIFDGAGFDC_ = 0;
      ...
      public emu.grasscutter.net.proto.ExpeditionPathInfoOuterClass.ExpeditionPathInfo buildPartial() {
        ...
        result.unk3250AIEJKADFLKG_ = unk3250AIEJKADFLKG_;
        result.unk3250LKAHOEBNBBI_ = unk3250LKAHOEBNBBI_;
        result.unk3250AFGPGIIGAKA_ = unk3250AFGPGIIGAKA_;
        result.unk3250LFIFDGAGFDC_ = unk3250LFIFDGAGFDC_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ExpeditionPathInfoOuterClass.ExpeditionPathInfo other) {
        ...
        if (other.getUnk3250AIEJKADFLKG() != 0) {
          setUnk3250AIEJKADFLKG(other.getUnk3250AIEJKADFLKG());
        }
        if (other.getUnk3250LKAHOEBNBBI() != 0) {
          setUnk3250LKAHOEBNBBI(other.getUnk3250LKAHOEBNBBI());
        }
        if (other.getUnk3250AFGPGIIGAKA() != 0) {
          setUnk3250AFGPGIIGAKA(other.getUnk3250AFGPGIIGAKA());
        }
        if (other.getUnk3250LFIFDGAGFDC() != 0) {
          setUnk3250LFIFDGAGFDC(other.getUnk3250LFIFDGAGFDC());
        }
        if (other.state_ != 0) {
      ...
      /**
       * <code>uint32 Unk3250_AIEJKADFLKG = 6;</code>
       * @param value The unk3250AIEJKADFLKG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250AIEJKADFLKG(int value) {
        
        unk3250AIEJKADFLKG_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250AIEJKADFLKG() {
      ...
      /**
       * <code>uint32 Unk3250_LKAHOEBNBBI = 14;</code>
       * @param value The unk3250LKAHOEBNBBI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LKAHOEBNBBI(int value) {
        
        unk3250LKAHOEBNBBI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LKAHOEBNBBI() {
      ...
      /**
       * <code>uint32 Unk3250_AFGPGIIGAKA = 7;</code>
       * @param value The unk3250AFGPGIIGAKA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250AFGPGIIGAKA(int value) {
        
        unk3250AFGPGIIGAKA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250AFGPGIIGAKA() {
      ...
      /**
       * <code>uint32 Unk3250_LFIFDGAGFDC = 5;</code>
       * @param value The unk3250LFIFDGAGFDC to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LFIFDGAGFDC(int value) {
        
        unk3250LFIFDGAGFDC_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LFIFDGAGFDC() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\033\n\023Unk3250_AIEJKADFLKG\030\006 \001(\r\022\033\n\023Unk3250" +
      "_LKAHOEBNBBI\030\016 \001(\r\022\033\n\023Unk3250_AFGPGIIGAK" +
      "A\030\007 \001(\r\022\033\n\023Unk3250_LFIFDGAGFDC\030\005 \001(\r\022\037\n\005" +
    ...
    internal_static_ExpeditionPathInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ExpeditionPathInfo_descriptor,
        new java.lang.String[] { "StartTime", "BonusProbability", "AvatarIdList", "PathId", "Unk3250AIEJKADFLKG", "Unk3250LKAHOEBNBBI", "Unk3250AFGPGIIGAKA", "Unk3250LFIFDGAGFDC", "State", "ChallengeId", });
    emu.grasscutter.net.proto.ExpeditionStateOuterClass.getDescriptor();
  }
