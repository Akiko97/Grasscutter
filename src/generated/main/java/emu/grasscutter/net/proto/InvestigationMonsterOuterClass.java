...
public final class InvestigationMonsterOuterClass {
  ...
  public interface InvestigationMonsterOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_ONLALCCKIEE = 1;</code>
     * @return The unk3250ONLALCCKIEE.
     */
    int getUnk3250ONLALCCKIEE();
    ...
    /**
     * <code>uint32 Unk3250_DKKOBDIEKPP = 6;</code>
     * @return The unk3250DKKOBDIEKPP.
     */
    int getUnk3250DKKOBDIEKPP();
    ...
    /**
     * <code>uint32 Unk3250_JHLEHEOOGGB = 10;</code>
     * @return The unk3250JHLEHEOOGGB.
     */
    int getUnk3250JHLEHEOOGGB();
    ...
    /**
     * <code>uint32 Unk3250_KNKFCOKMECI = 11;</code>
     * @return The unk3250KNKFCOKMECI.
     */
    int getUnk3250KNKFCOKMECI();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              unk3250ONLALCCKIEE_ = input.readUInt32();
              break;
            }
            case 16: {
            ...
            case 48: {
              ...
              unk3250DKKOBDIEKPP_ = input.readUInt32();
              break;
            }
            case 58: {
            ...
            case 80: {
              ...
              unk3250JHLEHEOOGGB_ = input.readUInt32();
              break;
            }
            case 88: {

              unk3250KNKFCOKMECI_ = input.readUInt32();
              break;
            }
            case 96: {
    ...
    public static final int UNK3250_ONLALCCKIEE_FIELD_NUMBER = 1;
    private int unk3250ONLALCCKIEE_;
    /**
     * <code>uint32 Unk3250_ONLALCCKIEE = 1;</code>
     * @return The unk3250ONLALCCKIEE.
     */
    @java.lang.Override
    public int getUnk3250ONLALCCKIEE() {
      return unk3250ONLALCCKIEE_;
    }
    ...
    public static final int UNK3250_DKKOBDIEKPP_FIELD_NUMBER = 6;
    private int unk3250DKKOBDIEKPP_;
    /**
     * <code>uint32 Unk3250_DKKOBDIEKPP = 6;</code>
     * @return The unk3250DKKOBDIEKPP.
     */
    @java.lang.Override
    public int getUnk3250DKKOBDIEKPP() {
      return unk3250DKKOBDIEKPP_;
    }
    ...
    public static final int UNK3250_JHLEHEOOGGB_FIELD_NUMBER = 10;
    private int unk3250JHLEHEOOGGB_;
    /**
     * <code>uint32 Unk3250_JHLEHEOOGGB = 10;</code>
     * @return The unk3250JHLEHEOOGGB.
     */
    @java.lang.Override
    public int getUnk3250JHLEHEOOGGB() {
      return unk3250JHLEHEOOGGB_;
    }
    ...
    public static final int UNK3250_KNKFCOKMECI_FIELD_NUMBER = 11;
    private int unk3250KNKFCOKMECI_;
    /**
     * <code>uint32 Unk3250_KNKFCOKMECI = 11;</code>
     * @return The unk3250KNKFCOKMECI.
     */
    @java.lang.Override
    public int getUnk3250KNKFCOKMECI() {
      return unk3250KNKFCOKMECI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250ONLALCCKIEE_ != 0) {
        output.writeUInt32(1, unk3250ONLALCCKIEE_);
      }
      if (level_ != 0) {
      ...
      if (unk3250DKKOBDIEKPP_ != 0) {
        output.writeUInt32(6, unk3250DKKOBDIEKPP_);
      }
      if (pos_ != null) {
      ...
      if (unk3250JHLEHEOOGGB_ != 0) {
        output.writeUInt32(10, unk3250JHLEHEOOGGB_);
      }
      if (unk3250KNKFCOKMECI_ != 0) {
        output.writeUInt32(11, unk3250KNKFCOKMECI_);
      }
      if (sceneId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250ONLALCCKIEE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, unk3250ONLALCCKIEE_);
      }
      if (level_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250DKKOBDIEKPP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, unk3250DKKOBDIEKPP_);
      }
      if (pos_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250JHLEHEOOGGB_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250JHLEHEOOGGB_);
      }
      if (unk3250KNKFCOKMECI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, unk3250KNKFCOKMECI_);
      }
      if (sceneId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250ONLALCCKIEE()
          != other.getUnk3250ONLALCCKIEE()) return false;
      ...
      if (getUnk3250DKKOBDIEKPP()
          != other.getUnk3250DKKOBDIEKPP()) return false;
      if (getId()
          != other.getId()) return false;
      if (getMonsterId()
          != other.getMonsterId()) return false;
      if (lockState_ != other.lockState_) return false;
      if (getUnk3250JHLEHEOOGGB()
          != other.getUnk3250JHLEHEOOGGB()) return false;
      if (getIsAreaLocked()
          != other.getIsAreaLocked()) return false;
      if (getLevel()
          != other.getLevel()) return false;
      if (getUnk3250KNKFCOKMECI()
          != other.getUnk3250KNKFCOKMECI()) return false;
      if (getResin()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_ONLALCCKIEE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250ONLALCCKIEE();
      if (hasWeeklyBossResinDiscountInfo()) {
        hash = (37 * hash) + WEEKLY_BOSS_RESIN_DISCOUNT_INFO_FIELD_NUMBER;
        hash = (53 * hash) + getWeeklyBossResinDiscountInfo().hashCode();
      }
      hash = (37 * hash) + UNK3250_DKKOBDIEKPP_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250DKKOBDIEKPP();
      ...
      hash = (37 * hash) + UNK3250_JHLEHEOOGGB_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250JHLEHEOOGGB();
      hash = (37 * hash) + IS_AREA_LOCKED_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsAreaLocked());
      hash = (37 * hash) + LEVEL_FIELD_NUMBER;
      hash = (53 * hash) + getLevel();
      hash = (37 * hash) + UNK3250_KNKFCOKMECI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250KNKFCOKMECI();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250JHLEHEOOGGB_ = 0;

        isAreaLocked_ = false;

        level_ = 0;

        unk3250KNKFCOKMECI_ = 0;
      ...
      public emu.grasscutter.net.proto.InvestigationMonsterOuterClass.InvestigationMonster buildPartial() {
        ...
        result.unk3250ONLALCCKIEE_ = unk3250ONLALCCKIEE_;
        if (weeklyBossResinDiscountInfoBuilder_ == null) {
        ...
        result.unk3250DKKOBDIEKPP_ = unk3250DKKOBDIEKPP_;
        result.id_ = id_;
        result.monsterId_ = monsterId_;
        result.lockState_ = lockState_;
        result.unk3250JHLEHEOOGGB_ = unk3250JHLEHEOOGGB_;
        result.isAreaLocked_ = isAreaLocked_;
        result.level_ = level_;
        result.unk3250KNKFCOKMECI_ = unk3250KNKFCOKMECI_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.InvestigationMonsterOuterClass.InvestigationMonster other) {
        ...
        if (other.getUnk3250ONLALCCKIEE() != 0) {
          setUnk3250ONLALCCKIEE(other.getUnk3250ONLALCCKIEE());
        }
        if (other.hasWeeklyBossResinDiscountInfo()) {
          mergeWeeklyBossResinDiscountInfo(other.getWeeklyBossResinDiscountInfo());
        }
        if (other.getUnk3250DKKOBDIEKPP() != 0) {
          setUnk3250DKKOBDIEKPP(other.getUnk3250DKKOBDIEKPP());
        }
        if (other.getId() != 0) {
          setId(other.getId());
        }
        ...
        if (other.getUnk3250JHLEHEOOGGB() != 0) {
          setUnk3250JHLEHEOOGGB(other.getUnk3250JHLEHEOOGGB());
        }
        ...
        if (other.getUnk3250KNKFCOKMECI() != 0) {
          setUnk3250KNKFCOKMECI(other.getUnk3250KNKFCOKMECI());
        }
        if (other.getResin() != 0) {
      ...
      /**
       * <code>uint32 Unk3250_ONLALCCKIEE = 1;</code>
       * @param value The unk3250ONLALCCKIEE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250ONLALCCKIEE(int value) {
        
        unk3250ONLALCCKIEE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250ONLALCCKIEE() {
      ...
      /**
       * <code>uint32 Unk3250_DKKOBDIEKPP = 6;</code>
       * @param value The unk3250DKKOBDIEKPP to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250DKKOBDIEKPP(int value) {
        
        unk3250DKKOBDIEKPP_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250DKKOBDIEKPP() {
      ...
      /**
       * <code>uint32 Unk3250_JHLEHEOOGGB = 10;</code>
       * @param value The unk3250JHLEHEOOGGB to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250JHLEHEOOGGB(int value) {
        
        unk3250JHLEHEOOGGB_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250JHLEHEOOGGB() {
      ...
      /**
       * <code>uint32 Unk3250_KNKFCOKMECI = 11;</code>
       * @param value The unk3250KNKFCOKMECI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250KNKFCOKMECI(int value) {
        
        unk3250KNKFCOKMECI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250KNKFCOKMECI() {
  ...
  static {
    ...
    internal_static_InvestigationMonster_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_InvestigationMonster_descriptor,
        new java.lang.String[] { "IsAlive", "Pos", "SceneId", "NextRefreshTime", "CityId", "GroupId", "Unk3250ONLALCCKIEE", "WeeklyBossResinDiscountInfo", "Unk3250DKKOBDIEKPP", "Id", "MonsterId", "LockState", "Unk3250JHLEHEOOGGB", "IsAreaLocked", "Level", "Unk3250KNKFCOKMECI", "Resin", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
    emu.grasscutter.net.proto.WeeklyBossResinDiscountInfoOuterClass.getDescriptor();
  }
