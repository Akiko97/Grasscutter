...
public final class TriggerRoguelikeCurseNotifyOuterClass {
  ...
  public interface TriggerRoguelikeCurseNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_POLIENBCNLF = 7;</code>
     * @return The unk3250POLIENBCNLF.
     */
    int getUnk3250POLIENBCNLF();

    /**
     * <code>uint32 Unk3250_LJHJIBDPBBC = 10;</code>
     * @return The unk3250LJHJIBDPBBC.
     */
    int getUnk3250LJHJIBDPBBC();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250POLIENBCNLF_ = input.readUInt32();
              break;
            }
            case 72: {
            ...
            case 80: {
              ...
              unk3250LJHJIBDPBBC_ = input.readUInt32();
              break;
            }
            case 88: {
    ...
    public static final int UNK3250_POLIENBCNLF_FIELD_NUMBER = 7;
    private int unk3250POLIENBCNLF_;
    /**
     * <code>uint32 Unk3250_POLIENBCNLF = 7;</code>
     * @return The unk3250POLIENBCNLF.
     */
    @java.lang.Override
    public int getUnk3250POLIENBCNLF() {
      return unk3250POLIENBCNLF_;
    }

    public static final int UNK3250_LJHJIBDPBBC_FIELD_NUMBER = 10;
    private int unk3250LJHJIBDPBBC_;
    /**
     * <code>uint32 Unk3250_LJHJIBDPBBC = 10;</code>
     * @return The unk3250LJHJIBDPBBC.
     */
    @java.lang.Override
    public int getUnk3250LJHJIBDPBBC() {
      return unk3250LJHJIBDPBBC_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (unk3250POLIENBCNLF_ != 0) {
        output.writeUInt32(7, unk3250POLIENBCNLF_);
      }
      ...
      if (unk3250LJHJIBDPBBC_ != 0) {
        output.writeUInt32(10, unk3250LJHJIBDPBBC_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250POLIENBCNLF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250POLIENBCNLF_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < effectParamList_.size(); i++) {
      ...
      if (unk3250LJHJIBDPBBC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250LJHJIBDPBBC_);
      }
      if (isTriggerCurse_ != false) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250POLIENBCNLF()
          != other.getUnk3250POLIENBCNLF()) return false;
      if (getUnk3250LJHJIBDPBBC()
          != other.getUnk3250LJHJIBDPBBC()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_POLIENBCNLF_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250POLIENBCNLF();
      hash = (37 * hash) + UNK3250_LJHJIBDPBBC_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LJHJIBDPBBC();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250POLIENBCNLF_ = 0;

        unk3250LJHJIBDPBBC_ = 0;
      ...
      public emu.grasscutter.net.proto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify buildPartial() {
        ...
        result.unk3250POLIENBCNLF_ = unk3250POLIENBCNLF_;
        result.unk3250LJHJIBDPBBC_ = unk3250LJHJIBDPBBC_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify other) {
        ...
        if (other.getUnk3250POLIENBCNLF() != 0) {
          setUnk3250POLIENBCNLF(other.getUnk3250POLIENBCNLF());
        }
        if (other.getUnk3250LJHJIBDPBBC() != 0) {
          setUnk3250LJHJIBDPBBC(other.getUnk3250LJHJIBDPBBC());
        }
      ...
      /**
       * <code>uint32 Unk3250_POLIENBCNLF = 7;</code>
       * @param value The unk3250POLIENBCNLF to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250POLIENBCNLF(int value) {
        
        unk3250POLIENBCNLF_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250POLIENBCNLF() {
      ...
      /**
       * <code>uint32 Unk3250_LJHJIBDPBBC = 10;</code>
       * @param value The unk3250LJHJIBDPBBC to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LJHJIBDPBBC(int value) {
        
        unk3250LJHJIBDPBBC_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LJHJIBDPBBC() {
  ...
  static {
    ...
    internal_static_TriggerRoguelikeCurseNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TriggerRoguelikeCurseNotify_descriptor,
        new java.lang.String[] { "Unk3250POLIENBCNLF", "Unk3250LJHJIBDPBBC", "IsTriggerCurse", "EffectParamList", });
  }
