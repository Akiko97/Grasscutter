...
public final class EvtBulletHitNotifyOuterClass {
  ...
  public interface EvtBulletHitNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_ELNFDKNGHFP = 4;</code>
     * @return The unk3250ELNFDKNGHFP.
     */
    int getUnk3250ELNFDKNGHFP();
    ...
    /**
     * <code>uint32 Unk3250_KANAJBJHCLG = 6;</code>
     * @return The unk3250KANAJBJHCLG.
     */
    int getUnk3250KANAJBJHCLG();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              unk3250ELNFDKNGHFP_ = input.readUInt32();
              break;
            }
            case 48: {

              unk3250KANAJBJHCLG_ = input.readUInt32();
              break;
            }
            case 66: {
    ...
    public static final int UNK3250_ELNFDKNGHFP_FIELD_NUMBER = 4;
    private int unk3250ELNFDKNGHFP_;
    /**
     * <code>uint32 Unk3250_ELNFDKNGHFP = 4;</code>
     * @return The unk3250ELNFDKNGHFP.
     */
    @java.lang.Override
    public int getUnk3250ELNFDKNGHFP() {
      return unk3250ELNFDKNGHFP_;
    }
    ...
    public static final int UNK3250_KANAJBJHCLG_FIELD_NUMBER = 6;
    private int unk3250KANAJBJHCLG_;
    /**
     * <code>uint32 Unk3250_KANAJBJHCLG = 6;</code>
     * @return The unk3250KANAJBJHCLG.
     */
    @java.lang.Override
    public int getUnk3250KANAJBJHCLG() {
      return unk3250KANAJBJHCLG_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250ELNFDKNGHFP_ != 0) {
        output.writeUInt32(4, unk3250ELNFDKNGHFP_);
      }
      if (unk3250KANAJBJHCLG_ != 0) {
        output.writeUInt32(6, unk3250KANAJBJHCLG_);
      }
      if (hitPoint_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250ELNFDKNGHFP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, unk3250ELNFDKNGHFP_);
      }
      if (unk3250KANAJBJHCLG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, unk3250KANAJBJHCLG_);
      }
      if (hitPoint_ != null) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250ELNFDKNGHFP()
          != other.getUnk3250ELNFDKNGHFP()) return false;
      if (hasHitNormal() != other.hasHitNormal()) return false;
      if (hasHitNormal()) {
        if (!getHitNormal()
            .equals(other.getHitNormal())) return false;
      }
      if (getUnk3250KANAJBJHCLG()
          != other.getUnk3250KANAJBJHCLG()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_ELNFDKNGHFP_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250ELNFDKNGHFP();
      if (hasHitNormal()) {
        hash = (37 * hash) + HIT_NORMAL_FIELD_NUMBER;
        hash = (53 * hash) + getHitNormal().hashCode();
      }
      hash = (37 * hash) + UNK3250_KANAJBJHCLG_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250KANAJBJHCLG();
      if (hasHitPoint()) {
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify buildPartial() {
        ...
        result.unk3250ELNFDKNGHFP_ = unk3250ELNFDKNGHFP_;
        if (hitNormalBuilder_ == null) {
          result.hitNormal_ = hitNormal_;
        } else {
          result.hitNormal_ = hitNormalBuilder_.build();
        }
        result.unk3250KANAJBJHCLG_ = unk3250KANAJBJHCLG_;
        if (hitPointBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.EvtBulletHitNotifyOuterClass.EvtBulletHitNotify other) {
        ...
        if (other.getUnk3250ELNFDKNGHFP() != 0) {
          setUnk3250ELNFDKNGHFP(other.getUnk3250ELNFDKNGHFP());
        }
        if (other.hasHitNormal()) {
          mergeHitNormal(other.getHitNormal());
        }
        if (other.getUnk3250KANAJBJHCLG() != 0) {
          setUnk3250KANAJBJHCLG(other.getUnk3250KANAJBJHCLG());
        }
      ...
      /**
       * <code>uint32 Unk3250_ELNFDKNGHFP = 4;</code>
       * @param value The unk3250ELNFDKNGHFP to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250ELNFDKNGHFP(int value) {
        
        unk3250ELNFDKNGHFP_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250ELNFDKNGHFP() {
      ...
      /**
       * <code>uint32 Unk3250_KANAJBJHCLG = 6;</code>
       * @param value The unk3250KANAJBJHCLG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250KANAJBJHCLG(int value) {
        
        unk3250KANAJBJHCLG_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250KANAJBJHCLG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\033\n\023Unk3250_KANAJBJHCLG\030\006 \001(\r\022\032\n\thit_poin" +
    ...
    internal_static_EvtBulletHitNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EvtBulletHitNotify_descriptor,
        new java.lang.String[] { "ForwardType", "Unk3250ELNFDKNGHFP", "HitNormal", "Unk3250KANAJBJHCLG", "HitPoint", "HitColliderType", "EntityId", "ForwardPeer", "HitBoxIndex", });
    emu.grasscutter.net.proto.ForwardTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.HitColliderTypeOuterClass.getDescriptor();
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
