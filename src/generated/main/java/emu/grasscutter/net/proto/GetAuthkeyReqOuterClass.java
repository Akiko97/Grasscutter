...
public final class GetAuthkeyReqOuterClass {
  ...
  public interface GetAuthkeyReqOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_FGBHHPOKCJH = 6;</code>
     * @return The unk3250FGBHHPOKCJH.
     */
    int getUnk3250FGBHHPOKCJH();
    ...
    /**
     * <code>uint32 Unk3250_DODLFCNOAMB = 15;</code>
     * @return The unk3250DODLFCNOAMB.
     */
    int getUnk3250DODLFCNOAMB();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 48: {
              ...
              unk3250FGBHHPOKCJH_ = input.readUInt32();
              break;
            }
            case 106: {
            ...
            case 120: {
              ...
              unk3250DODLFCNOAMB_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_FGBHHPOKCJH_FIELD_NUMBER = 6;
    private int unk3250FGBHHPOKCJH_;
    /**
     * <code>uint32 Unk3250_FGBHHPOKCJH = 6;</code>
     * @return The unk3250FGBHHPOKCJH.
     */
    @java.lang.Override
    public int getUnk3250FGBHHPOKCJH() {
      return unk3250FGBHHPOKCJH_;
    }
    ...
    public static final int UNK3250_DODLFCNOAMB_FIELD_NUMBER = 15;
    private int unk3250DODLFCNOAMB_;
    /**
     * <code>uint32 Unk3250_DODLFCNOAMB = 15;</code>
     * @return The unk3250DODLFCNOAMB.
     */
    @java.lang.Override
    public int getUnk3250DODLFCNOAMB() {
      return unk3250DODLFCNOAMB_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250FGBHHPOKCJH_ != 0) {
        output.writeUInt32(6, unk3250FGBHHPOKCJH_);
      }
      ...
      if (unk3250DODLFCNOAMB_ != 0) {
        output.writeUInt32(15, unk3250DODLFCNOAMB_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250FGBHHPOKCJH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, unk3250FGBHHPOKCJH_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(authAppid_)) {
      ...
      if (unk3250DODLFCNOAMB_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(15, unk3250DODLFCNOAMB_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250FGBHHPOKCJH()
          != other.getUnk3250FGBHHPOKCJH()) return false;
      if (!getAuthAppid()
          .equals(other.getAuthAppid())) return false;
      if (getUnk3250DODLFCNOAMB()
          != other.getUnk3250DODLFCNOAMB()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_FGBHHPOKCJH_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250FGBHHPOKCJH();
      hash = (37 * hash) + AUTH_APPID_FIELD_NUMBER;
      hash = (53 * hash) + getAuthAppid().hashCode();
      hash = (37 * hash) + UNK3250_DODLFCNOAMB_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250DODLFCNOAMB();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250FGBHHPOKCJH_ = 0;

        authAppid_ = "";

        unk3250DODLFCNOAMB_ = 0;
      ...
      public emu.grasscutter.net.proto.GetAuthkeyReqOuterClass.GetAuthkeyReq buildPartial() {
        ...
        result.unk3250FGBHHPOKCJH_ = unk3250FGBHHPOKCJH_;
        result.authAppid_ = authAppid_;
        result.unk3250DODLFCNOAMB_ = unk3250DODLFCNOAMB_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GetAuthkeyReqOuterClass.GetAuthkeyReq other) {
        ...
        if (other.getUnk3250FGBHHPOKCJH() != 0) {
          setUnk3250FGBHHPOKCJH(other.getUnk3250FGBHHPOKCJH());
        }
        if (!other.getAuthAppid().isEmpty()) {
          authAppid_ = other.authAppid_;
          onChanged();
        }
        if (other.getUnk3250DODLFCNOAMB() != 0) {
          setUnk3250DODLFCNOAMB(other.getUnk3250DODLFCNOAMB());
        }
      ...
      /**
       * <code>uint32 Unk3250_FGBHHPOKCJH = 6;</code>
       * @param value The unk3250FGBHHPOKCJH to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250FGBHHPOKCJH(int value) {
        
        unk3250FGBHHPOKCJH_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250FGBHHPOKCJH() {
  ...
  checkByteStringIsUtf8(value);
      ...
      /**
       * <code>uint32 Unk3250_DODLFCNOAMB = 15;</code>
       * @param value The unk3250DODLFCNOAMB to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250DODLFCNOAMB(int value) {
        
        unk3250DODLFCNOAMB_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250DODLFCNOAMB() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\023Unk3250_FGBHHPOKCJH\030\006 \001(\r\022\022\n\nauth_appi" +
      "d\030\r \001(\t\022\033\n\023Unk3250_DODLFCNOAMB\030\017 \001(\rB\033\n\031" +
    ...
    internal_static_GetAuthkeyReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GetAuthkeyReq_descriptor,
        new java.lang.String[] { "Unk3250FGBHHPOKCJH", "AuthAppid", "Unk3250DODLFCNOAMB", });
  }
