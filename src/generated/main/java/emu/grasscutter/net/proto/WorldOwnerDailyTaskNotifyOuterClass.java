...
public final class WorldOwnerDailyTaskNotifyOuterClass {
  ...
  public interface WorldOwnerDailyTaskNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_FJOJFPPPOFP = 4;</code>
     * @return The unk3250FJOJFPPPOFP.
     */
    int getUnk3250FJOJFPPPOFP();
    ...
    /**
     * <code>uint32 Unk3250_NADIOIJGPHE = 9;</code>
     * @return The unk3250NADIOIJGPHE.
     */
    int getUnk3250NADIOIJGPHE();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              unk3250FJOJFPPPOFP_ = input.readUInt32();
              break;
            }
            case 72: {

              unk3250NADIOIJGPHE_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_FJOJFPPPOFP_FIELD_NUMBER = 4;
    private int unk3250FJOJFPPPOFP_;
    /**
     * <code>uint32 Unk3250_FJOJFPPPOFP = 4;</code>
     * @return The unk3250FJOJFPPPOFP.
     */
    @java.lang.Override
    public int getUnk3250FJOJFPPPOFP() {
      return unk3250FJOJFPPPOFP_;
    }
    ...
    public static final int UNK3250_NADIOIJGPHE_FIELD_NUMBER = 9;
    private int unk3250NADIOIJGPHE_;
    /**
     * <code>uint32 Unk3250_NADIOIJGPHE = 9;</code>
     * @return The unk3250NADIOIJGPHE.
     */
    @java.lang.Override
    public int getUnk3250NADIOIJGPHE() {
      return unk3250NADIOIJGPHE_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250FJOJFPPPOFP_ != 0) {
        output.writeUInt32(4, unk3250FJOJFPPPOFP_);
      }
      if (unk3250NADIOIJGPHE_ != 0) {
        output.writeUInt32(9, unk3250NADIOIJGPHE_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250FJOJFPPPOFP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, unk3250FJOJFPPPOFP_);
      }
      if (unk3250NADIOIJGPHE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, unk3250NADIOIJGPHE_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250FJOJFPPPOFP()
          != other.getUnk3250FJOJFPPPOFP()) return false;
      if (!getTaskListList()
          .equals(other.getTaskListList())) return false;
      if (getUnk3250NADIOIJGPHE()
          != other.getUnk3250NADIOIJGPHE()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_FJOJFPPPOFP_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250FJOJFPPPOFP();
      if (getTaskListCount() > 0) {
        hash = (37 * hash) + TASK_LIST_FIELD_NUMBER;
        hash = (53 * hash) + getTaskListList().hashCode();
      }
      hash = (37 * hash) + UNK3250_NADIOIJGPHE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250NADIOIJGPHE();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify buildPartial() {
        ...
        result.unk3250FJOJFPPPOFP_ = unk3250FJOJFPPPOFP_;
        if (taskListBuilder_ == null) {
        ...
        result.unk3250NADIOIJGPHE_ = unk3250NADIOIJGPHE_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.WorldOwnerDailyTaskNotifyOuterClass.WorldOwnerDailyTaskNotify other) {
        ...
        if (other.getUnk3250FJOJFPPPOFP() != 0) {
          setUnk3250FJOJFPPPOFP(other.getUnk3250FJOJFPPPOFP());
        }
        if (taskListBuilder_ == null) {
        ...
        if (other.getUnk3250NADIOIJGPHE() != 0) {
          setUnk3250NADIOIJGPHE(other.getUnk3250NADIOIJGPHE());
        }
      ...
      /**
       * <code>uint32 Unk3250_FJOJFPPPOFP = 4;</code>
       * @param value The unk3250FJOJFPPPOFP to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250FJOJFPPPOFP(int value) {
        
        unk3250FJOJFPPPOFP_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250FJOJFPPPOFP() {
      ...
      /**
       * <code>uint32 Unk3250_NADIOIJGPHE = 9;</code>
       * @param value The unk3250NADIOIJGPHE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NADIOIJGPHE(int value) {
        
        unk3250NADIOIJGPHE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NADIOIJGPHE() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ify\022\033\n\023Unk3250_FJOJFPPPOFP\030\004 \001(\r\022!\n\ttask" +
    ...
    internal_static_WorldOwnerDailyTaskNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_WorldOwnerDailyTaskNotify_descriptor,
        new java.lang.String[] { "Unk3250FJOJFPPPOFP", "TaskList", "Unk3250NADIOIJGPHE", });
    emu.grasscutter.net.proto.DailyTaskInfoOuterClass.getDescriptor();
  }
