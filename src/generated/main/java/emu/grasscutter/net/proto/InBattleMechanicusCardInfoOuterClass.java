...
public final class InBattleMechanicusCardInfoOuterClass {
  ...
  public interface InBattleMechanicusCardInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_KCIEINMEPDH = 2;</code>
     * @return The unk3250KCIEINMEPDH.
     */
    int getUnk3250KCIEINMEPDH();

    /**
     * <code>uint32 Unk3250_NDAOOKKGJPH = 7;</code>
     * @return The unk3250NDAOOKKGJPH.
     */
    int getUnk3250NDAOOKKGJPH();
    ...
    /**
     * <code>uint32 Unk3250_FNAHKHODBKN = 13;</code>
     * @return The unk3250FNAHKHODBKN.
     */
    int getUnk3250FNAHKHODBKN();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              unk3250KCIEINMEPDH_ = input.readUInt32();
              break;
            }
            case 24: {
            ...
            case 56: {
              ...
              unk3250NDAOOKKGJPH_ = input.readUInt32();
              break;
            }
            case 104: {

              unk3250FNAHKHODBKN_ = input.readUInt32();
              break;
            }
            case 120: {
    ...
    public static final int UNK3250_KCIEINMEPDH_FIELD_NUMBER = 2;
    private int unk3250KCIEINMEPDH_;
    /**
     * <code>uint32 Unk3250_KCIEINMEPDH = 2;</code>
     * @return The unk3250KCIEINMEPDH.
     */
    @java.lang.Override
    public int getUnk3250KCIEINMEPDH() {
      return unk3250KCIEINMEPDH_;
    }

    public static final int UNK3250_NDAOOKKGJPH_FIELD_NUMBER = 7;
    private int unk3250NDAOOKKGJPH_;
    /**
     * <code>uint32 Unk3250_NDAOOKKGJPH = 7;</code>
     * @return The unk3250NDAOOKKGJPH.
     */
    @java.lang.Override
    public int getUnk3250NDAOOKKGJPH() {
      return unk3250NDAOOKKGJPH_;
    }
    ...
    public static final int UNK3250_FNAHKHODBKN_FIELD_NUMBER = 13;
    private int unk3250FNAHKHODBKN_;
    /**
     * <code>uint32 Unk3250_FNAHKHODBKN = 13;</code>
     * @return The unk3250FNAHKHODBKN.
     */
    @java.lang.Override
    public int getUnk3250FNAHKHODBKN() {
      return unk3250FNAHKHODBKN_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250KCIEINMEPDH_ != 0) {
        output.writeUInt32(2, unk3250KCIEINMEPDH_);
      }
      if (cardId_ != 0) {
      ...
      if (unk3250NDAOOKKGJPH_ != 0) {
        output.writeUInt32(7, unk3250NDAOOKKGJPH_);
      }
      if (unk3250FNAHKHODBKN_ != 0) {
        output.writeUInt32(13, unk3250FNAHKHODBKN_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250KCIEINMEPDH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, unk3250KCIEINMEPDH_);
      }
      if (cardId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250NDAOOKKGJPH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250NDAOOKKGJPH_);
      }
      if (unk3250FNAHKHODBKN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, unk3250FNAHKHODBKN_);
      }
      if (challengeState_ != emu.grasscutter.net.proto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState.IN_BATTLE_MECHANICUS_CARD_CHALLENGE_STATE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250KCIEINMEPDH()
          != other.getUnk3250KCIEINMEPDH()) return false;
      if (getUnk3250NDAOOKKGJPH()
          != other.getUnk3250NDAOOKKGJPH()) return false;
      if (getCostPoints()
          != other.getCostPoints()) return false;
      if (getCardId()
          != other.getCardId()) return false;
      if (getUnk3250FNAHKHODBKN()
          != other.getUnk3250FNAHKHODBKN()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_KCIEINMEPDH_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250KCIEINMEPDH();
      hash = (37 * hash) + UNK3250_NDAOOKKGJPH_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250NDAOOKKGJPH();
      hash = (37 * hash) + COST_POINTS_FIELD_NUMBER;
      hash = (53 * hash) + getCostPoints();
      hash = (37 * hash) + CARD_ID_FIELD_NUMBER;
      hash = (53 * hash) + getCardId();
      hash = (37 * hash) + UNK3250_FNAHKHODBKN_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250FNAHKHODBKN();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250KCIEINMEPDH_ = 0;

        unk3250NDAOOKKGJPH_ = 0;

        costPoints_ = 0;

        cardId_ = 0;

        unk3250FNAHKHODBKN_ = 0;
      ...
      public emu.grasscutter.net.proto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo buildPartial() {
        ...
        result.unk3250KCIEINMEPDH_ = unk3250KCIEINMEPDH_;
        result.unk3250NDAOOKKGJPH_ = unk3250NDAOOKKGJPH_;
        result.costPoints_ = costPoints_;
        result.cardId_ = cardId_;
        result.unk3250FNAHKHODBKN_ = unk3250FNAHKHODBKN_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo other) {
        ...
        if (other.getUnk3250KCIEINMEPDH() != 0) {
          setUnk3250KCIEINMEPDH(other.getUnk3250KCIEINMEPDH());
        }
        if (other.getUnk3250NDAOOKKGJPH() != 0) {
          setUnk3250NDAOOKKGJPH(other.getUnk3250NDAOOKKGJPH());
        }
        ...
        if (other.getUnk3250FNAHKHODBKN() != 0) {
          setUnk3250FNAHKHODBKN(other.getUnk3250FNAHKHODBKN());
        }
      ...
      /**
       * <code>uint32 Unk3250_KCIEINMEPDH = 2;</code>
       * @param value The unk3250KCIEINMEPDH to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250KCIEINMEPDH(int value) {
        
        unk3250KCIEINMEPDH_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250KCIEINMEPDH() {
      ...
      /**
       * <code>uint32 Unk3250_NDAOOKKGJPH = 7;</code>
       * @param value The unk3250NDAOOKKGJPH to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NDAOOKKGJPH(int value) {
        
        unk3250NDAOOKKGJPH_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NDAOOKKGJPH() {
      ...
      /**
       * <code>uint32 Unk3250_FNAHKHODBKN = 13;</code>
       * @param value The unk3250FNAHKHODBKN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250FNAHKHODBKN(int value) {
        
        unk3250FNAHKHODBKN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250FNAHKHODBKN() {
  ...
  static {
    ...
    internal_static_InBattleMechanicusCardInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_InBattleMechanicusCardInfo_descriptor,
        new java.lang.String[] { "Unk3250KCIEINMEPDH", "Unk3250NDAOOKKGJPH", "CostPoints", "CardId", "Unk3250FNAHKHODBKN", "ChallengeState", });
    emu.grasscutter.net.proto.InBattleMechanicusCardChallengeStateOuterClass.getDescriptor();
  }
