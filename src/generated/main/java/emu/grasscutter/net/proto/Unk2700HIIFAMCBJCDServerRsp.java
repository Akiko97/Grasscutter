...
public final class Unk2700HIIFAMCBJCDServerRsp {
  ...
  public interface Unk2700_HIIFAMCBJCD_ServerRspOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_CPFIBCBFKJH = 14;</code>
     * @return The unk3250CPFIBCBFKJH.
     */
    int getUnk3250CPFIBCBFKJH();
    ...
    /**
     * <code>uint32 Unk3250_IMFMIODOMDK = 4;</code>
     * @return The unk3250IMFMIODOMDK.
     */
    int getUnk3250IMFMIODOMDK();
  }
  /**
   * <pre>
   * CmdId: 4208
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              unk3250IMFMIODOMDK_ = input.readUInt32();
              break;
            }
            case 40: {
            ...
            case 112: {
              ...
              unk3250CPFIBCBFKJH_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_CPFIBCBFKJH_FIELD_NUMBER = 14;
    private int unk3250CPFIBCBFKJH_;
    /**
     * <code>uint32 Unk3250_CPFIBCBFKJH = 14;</code>
     * @return The unk3250CPFIBCBFKJH.
     */
    @java.lang.Override
    public int getUnk3250CPFIBCBFKJH() {
      return unk3250CPFIBCBFKJH_;
    }
    ...
    public static final int UNK3250_IMFMIODOMDK_FIELD_NUMBER = 4;
    private int unk3250IMFMIODOMDK_;
    /**
     * <code>uint32 Unk3250_IMFMIODOMDK = 4;</code>
     * @return The unk3250IMFMIODOMDK.
     */
    @java.lang.Override
    public int getUnk3250IMFMIODOMDK() {
      return unk3250IMFMIODOMDK_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250IMFMIODOMDK_ != 0) {
        output.writeUInt32(4, unk3250IMFMIODOMDK_);
      }
      if (retcode_ != 0) {
        output.writeInt32(5, retcode_);
      }
      if (unk3250CPFIBCBFKJH_ != 0) {
        output.writeUInt32(14, unk3250CPFIBCBFKJH_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250IMFMIODOMDK_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, unk3250IMFMIODOMDK_);
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250CPFIBCBFKJH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, unk3250CPFIBCBFKJH_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250CPFIBCBFKJH()
          != other.getUnk3250CPFIBCBFKJH()) return false;
      if (getRetcode()
          != other.getRetcode()) return false;
      if (getUnk3250IMFMIODOMDK()
          != other.getUnk3250IMFMIODOMDK()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_CPFIBCBFKJH_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250CPFIBCBFKJH();
      hash = (37 * hash) + RETCODE_FIELD_NUMBER;
      hash = (53 * hash) + getRetcode();
      hash = (37 * hash) + UNK3250_IMFMIODOMDK_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IMFMIODOMDK();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250CPFIBCBFKJH_ = 0;

        retcode_ = 0;

        unk3250IMFMIODOMDK_ = 0;
      ...
      public emu.grasscutter.net.proto.Unk2700HIIFAMCBJCDServerRsp.Unk2700_HIIFAMCBJCD_ServerRsp buildPartial() {
        ...
        result.unk3250CPFIBCBFKJH_ = unk3250CPFIBCBFKJH_;
        result.retcode_ = retcode_;
        result.unk3250IMFMIODOMDK_ = unk3250IMFMIODOMDK_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.Unk2700HIIFAMCBJCDServerRsp.Unk2700_HIIFAMCBJCD_ServerRsp other) {
        ...
        if (other.getUnk3250CPFIBCBFKJH() != 0) {
          setUnk3250CPFIBCBFKJH(other.getUnk3250CPFIBCBFKJH());
        }
        if (other.getRetcode() != 0) {
          setRetcode(other.getRetcode());
        }
        if (other.getUnk3250IMFMIODOMDK() != 0) {
          setUnk3250IMFMIODOMDK(other.getUnk3250IMFMIODOMDK());
        }
      ...
      /**
       * <code>uint32 Unk3250_CPFIBCBFKJH = 14;</code>
       * @param value The unk3250CPFIBCBFKJH to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250CPFIBCBFKJH(int value) {
        
        unk3250CPFIBCBFKJH_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250CPFIBCBFKJH() {
      ...
      /**
       * <code>uint32 Unk3250_IMFMIODOMDK = 4;</code>
       * @param value The unk3250IMFMIODOMDK to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IMFMIODOMDK(int value) {
        
        unk3250IMFMIODOMDK_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IMFMIODOMDK() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n#Unk2700_HIIFAMCBJCD_ServerRsp.proto\"j\n" +
      "\035Unk2700_HIIFAMCBJCD_ServerRsp\022\033\n\023Unk325" +
      "0_CPFIBCBFKJH\030\016 \001(\r\022\017\n\007retcode\030\005 \001(\005\022\033\n\023" +
      "Unk3250_IMFMIODOMDK\030\004 \001(\rB\033\n\031emu.grasscu" +
    ...
    internal_static_Unk2700_HIIFAMCBJCD_ServerRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_Unk2700_HIIFAMCBJCD_ServerRsp_descriptor,
        new java.lang.String[] { "Unk3250CPFIBCBFKJH", "Retcode", "Unk3250IMFMIODOMDK", });
  }
