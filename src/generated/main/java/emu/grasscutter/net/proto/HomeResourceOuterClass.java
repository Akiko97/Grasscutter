...
public final class HomeResourceOuterClass {
  ...
  public interface HomeResourceOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_LJCAIDECBND = 6;</code>
     * @return The unk3250LJCAIDECBND.
     */
    int getUnk3250LJCAIDECBND();
    ...
    /**
     * <code>uint32 Unk3250_LINAPIIPNOB = 1;</code>
     * @return The unk3250LINAPIIPNOB.
     */
    int getUnk3250LINAPIIPNOB();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              unk3250LINAPIIPNOB_ = input.readUInt32();
              break;
            }
            case 48: {

              unk3250LJCAIDECBND_ = input.readUInt32();
              break;
            }
            case 109: {
    ...
    public static final int UNK3250_LJCAIDECBND_FIELD_NUMBER = 6;
    private int unk3250LJCAIDECBND_;
    /**
     * <code>uint32 Unk3250_LJCAIDECBND = 6;</code>
     * @return The unk3250LJCAIDECBND.
     */
    @java.lang.Override
    public int getUnk3250LJCAIDECBND() {
      return unk3250LJCAIDECBND_;
    }
    ...
    public static final int UNK3250_LINAPIIPNOB_FIELD_NUMBER = 1;
    private int unk3250LINAPIIPNOB_;
    /**
     * <code>uint32 Unk3250_LINAPIIPNOB = 1;</code>
     * @return The unk3250LINAPIIPNOB.
     */
    @java.lang.Override
    public int getUnk3250LINAPIIPNOB() {
      return unk3250LINAPIIPNOB_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250LINAPIIPNOB_ != 0) {
        output.writeUInt32(1, unk3250LINAPIIPNOB_);
      }
      if (unk3250LJCAIDECBND_ != 0) {
        output.writeUInt32(6, unk3250LJCAIDECBND_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250LINAPIIPNOB_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, unk3250LINAPIIPNOB_);
      }
      if (unk3250LJCAIDECBND_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, unk3250LJCAIDECBND_);
      }
      if (nextRefreshTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250LJCAIDECBND()
          != other.getUnk3250LJCAIDECBND()) return false;
      if (getNextRefreshTime()
          != other.getNextRefreshTime()) return false;
      if (getUnk3250LINAPIIPNOB()
          != other.getUnk3250LINAPIIPNOB()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_LJCAIDECBND_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LJCAIDECBND();
      hash = (37 * hash) + NEXT_REFRESH_TIME_FIELD_NUMBER;
      hash = (53 * hash) + getNextRefreshTime();
      hash = (37 * hash) + UNK3250_LINAPIIPNOB_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LINAPIIPNOB();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250LJCAIDECBND_ = 0;

        nextRefreshTime_ = 0;

        unk3250LINAPIIPNOB_ = 0;
      ...
      public emu.grasscutter.net.proto.HomeResourceOuterClass.HomeResource buildPartial() {
        ...
        result.unk3250LJCAIDECBND_ = unk3250LJCAIDECBND_;
        result.nextRefreshTime_ = nextRefreshTime_;
        result.unk3250LINAPIIPNOB_ = unk3250LINAPIIPNOB_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.HomeResourceOuterClass.HomeResource other) {
        ...
        if (other.getUnk3250LJCAIDECBND() != 0) {
          setUnk3250LJCAIDECBND(other.getUnk3250LJCAIDECBND());
        }
        if (other.getNextRefreshTime() != 0) {
          setNextRefreshTime(other.getNextRefreshTime());
        }
        if (other.getUnk3250LINAPIIPNOB() != 0) {
          setUnk3250LINAPIIPNOB(other.getUnk3250LINAPIIPNOB());
        }
      ...
      /**
       * <code>uint32 Unk3250_LJCAIDECBND = 6;</code>
       * @param value The unk3250LJCAIDECBND to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LJCAIDECBND(int value) {
        
        unk3250LJCAIDECBND_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LJCAIDECBND() {
      ...
      /**
       * <code>uint32 Unk3250_LINAPIIPNOB = 1;</code>
       * @param value The unk3250LINAPIIPNOB to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LINAPIIPNOB(int value) {
        
        unk3250LINAPIIPNOB_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LINAPIIPNOB() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Unk3250_LJCAIDECBND\030\006 \001(\r\022\031\n\021next_refres" +
      "h_time\030\r \001(\007\022\033\n\023Unk3250_LINAPIIPNOB\030\001 \001(" +
    ...
    internal_static_HomeResource_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomeResource_descriptor,
        new java.lang.String[] { "Unk3250LJCAIDECBND", "NextRefreshTime", "Unk3250LINAPIIPNOB", });
  }
