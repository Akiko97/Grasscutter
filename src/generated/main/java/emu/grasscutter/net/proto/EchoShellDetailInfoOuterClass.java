...
public final class EchoShellDetailInfoOuterClass {
  ...
  public interface EchoShellDetailInfoOrBuilder extends
    ...
    /**
     * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
     * @return A list containing the unk3250OOCDFANFFDG.
     */
    java.util.List<java.lang.Integer> getUnk3250OOCDFANFFDGList();
    /**
     * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
     * @return The count of unk3250OOCDFANFFDG.
     */
    int getUnk3250OOCDFANFFDGCount();
    /**
     * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
     * @param index The index of the element to return.
     * @return The unk3250OOCDFANFFDG at the given index.
     */
    int getUnk3250OOCDFANFFDG(int index);
    ...
    /**
     * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
     * @return A list containing the unk3250NEFBJPKBEHF.
     */
    java.util.List<java.lang.Integer> getUnk3250NEFBJPKBEHFList();
    /**
     * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
     * @return The count of unk3250NEFBJPKBEHF.
     */
    int getUnk3250NEFBJPKBEHFCount();
    /**
     * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
     * @param index The index of the element to return.
     * @return The unk3250NEFBJPKBEHF at the given index.
     */
    int getUnk3250NEFBJPKBEHF(int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private EchoShellDetailInfo(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 48: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                unk3250OOCDFANFFDG_ = newIntList();
                mutable_bitField0_ |= 0x00000001;
              }
              unk3250OOCDFANFFDG_.addInt(input.readUInt32());
              break;
            }
            case 50: {
              int length = input.readRawVarint32();
            ...
            case 80: {
              if (!((mutable_bitField0_ & 0x00000008) != 0)) {
                unk3250NEFBJPKBEHF_ = newIntList();
                mutable_bitField0_ |= 0x00000008;
              }
              unk3250NEFBJPKBEHF_.addInt(input.readUInt32());
              break;
            }
            case 82: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          unk3250OOCDFANFFDG_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000008) != 0)) {
          unk3250NEFBJPKBEHF_.makeImmutable(); // C
        }
    ...
    public static final int UNK3250_OOCDFANFFDG_FIELD_NUMBER = 6;
    private com.google.protobuf.Internal.IntList unk3250OOCDFANFFDG_;
    /**
     * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
     * @return A list containing the unk3250OOCDFANFFDG.
     */
    ...
    public java.util.List<java.lang.Integer>
        getUnk3250OOCDFANFFDGList() {
      return unk3250OOCDFANFFDG_;
    }
    /**
     * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
     * @return The count of unk3250OOCDFANFFDG.
     */
    public int getUnk3250OOCDFANFFDGCount() {
      return unk3250OOCDFANFFDG_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
     * @param index The index of the element to return.
     * @return The unk3250OOCDFANFFDG at the given index.
     */
    public int getUnk3250OOCDFANFFDG(int index) {
      return unk3250OOCDFANFFDG_.getInt(index);
    }
    private int unk3250OOCDFANFFDGMemoizedSerializedSize = -1;
    ...
    public static final int UNK3250_NEFBJPKBEHF_FIELD_NUMBER = 10;
    private com.google.protobuf.Internal.IntList unk3250NEFBJPKBEHF_;
    /**
     * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
     * @return A list containing the unk3250NEFBJPKBEHF.
     */
    @java.lang.Override
    public java.util.List<java.lang.Integer>
        getUnk3250NEFBJPKBEHFList() {
      return unk3250NEFBJPKBEHF_;
    }
    /**
     * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
     * @return The count of unk3250NEFBJPKBEHF.
     */
    public int getUnk3250NEFBJPKBEHFCount() {
      return unk3250NEFBJPKBEHF_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
     * @param index The index of the element to return.
     * @return The unk3250NEFBJPKBEHF at the given index.
     */
    public int getUnk3250NEFBJPKBEHF(int index) {
      return unk3250NEFBJPKBEHF_.getInt(index);
    }
    private int unk3250NEFBJPKBEHFMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (getUnk3250OOCDFANFFDGList().size() > 0) {
        output.writeUInt32NoTag(50);
        output.writeUInt32NoTag(unk3250OOCDFANFFDGMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250OOCDFANFFDG_.size(); i++) {
        output.writeUInt32NoTag(unk3250OOCDFANFFDG_.getInt(i));
      }
      if (getUnk3250NEFBJPKBEHFList().size() > 0) {
        output.writeUInt32NoTag(82);
        output.writeUInt32NoTag(unk3250NEFBJPKBEHFMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250NEFBJPKBEHF_.size(); i++) {
        output.writeUInt32NoTag(unk3250NEFBJPKBEHF_.getInt(i));
      }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < unk3250OOCDFANFFDG_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250OOCDFANFFDG_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250OOCDFANFFDGList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250OOCDFANFFDGMemoizedSerializedSize = dataSize;
      }
      {
        int dataSize = 0;
        for (int i = 0; i < unk3250NEFBJPKBEHF_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250NEFBJPKBEHF_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250NEFBJPKBEHFList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250NEFBJPKBEHFMemoizedSerializedSize = dataSize;
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getUnk3250OOCDFANFFDGList()
          .equals(other.getUnk3250OOCDFANFFDGList())) return false;
      ...
      if (!getUnk3250NEFBJPKBEHFList()
          .equals(other.getUnk3250NEFBJPKBEHFList())) return false;
    ...
    public int hashCode() {
      ...
      if (getUnk3250OOCDFANFFDGCount() > 0) {
        hash = (37 * hash) + UNK3250_OOCDFANFFDG_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250OOCDFANFFDGList().hashCode();
      }
      ...
      if (getUnk3250NEFBJPKBEHFCount() > 0) {
        hash = (37 * hash) + UNK3250_NEFBJPKBEHF_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250NEFBJPKBEHFList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo buildPartial() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
          unk3250OOCDFANFFDG_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.unk3250OOCDFANFFDG_ = unk3250OOCDFANFFDG_;
        ...
        if (((bitField0_ & 0x00000008) != 0)) {
          unk3250NEFBJPKBEHF_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000008);
        }
        result.unk3250NEFBJPKBEHF_ = unk3250NEFBJPKBEHF_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo other) {
        ...
        if (!other.unk3250OOCDFANFFDG_.isEmpty()) {
          if (unk3250OOCDFANFFDG_.isEmpty()) {
            unk3250OOCDFANFFDG_ = other.unk3250OOCDFANFFDG_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureUnk3250OOCDFANFFDGIsMutable();
            unk3250OOCDFANFFDG_.addAll(other.unk3250OOCDFANFFDG_);
          }
          onChanged();
        }
        ...
        if (!other.unk3250NEFBJPKBEHF_.isEmpty()) {
          if (unk3250NEFBJPKBEHF_.isEmpty()) {
            unk3250NEFBJPKBEHF_ = other.unk3250NEFBJPKBEHF_;
            bitField0_ = (bitField0_ & ~0x00000008);
          } else {
            ensureUnk3250NEFBJPKBEHFIsMutable();
            unk3250NEFBJPKBEHF_.addAll(other.unk3250NEFBJPKBEHF_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList unk3250OOCDFANFFDG_ = emptyIntList();
      private void ensureUnk3250OOCDFANFFDGIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          unk3250OOCDFANFFDG_ = mutableCopy(unk3250OOCDFANFFDG_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250OOCDFANFFDG_) : unk3250OOCDFANFFDG_;
      }
      /**
       * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
       * @return The count of unk3250OOCDFANFFDG.
       ...
       * @param value The unk3250OOCDFANFFDG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250OOCDFANFFDG(
          int index, int value) {
        ensureUnk3250OOCDFANFFDGIsMutable();
        unk3250OOCDFANFFDG_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
       * @param value The unk3250OOCDFANFFDG to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250OOCDFANFFDG(int value) {
        ensureUnk3250OOCDFANFFDGIsMutable();
        unk3250OOCDFANFFDG_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_OOCDFANFFDG = 6;</code>
       * @param values The unk3250OOCDFANFFDG to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250OOCDFANFFDG(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250OOCDFANFFDGIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250OOCDFANFFDG_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250OOCDFANFFDG() {
        unk3250OOCDFANFFDG_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
        return this;
      ...
      private com.google.protobuf.Internal.IntList unk3250NEFBJPKBEHF_ = emptyIntList();
      private void ensureUnk3250NEFBJPKBEHFIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          unk3250NEFBJPKBEHF_ = mutableCopy(unk3250NEFBJPKBEHF_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000008) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250NEFBJPKBEHF_) : unk3250NEFBJPKBEHF_;
      }
      /**
       * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
       * @return The count of unk3250NEFBJPKBEHF.
       ...
       * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
       * @param index The index to set the value at.
       * @param value The unk3250NEFBJPKBEHF to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NEFBJPKBEHF(
          int index, int value) {
        ensureUnk3250NEFBJPKBEHFIsMutable();
        unk3250NEFBJPKBEHF_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
       * @param value The unk3250NEFBJPKBEHF to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250NEFBJPKBEHF(int value) {
        ensureUnk3250NEFBJPKBEHFIsMutable();
        unk3250NEFBJPKBEHF_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_NEFBJPKBEHF = 10;</code>
       * @param values The unk3250NEFBJPKBEHF to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250NEFBJPKBEHF(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250NEFBJPKBEHFIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250NEFBJPKBEHF_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NEFBJPKBEHF() {
        unk3250NEFBJPKBEHF_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000008);
        onChanged();
        return this;
  ...
  static {
    ...
    internal_static_EchoShellDetailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EchoShellDetailInfo_descriptor,
        new java.lang.String[] { "Unk3250OOCDFANFFDG", "TakenRewardList", "SummerTimeDungeonList", "Unk3250NEFBJPKBEHF", });
    emu.grasscutter.net.proto.SummerTimeDungeonInfoOuterClass.getDescriptor();
  }
