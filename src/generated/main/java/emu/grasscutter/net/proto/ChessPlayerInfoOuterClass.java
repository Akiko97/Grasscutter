...
public final class ChessPlayerInfoOuterClass {
  ...
  public interface ChessPlayerInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_AOCJHOKCDDM = 2;</code>
     * @return The unk3250AOCJHOKCDDM.
     */
    int getUnk3250AOCJHOKCDDM();

    /**
     * <code>uint32 Unk3250_GPNDNCCLHKE = 10;</code>
     * @return The unk3250GPNDNCCLHKE.
     */
    int getUnk3250GPNDNCCLHKE();
    ...
    /**
     * <code>uint32 Unk3250_PPFBGIDKCDJ = 12;</code>
     * @return The unk3250PPFBGIDKCDJ.
     */
    int getUnk3250PPFBGIDKCDJ();

    /**
     * <code>uint32 Unk3250_PPFPEAGBHLP = 13;</code>
     * @return The unk3250PPFPEAGBHLP.
     */
    int getUnk3250PPFPEAGBHLP();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              unk3250AOCJHOKCDDM_ = input.readUInt32();
              break;
            }
            case 40: {
            ...
            case 80: {
              ...
              unk3250GPNDNCCLHKE_ = input.readUInt32();
              break;
            }
            case 96: {

              unk3250PPFBGIDKCDJ_ = input.readUInt32();
              break;
            }
            case 104: {

              unk3250PPFPEAGBHLP_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_AOCJHOKCDDM_FIELD_NUMBER = 2;
    private int unk3250AOCJHOKCDDM_;
    /**
     * <code>uint32 Unk3250_AOCJHOKCDDM = 2;</code>
     * @return The unk3250AOCJHOKCDDM.
     */
    @java.lang.Override
    public int getUnk3250AOCJHOKCDDM() {
      return unk3250AOCJHOKCDDM_;
    }

    public static final int UNK3250_GPNDNCCLHKE_FIELD_NUMBER = 10;
    private int unk3250GPNDNCCLHKE_;
    /**
     * <code>uint32 Unk3250_GPNDNCCLHKE = 10;</code>
     * @return The unk3250GPNDNCCLHKE.
     */
    @java.lang.Override
    public int getUnk3250GPNDNCCLHKE() {
      return unk3250GPNDNCCLHKE_;
    }
    ...
    public static final int UNK3250_PPFBGIDKCDJ_FIELD_NUMBER = 12;
    private int unk3250PPFBGIDKCDJ_;
    /**
     * <code>uint32 Unk3250_PPFBGIDKCDJ = 12;</code>
     * @return The unk3250PPFBGIDKCDJ.
     */
    @java.lang.Override
    public int getUnk3250PPFBGIDKCDJ() {
      return unk3250PPFBGIDKCDJ_;
    }

    public static final int UNK3250_PPFPEAGBHLP_FIELD_NUMBER = 13;
    private int unk3250PPFPEAGBHLP_;
    /**
     * <code>uint32 Unk3250_PPFPEAGBHLP = 13;</code>
     * @return The unk3250PPFPEAGBHLP.
     */
    @java.lang.Override
    public int getUnk3250PPFPEAGBHLP() {
      return unk3250PPFPEAGBHLP_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250AOCJHOKCDDM_ != 0) {
        output.writeUInt32(2, unk3250AOCJHOKCDDM_);
      }
      if (uid_ != 0) {
      ...
      if (unk3250GPNDNCCLHKE_ != 0) {
        output.writeUInt32(10, unk3250GPNDNCCLHKE_);
      }
      if (unk3250PPFBGIDKCDJ_ != 0) {
        output.writeUInt32(12, unk3250PPFBGIDKCDJ_);
      }
      if (unk3250PPFPEAGBHLP_ != 0) {
        output.writeUInt32(13, unk3250PPFPEAGBHLP_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250AOCJHOKCDDM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, unk3250AOCJHOKCDDM_);
      }
      if (uid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250GPNDNCCLHKE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250GPNDNCCLHKE_);
      }
      if (unk3250PPFBGIDKCDJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, unk3250PPFBGIDKCDJ_);
      }
      if (unk3250PPFPEAGBHLP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, unk3250PPFPEAGBHLP_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250AOCJHOKCDDM()
          != other.getUnk3250AOCJHOKCDDM()) return false;
      if (getUnk3250GPNDNCCLHKE()
          != other.getUnk3250GPNDNCCLHKE()) return false;
      if (getBuildingPoints()
          != other.getBuildingPoints()) return false;
      if (getUnk3250PPFBGIDKCDJ()
          != other.getUnk3250PPFBGIDKCDJ()) return false;
      if (getUnk3250PPFPEAGBHLP()
          != other.getUnk3250PPFPEAGBHLP()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + getUid();
      hash = (37 * hash) + UNK3250_AOCJHOKCDDM_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250AOCJHOKCDDM();
      hash = (37 * hash) + UNK3250_GPNDNCCLHKE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250GPNDNCCLHKE();
      hash = (37 * hash) + BUILDING_POINTS_FIELD_NUMBER;
      hash = (53 * hash) + getBuildingPoints();
      hash = (37 * hash) + UNK3250_PPFBGIDKCDJ_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PPFBGIDKCDJ();
      hash = (37 * hash) + UNK3250_PPFPEAGBHLP_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PPFPEAGBHLP();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250AOCJHOKCDDM_ = 0;

        unk3250GPNDNCCLHKE_ = 0;

        buildingPoints_ = 0;

        unk3250PPFBGIDKCDJ_ = 0;

        unk3250PPFPEAGBHLP_ = 0;
      ...
      public emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo buildPartial() {
        ...
        result.uid_ = uid_;
        result.unk3250AOCJHOKCDDM_ = unk3250AOCJHOKCDDM_;
        result.unk3250GPNDNCCLHKE_ = unk3250GPNDNCCLHKE_;
        result.buildingPoints_ = buildingPoints_;
        result.unk3250PPFBGIDKCDJ_ = unk3250PPFBGIDKCDJ_;
        result.unk3250PPFPEAGBHLP_ = unk3250PPFPEAGBHLP_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ChessPlayerInfoOuterClass.ChessPlayerInfo other) {
        ...
        if (other.getUnk3250AOCJHOKCDDM() != 0) {
          setUnk3250AOCJHOKCDDM(other.getUnk3250AOCJHOKCDDM());
        }
        if (other.getUnk3250GPNDNCCLHKE() != 0) {
          setUnk3250GPNDNCCLHKE(other.getUnk3250GPNDNCCLHKE());
        }
        if (other.getBuildingPoints() != 0) {
          setBuildingPoints(other.getBuildingPoints());
        }
        if (other.getUnk3250PPFBGIDKCDJ() != 0) {
          setUnk3250PPFBGIDKCDJ(other.getUnk3250PPFBGIDKCDJ());
        }
        if (other.getUnk3250PPFPEAGBHLP() != 0) {
          setUnk3250PPFPEAGBHLP(other.getUnk3250PPFPEAGBHLP());
        }
      ...
      /**
       * <code>uint32 Unk3250_AOCJHOKCDDM = 2;</code>
       * @param value The unk3250AOCJHOKCDDM to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250AOCJHOKCDDM(int value) {
        
        unk3250AOCJHOKCDDM_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250AOCJHOKCDDM() {
      ...
      /**
       * <code>uint32 Unk3250_GPNDNCCLHKE = 10;</code>
       * @param value The unk3250GPNDNCCLHKE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250GPNDNCCLHKE(int value) {
        
        unk3250GPNDNCCLHKE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250GPNDNCCLHKE() {
      ...
      /**
       * <code>uint32 Unk3250_PPFBGIDKCDJ = 12;</code>
       * @param value The unk3250PPFBGIDKCDJ to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PPFBGIDKCDJ(int value) {
        
        unk3250PPFBGIDKCDJ_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PPFBGIDKCDJ() {
      ...
      /**
       * <code>uint32 Unk3250_PPFPEAGBHLP = 13;</code>
       * @param value The unk3250PPFPEAGBHLP to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PPFPEAGBHLP(int value) {
        
        unk3250PPFPEAGBHLP_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PPFPEAGBHLP() {
  ...
  static {
    ...
    internal_static_ChessPlayerInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ChessPlayerInfo_descriptor,
        new java.lang.String[] { "CandidateCardInfoList", "Uid", "Unk3250AOCJHOKCDDM", "Unk3250GPNDNCCLHKE", "BuildingPoints", "Unk3250PPFBGIDKCDJ", "Unk3250PPFPEAGBHLP", });
    emu.grasscutter.net.proto.ChessNormalCardInfoOuterClass.getDescriptor();
  }
