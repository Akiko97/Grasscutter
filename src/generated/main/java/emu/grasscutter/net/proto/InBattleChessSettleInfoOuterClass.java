...
public final class InBattleChessSettleInfoOuterClass {
  ...
  public interface InBattleChessSettleInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_LPANFEBFJOJ = 5;</code>
     * @return The unk3250LPANFEBFJOJ.
     */
    int getUnk3250LPANFEBFJOJ();
    ...
    /**
     * <code>uint32 Unk3250_NKHDFHAPNCN = 13;</code>
     * @return The unk3250NKHDFHAPNCN.
     */
    int getUnk3250NKHDFHAPNCN();
    ...
    /**
     * <code>uint32 Unk3250_EMNLLDJHMEI = 1;</code>
     * @return The unk3250EMNLLDJHMEI.
     */
    int getUnk3250EMNLLDJHMEI();
    ...
    /**
     * <code>uint32 Unk3250_IPGILJCBABK = 2;</code>
     * @return The unk3250IPGILJCBABK.
     */
    int getUnk3250IPGILJCBABK();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              unk3250EMNLLDJHMEI_ = input.readUInt32();
              break;
            }
            case 16: {

              unk3250IPGILJCBABK_ = input.readUInt32();
              break;
            }
            case 34: {
            ...
            case 40: {
              ...
              unk3250LPANFEBFJOJ_ = input.readUInt32();
              break;
            }
            case 48: {
            ...
            case 104: {
              ...
              unk3250NKHDFHAPNCN_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_LPANFEBFJOJ_FIELD_NUMBER = 5;
    private int unk3250LPANFEBFJOJ_;
    /**
     * <code>uint32 Unk3250_LPANFEBFJOJ = 5;</code>
     * @return The unk3250LPANFEBFJOJ.
     */
    @java.lang.Override
    public int getUnk3250LPANFEBFJOJ() {
      return unk3250LPANFEBFJOJ_;
    }
    ...
    public static final int UNK3250_NKHDFHAPNCN_FIELD_NUMBER = 13;
    private int unk3250NKHDFHAPNCN_;
    /**
     * <code>uint32 Unk3250_NKHDFHAPNCN = 13;</code>
     * @return The unk3250NKHDFHAPNCN.
     */
    @java.lang.Override
    public int getUnk3250NKHDFHAPNCN() {
      return unk3250NKHDFHAPNCN_;
    }
    ...
    public static final int UNK3250_EMNLLDJHMEI_FIELD_NUMBER = 1;
    private int unk3250EMNLLDJHMEI_;
    /**
     * <code>uint32 Unk3250_EMNLLDJHMEI = 1;</code>
     * @return The unk3250EMNLLDJHMEI.
     */
    @java.lang.Override
    public int getUnk3250EMNLLDJHMEI() {
      return unk3250EMNLLDJHMEI_;
    }
    ...
    public static final int UNK3250_IPGILJCBABK_FIELD_NUMBER = 2;
    private int unk3250IPGILJCBABK_;
    /**
     * <code>uint32 Unk3250_IPGILJCBABK = 2;</code>
     * @return The unk3250IPGILJCBABK.
     */
    @java.lang.Override
    public int getUnk3250IPGILJCBABK() {
      return unk3250IPGILJCBABK_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250EMNLLDJHMEI_ != 0) {
        output.writeUInt32(1, unk3250EMNLLDJHMEI_);
      }
      if (unk3250IPGILJCBABK_ != 0) {
        output.writeUInt32(2, unk3250IPGILJCBABK_);
      }
      for (int i = 0; i < scoreList_.size(); i++) {
        output.writeMessage(4, scoreList_.get(i));
      }
      if (unk3250LPANFEBFJOJ_ != 0) {
        output.writeUInt32(5, unk3250LPANFEBFJOJ_);
      }
      if (isSuccess_ != false) {
      ...
      if (unk3250NKHDFHAPNCN_ != 0) {
        output.writeUInt32(13, unk3250NKHDFHAPNCN_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250EMNLLDJHMEI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, unk3250EMNLLDJHMEI_);
      }
      if (unk3250IPGILJCBABK_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, unk3250IPGILJCBABK_);
      }
      for (int i = 0; i < scoreList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250LPANFEBFJOJ_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, unk3250LPANFEBFJOJ_);
      }
      if (isSuccess_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250NKHDFHAPNCN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, unk3250NKHDFHAPNCN_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250LPANFEBFJOJ()
          != other.getUnk3250LPANFEBFJOJ()) return false;
      if (getSceneTimeMs()
          != other.getSceneTimeMs()) return false;
      if (getUnk3250NKHDFHAPNCN()
          != other.getUnk3250NKHDFHAPNCN()) return false;
      if (getIsSuccess()
          != other.getIsSuccess()) return false;
      if (getUnk3250EMNLLDJHMEI()
          != other.getUnk3250EMNLLDJHMEI()) return false;
      if (!getScoreListList()
          .equals(other.getScoreListList())) return false;
      if (getUnk3250IPGILJCBABK()
          != other.getUnk3250IPGILJCBABK()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_LPANFEBFJOJ_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LPANFEBFJOJ();
      hash = (37 * hash) + SCENE_TIME_MS_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getSceneTimeMs());
      hash = (37 * hash) + UNK3250_NKHDFHAPNCN_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250NKHDFHAPNCN();
      hash = (37 * hash) + IS_SUCCESS_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsSuccess());
      hash = (37 * hash) + UNK3250_EMNLLDJHMEI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250EMNLLDJHMEI();
      if (getScoreListCount() > 0) {
        hash = (37 * hash) + SCORE_LIST_FIELD_NUMBER;
        hash = (53 * hash) + getScoreListList().hashCode();
      }
      hash = (37 * hash) + UNK3250_IPGILJCBABK_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IPGILJCBABK();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250LPANFEBFJOJ_ = 0;

        sceneTimeMs_ = 0L;

        unk3250NKHDFHAPNCN_ = 0;

        isSuccess_ = false;

        unk3250EMNLLDJHMEI_ = 0;
      ...
      public emu.grasscutter.net.proto.InBattleChessSettleInfoOuterClass.InBattleChessSettleInfo buildPartial() {
        ...
        result.unk3250LPANFEBFJOJ_ = unk3250LPANFEBFJOJ_;
        result.sceneTimeMs_ = sceneTimeMs_;
        result.unk3250NKHDFHAPNCN_ = unk3250NKHDFHAPNCN_;
        result.isSuccess_ = isSuccess_;
        result.unk3250EMNLLDJHMEI_ = unk3250EMNLLDJHMEI_;
        if (scoreListBuilder_ == null) {
        ...
        result.unk3250IPGILJCBABK_ = unk3250IPGILJCBABK_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.InBattleChessSettleInfoOuterClass.InBattleChessSettleInfo other) {
        ...
        if (other.getUnk3250LPANFEBFJOJ() != 0) {
          setUnk3250LPANFEBFJOJ(other.getUnk3250LPANFEBFJOJ());
        }
        if (other.getSceneTimeMs() != 0L) {
          setSceneTimeMs(other.getSceneTimeMs());
        }
        if (other.getUnk3250NKHDFHAPNCN() != 0) {
          setUnk3250NKHDFHAPNCN(other.getUnk3250NKHDFHAPNCN());
        }
        if (other.getIsSuccess() != false) {
          setIsSuccess(other.getIsSuccess());
        }
        if (other.getUnk3250EMNLLDJHMEI() != 0) {
          setUnk3250EMNLLDJHMEI(other.getUnk3250EMNLLDJHMEI());
        }
        if (scoreListBuilder_ == null) {
        ...
        if (other.getUnk3250IPGILJCBABK() != 0) {
          setUnk3250IPGILJCBABK(other.getUnk3250IPGILJCBABK());
        }
      ...
      /**
       * <code>uint32 Unk3250_LPANFEBFJOJ = 5;</code>
       * @param value The unk3250LPANFEBFJOJ to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LPANFEBFJOJ(int value) {
        
        unk3250LPANFEBFJOJ_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LPANFEBFJOJ() {
      ...
      /**
       * <code>uint32 Unk3250_NKHDFHAPNCN = 13;</code>
       * @param value The unk3250NKHDFHAPNCN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NKHDFHAPNCN(int value) {
        
        unk3250NKHDFHAPNCN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NKHDFHAPNCN() {
      ...
      /**
       * <code>uint32 Unk3250_EMNLLDJHMEI = 1;</code>
       * @param value The unk3250EMNLLDJHMEI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250EMNLLDJHMEI(int value) {
        
        unk3250EMNLLDJHMEI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250EMNLLDJHMEI() {
      ...
      /**
       * <code>uint32 Unk3250_IPGILJCBABK = 2;</code>
       * @param value The unk3250IPGILJCBABK to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IPGILJCBABK(int value) {
        
        unk3250IPGILJCBABK_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IPGILJCBABK() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ttleInfo\022\033\n\023Unk3250_LPANFEBFJOJ\030\005 \001(\r\022\025\n" +
    ...
    internal_static_InBattleChessSettleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_InBattleChessSettleInfo_descriptor,
        new java.lang.String[] { "Unk3250LPANFEBFJOJ", "SceneTimeMs", "Unk3250NKHDFHAPNCN", "IsSuccess", "Unk3250EMNLLDJHMEI", "ScoreList", "Unk3250IPGILJCBABK", });
    emu.grasscutter.net.proto.ExhibitionDisplayInfoOuterClass.getDescriptor();
  }
