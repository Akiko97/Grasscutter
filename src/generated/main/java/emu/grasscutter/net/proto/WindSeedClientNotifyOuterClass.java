...
public final class WindSeedClientNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface AddWindBulletNotifyOrBuilder extends
      ...
      /**
       * <code>uint32 Unk3250_CKIKKCAFJBC = 7;</code>
       * @return The unk3250CKIKKCAFJBC.
       */
      int getUnk3250CKIKKCAFJBC();

      /**
       * <code>uint32 Unk3250_MPDFAPBDJAH = 11;</code>
       * @return The unk3250MPDFAPBDJAH.
       */
      int getUnk3250MPDFAPBDJAH();
    }
    /**
    ...
    private static final long serialVersionUID = 0L;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 56: {
                ...
                unk3250CKIKKCAFJBC_ = input.readUInt32();
                break;
              }
              case 88: {

                unk3250MPDFAPBDJAH_ = input.readUInt32();
                break;
              }
              case 114: {
      ...
      public static final int UNK3250_CKIKKCAFJBC_FIELD_NUMBER = 7;
      private int unk3250CKIKKCAFJBC_;
      /**
       * <code>uint32 Unk3250_CKIKKCAFJBC = 7;</code>
       * @return The unk3250CKIKKCAFJBC.
       */
      @java.lang.Override
      public int getUnk3250CKIKKCAFJBC() {
        return unk3250CKIKKCAFJBC_;
      }

      public static final int UNK3250_MPDFAPBDJAH_FIELD_NUMBER = 11;
      private int unk3250MPDFAPBDJAH_;
      /**
       * <code>uint32 Unk3250_MPDFAPBDJAH = 11;</code>
       * @return The unk3250MPDFAPBDJAH.
       */
      @java.lang.Override
      public int getUnk3250MPDFAPBDJAH() {
        return unk3250MPDFAPBDJAH_;
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
                          throws java.io.IOException {
        if (unk3250CKIKKCAFJBC_ != 0) {
          output.writeUInt32(7, unk3250CKIKKCAFJBC_);
        }
        if (unk3250MPDFAPBDJAH_ != 0) {
          output.writeUInt32(11, unk3250MPDFAPBDJAH_);
        }
        if (seedPos_ != null) {
      ...
      public int getSerializedSize() {
        ...
        if (unk3250CKIKKCAFJBC_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(7, unk3250CKIKKCAFJBC_);
        }
        if (unk3250MPDFAPBDJAH_ != 0) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt32Size(11, unk3250MPDFAPBDJAH_);
        }
        if (seedPos_ != null) {
          size += com.google.protobuf.CodedOutputStream
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (getUnk3250CKIKKCAFJBC()
            != other.getUnk3250CKIKKCAFJBC()) return false;
        if (getUnk3250MPDFAPBDJAH()
            != other.getUnk3250MPDFAPBDJAH()) return false;
        if (!unknownFields.equals(other.unknownFields)) return false;
        return true;
      }
      ...
      public int hashCode() {
        ...
        hash = (37 * hash) + UNK3250_CKIKKCAFJBC_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250CKIKKCAFJBC();
        hash = (37 * hash) + UNK3250_MPDFAPBDJAH_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250MPDFAPBDJAH();
        hash = (29 * hash) + unknownFields.hashCode();
        memoizedHashCode = hash;
        return hash;
      }
      ...
      public static final class Builder extends
        ...
        public Builder clear() {
          ...
          unk3250CKIKKCAFJBC_ = 0;

          unk3250MPDFAPBDJAH_ = 0;
        ...
        public emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotify buildPartial() {
          ...
          result.unk3250CKIKKCAFJBC_ = unk3250CKIKKCAFJBC_;
          result.unk3250MPDFAPBDJAH_ = unk3250MPDFAPBDJAH_;
          onBuilt();
          return result;
        }
        ...
        public Builder mergeFrom(emu.grasscutter.net.proto.WindSeedClientNotifyOuterClass.WindSeedClientNotify.AddWindBulletNotify other) {
          ...
          if (other.getUnk3250CKIKKCAFJBC() != 0) {
            setUnk3250CKIKKCAFJBC(other.getUnk3250CKIKKCAFJBC());
          }
          if (other.getUnk3250MPDFAPBDJAH() != 0) {
            setUnk3250MPDFAPBDJAH(other.getUnk3250MPDFAPBDJAH());
          }
          this.mergeUnknownFields(other.unknownFields);
          onChanged();
          return this;
        ...
        /**
         * <code>uint32 Unk3250_CKIKKCAFJBC = 7;</code>
         * @param value The unk3250CKIKKCAFJBC to set.
         * @return This builder for chaining.
         */
        public Builder setUnk3250CKIKKCAFJBC(int value) {
          
          unk3250CKIKKCAFJBC_ = value;
          onChanged();
          return this;
        }
        /**
         ...
         * @return This builder for chaining.
         */
        public Builder clearUnk3250CKIKKCAFJBC() {
        ...
        /**
         * <code>uint32 Unk3250_MPDFAPBDJAH = 11;</code>
         * @param value The unk3250MPDFAPBDJAH to set.
         * @return This builder for chaining.
         */
        public Builder setUnk3250MPDFAPBDJAH(int value) {
          
          unk3250MPDFAPBDJAH_ = value;
          onChanged();
          return this;
        }
        /**
         ...
         * @return This builder for chaining.
         */
        public Builder clearUnk3250MPDFAPBDJAH() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "250_CKIKKCAFJBC\030\007 \001(\r\022\033\n\023Unk3250_MPDFAPB" +
    ...
    internal_static_WindSeedClientNotify_AddWindBulletNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_WindSeedClientNotify_AddWindBulletNotify_descriptor,
        new java.lang.String[] { "SeedPos", "Unk3250CKIKKCAFJBC", "Unk3250MPDFAPBDJAH", });
    internal_static_WindSeedClientNotify_AreaNotify_descriptor =
