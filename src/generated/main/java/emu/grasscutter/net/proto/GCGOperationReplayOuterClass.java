...
public final class GCGOperationReplayOuterClass {
  ...
  public interface GCGOperationReplayOrBuilder extends
    ...
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    java.util.List<emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH> 
        getUnk3250FKBLJIMBHEAList();
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH getUnk3250FKBLJIMBHEA(int index);
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    int getUnk3250FKBLJIMBHEACount();
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    java.util.List<? extends emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder> 
        getUnk3250FKBLJIMBHEAOrBuilderList();
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder getUnk3250FKBLJIMBHEAOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    private GCGOperationReplay() {
      unk3250FKBLJIMBHEA_ = java.util.Collections.emptyList();
    ...
    private GCGOperationReplay(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 50: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                unk3250FKBLJIMBHEA_ = new java.util.ArrayList<emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH>();
                mutable_bitField0_ |= 0x00000001;
              }
              unk3250FKBLJIMBHEA_.add(
                  input.readMessage(emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.parser(), extensionRegistry));
              break;
            }
            case 58: {
        ...
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          unk3250FKBLJIMBHEA_ = java.util.Collections.unmodifiableList(unk3250FKBLJIMBHEA_);
        }
        if (((mutable_bitField0_ & 0x00000004) != 0)) {
    ...
    public static final int UNK3250_FKBLJIMBHEA_FIELD_NUMBER = 6;
    private java.util.List<emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH> unk3250FKBLJIMBHEA_;
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH> getUnk3250FKBLJIMBHEAList() {
      return unk3250FKBLJIMBHEA_;
    }
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder> 
        getUnk3250FKBLJIMBHEAOrBuilderList() {
      return unk3250FKBLJIMBHEA_;
    }
    /**
     ...
     */
    @java.lang.Override
    public int getUnk3250FKBLJIMBHEACount() {
      return unk3250FKBLJIMBHEA_.size();
    }
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH getUnk3250FKBLJIMBHEA(int index) {
      return unk3250FKBLJIMBHEA_.get(index);
    }
    /**
     * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder getUnk3250FKBLJIMBHEAOrBuilder(
        int index) {
      return unk3250FKBLJIMBHEA_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < unk3250FKBLJIMBHEA_.size(); i++) {
        output.writeMessage(6, unk3250FKBLJIMBHEA_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < unk3250FKBLJIMBHEA_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, unk3250FKBLJIMBHEA_.get(i));
      }
      for (int i = 0; i < controllerDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getUnk3250FKBLJIMBHEAList()
          .equals(other.getUnk3250FKBLJIMBHEAList())) return false;
      if (getSeed()
    ...
    public int hashCode() {
      ...
      if (getUnk3250FKBLJIMBHEACount() > 0) {
        hash = (37 * hash) + UNK3250_FKBLJIMBHEA_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250FKBLJIMBHEAList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessageV3
          ...
          getUnk3250FKBLJIMBHEAFieldBuilder();
      ...
      public Builder clear() {
        super.clear();
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          unk3250FKBLJIMBHEA_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000001);
        } else {
          unk3250FKBLJIMBHEABuilder_.clear();
        }
        seed_ = 0;
      ...
      public emu.grasscutter.net.proto.GCGOperationReplayOuterClass.GCGOperationReplay buildPartial() {
        ...
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ...
          result.unk3250FKBLJIMBHEA_ = unk3250FKBLJIMBHEA_;
        } else {
          result.unk3250FKBLJIMBHEA_ = unk3250FKBLJIMBHEABuilder_.build();
        }
        result.seed_ = seed_;
        if (operationDataListBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GCGOperationReplayOuterClass.GCGOperationReplay other) {
        ...
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          if (!other.unk3250FKBLJIMBHEA_.isEmpty()) {
            if (unk3250FKBLJIMBHEA_.isEmpty()) {
              unk3250FKBLJIMBHEA_ = other.unk3250FKBLJIMBHEA_;
              bitField0_ = (bitField0_ & ~0x00000001);
            } else {
              ensureUnk3250FKBLJIMBHEAIsMutable();
              unk3250FKBLJIMBHEA_.addAll(other.unk3250FKBLJIMBHEA_);
            }
            onChanged();
          }
        } else {
          if (!other.unk3250FKBLJIMBHEA_.isEmpty()) {
            if (unk3250FKBLJIMBHEABuilder_.isEmpty()) {
              unk3250FKBLJIMBHEABuilder_.dispose();
              unk3250FKBLJIMBHEABuilder_ = null;
              unk3250FKBLJIMBHEA_ = other.unk3250FKBLJIMBHEA_;
              bitField0_ = (bitField0_ & ~0x00000001);
              unk3250FKBLJIMBHEABuilder_ = 
                com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                   getUnk3250FKBLJIMBHEAFieldBuilder() : null;
            } else {
              unk3250FKBLJIMBHEABuilder_.addAllMessages(other.unk3250FKBLJIMBHEA_);
            }
          }
        }
        if (other.getSeed() != 0) {
      ...
      private void ensureUnk3250FKBLJIMBHEAIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          unk3250FKBLJIMBHEA_ = new java.util.ArrayList<emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH>(unk3250FKBLJIMBHEA_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder> unk3250FKBLJIMBHEABuilder_;
      ...
      public java.util.List<emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH> getUnk3250FKBLJIMBHEAList() {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          return java.util.Collections.unmodifiableList(unk3250FKBLJIMBHEA_);
        } else {
          return unk3250FKBLJIMBHEABuilder_.getMessageList();
        }
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
      ...
      public int getUnk3250FKBLJIMBHEACount() {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ...
          return unk3250FKBLJIMBHEABuilder_.getCount();
        }
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
      ...
      public emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH getUnk3250FKBLJIMBHEA(int index) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ...
          return unk3250FKBLJIMBHEABuilder_.getMessage(index);
        }
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public Builder setUnk3250FKBLJIMBHEA(
          int index, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH value) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureUnk3250FKBLJIMBHEAIsMutable();
          unk3250FKBLJIMBHEA_.set(index, value);
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.setMessage(index, value);
        }
        return this;
      }
      /**
       ...
       */
      public Builder setUnk3250FKBLJIMBHEA(
          int index, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder builderForValue) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ensureUnk3250FKBLJIMBHEAIsMutable();
          unk3250FKBLJIMBHEA_.set(index, builderForValue.build());
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.setMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public Builder addUnk3250FKBLJIMBHEA(emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH value) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
          ensureUnk3250FKBLJIMBHEAIsMutable();
          unk3250FKBLJIMBHEA_.add(value);
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.addMessage(value);
        }
        return this;
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public Builder addUnk3250FKBLJIMBHEA(
          int index, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH value) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          ...
          ensureUnk3250FKBLJIMBHEAIsMutable();
          unk3250FKBLJIMBHEA_.add(index, value);
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.addMessage(index, value);
        }
        return this;
      }
      /**
       ...
       */
      public Builder addUnk3250FKBLJIMBHEA(
          emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder builderForValue) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ensureUnk3250FKBLJIMBHEAIsMutable();
          unk3250FKBLJIMBHEA_.add(builderForValue.build());
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.addMessage(builderForValue.build());
        }
        return this;
      }
      /**
      ...
      public Builder addUnk3250FKBLJIMBHEA(
        ...
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ensureUnk3250FKBLJIMBHEAIsMutable();
          unk3250FKBLJIMBHEA_.add(index, builderForValue.build());
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.addMessage(index, builderForValue.build());
        }
        return this;
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public Builder addAllUnk3250FKBLJIMBHEA(
          java.lang.Iterable<? extends emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH> values) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ensureUnk3250FKBLJIMBHEAIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, unk3250FKBLJIMBHEA_);
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.addAllMessages(values);
        }
        return this;
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public Builder clearUnk3250FKBLJIMBHEA() {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          unk3250FKBLJIMBHEA_ = java.util.Collections.emptyList();
          bitField0_ = (bitField0_ & ~0x00000001);
          onChanged();
       ...
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public Builder removeUnk3250FKBLJIMBHEA(int index) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          ensureUnk3250FKBLJIMBHEAIsMutable();
          unk3250FKBLJIMBHEA_.remove(index);
          onChanged();
        } else {
          unk3250FKBLJIMBHEABuilder_.remove(index);
        }
        return this;
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder getUnk3250FKBLJIMBHEABuilder(
          int index) {
        return getUnk3250FKBLJIMBHEAFieldBuilder().getBuilder(index);
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder getUnk3250FKBLJIMBHEAOrBuilder(
          int index) {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          return unk3250FKBLJIMBHEA_.get(index);  } else {
          return unk3250FKBLJIMBHEABuilder_.getMessageOrBuilder(index);
        }
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
      ...
      public java.util.List<? extends emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder> 
           getUnk3250FKBLJIMBHEAOrBuilderList() {
        if (unk3250FKBLJIMBHEABuilder_ != null) {
          return unk3250FKBLJIMBHEABuilder_.getMessageOrBuilderList();
        } else {
          return java.util.Collections.unmodifiableList(unk3250FKBLJIMBHEA_);
        }
      }
       ...
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder addUnk3250FKBLJIMBHEABuilder() {
        return getUnk3250FKBLJIMBHEAFieldBuilder().addBuilder(
            emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.getDefaultInstance());
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder addUnk3250FKBLJIMBHEABuilder(
          int index) {
        return getUnk3250FKBLJIMBHEAFieldBuilder().addBuilder(
            index, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.getDefaultInstance());
      }
      /**
       * <code>repeated .Unk3250_PPKPCOCOMDH Unk3250_FKBLJIMBHEA = 6;</code>
       */
      public java.util.List<emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder> 
           getUnk3250FKBLJIMBHEABuilderList() {
        return getUnk3250FKBLJIMBHEAFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder> 
          getUnk3250FKBLJIMBHEAFieldBuilder() {
        if (unk3250FKBLJIMBHEABuilder_ == null) {
          unk3250FKBLJIMBHEABuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
              emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDH.Builder, emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.Unk3250_PPKPCOCOMDHOrBuilder>(
                  unk3250FKBLJIMBHEA_,
                  ((bitField0_ & 0x00000001) != 0),
                  getParentForChildren(),
                  isClean());
          unk3250FKBLJIMBHEA_ = null;
        }
        return unk3250FKBLJIMBHEABuilder_;
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "a.proto\032\031Unk3250_PPKPCOCOMDH.proto\"\324\001\n\022G" +
      "CGOperationReplay\0221\n\023Unk3250_FKBLJIMBHEA" +
      "\030\006 \003(\0132\024.Unk3250_PPKPCOCOMDH\022\014\n\004seed\030\001 \001" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.getDescriptor(),
        });
    internal_static_GCGOperationReplay_descriptor =
    ...
    internal_static_GCGOperationReplay_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GCGOperationReplay_descriptor,
        new java.lang.String[] { "Unk3250FKBLJIMBHEA", "Seed", "OperationDataList", "GameId", "ControllerDataList", });
    emu.grasscutter.net.proto.GCGReplayControllerDataOuterClass.getDescriptor();
    emu.grasscutter.net.proto.GCGReplayOperationDataOuterClass.getDescriptor();
    emu.grasscutter.net.proto.Unk3250PPKPCOCOMDH.getDescriptor();
  }
