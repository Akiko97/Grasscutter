...
public final class EvtCombatForceSetPosInfoOuterClass {
  ...
  public interface EvtCombatForceSetPosInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_LGGMBNLMGHB = 8;</code>
     * @return The unk3250LGGMBNLMGHB.
     */
    int getUnk3250LGGMBNLMGHB();

    /**
     * <code>uint32 Unk3250_IALIGDPAMFL = 7;</code>
     * @return The unk3250IALIGDPAMFL.
     */
    int getUnk3250IALIGDPAMFL();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250IALIGDPAMFL_ = input.readUInt32();
              break;
            }
            case 64: {

              unk3250LGGMBNLMGHB_ = input.readUInt32();
              break;
            }
            case 80: {
    ...
    public static final int UNK3250_LGGMBNLMGHB_FIELD_NUMBER = 8;
    private int unk3250LGGMBNLMGHB_;
    /**
     * <code>uint32 Unk3250_LGGMBNLMGHB = 8;</code>
     * @return The unk3250LGGMBNLMGHB.
     */
    @java.lang.Override
    public int getUnk3250LGGMBNLMGHB() {
      return unk3250LGGMBNLMGHB_;
    }

    public static final int UNK3250_IALIGDPAMFL_FIELD_NUMBER = 7;
    private int unk3250IALIGDPAMFL_;
    /**
     * <code>uint32 Unk3250_IALIGDPAMFL = 7;</code>
     * @return The unk3250IALIGDPAMFL.
     */
    @java.lang.Override
    public int getUnk3250IALIGDPAMFL() {
      return unk3250IALIGDPAMFL_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250IALIGDPAMFL_ != 0) {
        output.writeUInt32(7, unk3250IALIGDPAMFL_);
      }
      if (unk3250LGGMBNLMGHB_ != 0) {
        output.writeUInt32(8, unk3250LGGMBNLMGHB_);
      }
      if (entityId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250IALIGDPAMFL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250IALIGDPAMFL_);
      }
      if (unk3250LGGMBNLMGHB_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, unk3250LGGMBNLMGHB_);
      }
      if (entityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250LGGMBNLMGHB()
          != other.getUnk3250LGGMBNLMGHB()) return false;
      if (getUnk3250IALIGDPAMFL()
          != other.getUnk3250IALIGDPAMFL()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_LGGMBNLMGHB_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LGGMBNLMGHB();
      hash = (37 * hash) + UNK3250_IALIGDPAMFL_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IALIGDPAMFL();
      if (hasTargetPos()) {
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250LGGMBNLMGHB_ = 0;

        unk3250IALIGDPAMFL_ = 0;
      ...
      public emu.grasscutter.net.proto.EvtCombatForceSetPosInfoOuterClass.EvtCombatForceSetPosInfo buildPartial() {
        ...
        result.unk3250LGGMBNLMGHB_ = unk3250LGGMBNLMGHB_;
        result.unk3250IALIGDPAMFL_ = unk3250IALIGDPAMFL_;
        if (targetPosBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.EvtCombatForceSetPosInfoOuterClass.EvtCombatForceSetPosInfo other) {
        ...
        if (other.getUnk3250LGGMBNLMGHB() != 0) {
          setUnk3250LGGMBNLMGHB(other.getUnk3250LGGMBNLMGHB());
        }
        if (other.getUnk3250IALIGDPAMFL() != 0) {
          setUnk3250IALIGDPAMFL(other.getUnk3250IALIGDPAMFL());
        }
      ...
      /**
       * <code>uint32 Unk3250_LGGMBNLMGHB = 8;</code>
       * @param value The unk3250LGGMBNLMGHB to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LGGMBNLMGHB(int value) {
        
        unk3250LGGMBNLMGHB_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LGGMBNLMGHB() {
      ...
      /**
       * <code>uint32 Unk3250_IALIGDPAMFL = 7;</code>
       * @param value The unk3250IALIGDPAMFL to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IALIGDPAMFL(int value) {
        
        unk3250IALIGDPAMFL_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IALIGDPAMFL() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nk3250_LGGMBNLMGHB\030\010 \001(\r\022\033\n\023Unk3250_IALI" +
    ...
    internal_static_EvtCombatForceSetPosInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_EvtCombatForceSetPosInfo_descriptor,
        new java.lang.String[] { "Unk3250LGGMBNLMGHB", "Unk3250IALIGDPAMFL", "TargetPos", "EntityId", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
