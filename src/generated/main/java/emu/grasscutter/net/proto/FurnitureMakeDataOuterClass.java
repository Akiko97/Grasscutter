...
public final class FurnitureMakeDataOuterClass {
  ...
  public interface FurnitureMakeDataOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_GDIBLADMJIC = 8;</code>
     * @return The unk3250GDIBLADMJIC.
     */
    int getUnk3250GDIBLADMJIC();

    /**
     * <code>uint32 Unk3250_GBDHFLEFJLG = 7;</code>
     * @return The unk3250GBDHFLEFJLG.
     */
    int getUnk3250GBDHFLEFJLG();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250GBDHFLEFJLG_ = input.readUInt32();
              break;
            }
            case 64: {

              unk3250GDIBLADMJIC_ = input.readUInt32();
              break;
            }
            case 80: {
    ...
    public static final int UNK3250_GDIBLADMJIC_FIELD_NUMBER = 8;
    private int unk3250GDIBLADMJIC_;
    /**
     * <code>uint32 Unk3250_GDIBLADMJIC = 8;</code>
     * @return The unk3250GDIBLADMJIC.
     */
    @java.lang.Override
    public int getUnk3250GDIBLADMJIC() {
      return unk3250GDIBLADMJIC_;
    }

    public static final int UNK3250_GBDHFLEFJLG_FIELD_NUMBER = 7;
    private int unk3250GBDHFLEFJLG_;
    /**
     * <code>uint32 Unk3250_GBDHFLEFJLG = 7;</code>
     * @return The unk3250GBDHFLEFJLG.
     */
    @java.lang.Override
    public int getUnk3250GBDHFLEFJLG() {
      return unk3250GBDHFLEFJLG_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250GBDHFLEFJLG_ != 0) {
        output.writeUInt32(7, unk3250GBDHFLEFJLG_);
      }
      if (unk3250GDIBLADMJIC_ != 0) {
        output.writeUInt32(8, unk3250GDIBLADMJIC_);
      }
      if (makeId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250GBDHFLEFJLG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250GBDHFLEFJLG_);
      }
      if (unk3250GDIBLADMJIC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, unk3250GDIBLADMJIC_);
      }
      if (makeId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250GDIBLADMJIC()
          != other.getUnk3250GDIBLADMJIC()) return false;
      if (getUnk3250GBDHFLEFJLG()
          != other.getUnk3250GBDHFLEFJLG()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_GDIBLADMJIC_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250GDIBLADMJIC();
      hash = (37 * hash) + UNK3250_GBDHFLEFJLG_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250GBDHFLEFJLG();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250GDIBLADMJIC_ = 0;

        unk3250GBDHFLEFJLG_ = 0;
      ...
      public emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData buildPartial() {
        ...
        result.unk3250GDIBLADMJIC_ = unk3250GDIBLADMJIC_;
        result.unk3250GBDHFLEFJLG_ = unk3250GBDHFLEFJLG_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FurnitureMakeDataOuterClass.FurnitureMakeData other) {
        ...
        if (other.getUnk3250GDIBLADMJIC() != 0) {
          setUnk3250GDIBLADMJIC(other.getUnk3250GDIBLADMJIC());
        }
        if (other.getUnk3250GBDHFLEFJLG() != 0) {
          setUnk3250GBDHFLEFJLG(other.getUnk3250GBDHFLEFJLG());
        }
      ...
      /**
       * <code>uint32 Unk3250_GDIBLADMJIC = 8;</code>
       * @param value The unk3250GDIBLADMJIC to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250GDIBLADMJIC(int value) {
        
        unk3250GDIBLADMJIC_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250GDIBLADMJIC() {
      ...
      /**
       * <code>uint32 Unk3250_GBDHFLEFJLG = 7;</code>
       * @param value The unk3250GBDHFLEFJLG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250GBDHFLEFJLG(int value) {
        
        unk3250GBDHFLEFJLG_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250GBDHFLEFJLG() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\023Unk3250_GDIBLADMJIC\030\010 \001(\r\022\033\n\023Unk3250_G" +
    ...
    internal_static_FurnitureMakeData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FurnitureMakeData_descriptor,
        new java.lang.String[] { "BeginTime", "AvatarId", "MakeId", "Index", "Unk3250GDIBLADMJIC", "Unk3250GBDHFLEFJLG", });
  }
