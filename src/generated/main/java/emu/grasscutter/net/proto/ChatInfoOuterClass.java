...
public final class ChatInfoOuterClass {
  ...
  public interface ChatInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_PHBEHIGHOCD = 5;</code>
     * @return The unk3250PHBEHIGHOCD.
     */
    int getUnk3250PHBEHIGHOCD();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              unk3250PHBEHIGHOCD_ = input.readUInt32();
              break;
            }
            case 80: {
    ...
    public static final int UNK3250_PHBEHIGHOCD_FIELD_NUMBER = 5;
    private int unk3250PHBEHIGHOCD_;
    /**
     * <code>uint32 Unk3250_PHBEHIGHOCD = 5;</code>
     * @return The unk3250PHBEHIGHOCD.
     */
    @java.lang.Override
    public int getUnk3250PHBEHIGHOCD() {
      return unk3250PHBEHIGHOCD_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250PHBEHIGHOCD_ != 0) {
        output.writeUInt32(5, unk3250PHBEHIGHOCD_);
      }
      if (toUid_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250PHBEHIGHOCD_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, unk3250PHBEHIGHOCD_);
      }
      if (toUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250PHBEHIGHOCD()
          != other.getUnk3250PHBEHIGHOCD()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + getUid();
      hash = (37 * hash) + UNK3250_PHBEHIGHOCD_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PHBEHIGHOCD();
      switch (contentCase_) {
        case 909:
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo buildPartial() {
        ...
        result.uid_ = uid_;
        result.unk3250PHBEHIGHOCD_ = unk3250PHBEHIGHOCD_;
        if (contentCase_ == 909) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ChatInfoOuterClass.ChatInfo other) {
        ...
        if (other.getUnk3250PHBEHIGHOCD() != 0) {
          setUnk3250PHBEHIGHOCD(other.getUnk3250PHBEHIGHOCD());
        }
      ...
      /**
       * <code>uint32 Unk3250_PHBEHIGHOCD = 5;</code>
       * @param value The unk3250PHBEHIGHOCD to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PHBEHIGHOCD(int value) {
        
        unk3250PHBEHIGHOCD_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PHBEHIGHOCD() {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\016ChatInfo.proto\"\332\002\n\010ChatInfo\022\017\n\007is_read" +
      "\030\003 \001(\010\022\014\n\004time\030\001 \001(\r\022\016\n\006to_uid\030\n \001(\r\022\013\n\003" +
      "uid\030\013 \001(\r\022\033\n\023Unk3250_PHBEHIGHOCD\030\005 \001(\r\022\017" +
      "\n\004text\030\215\007 \001(\tH\000\022\017\n\004icon\030\336\007 \001(\rH\000\022,\n\013syst" +
      "em_hint\030\237\006 \001(\0132\024.ChatInfo.SystemHintH\000\032\032" +
      "\n\nSystemHint\022\014\n\004type\030\017 \001(\r\"~\n\016SystemHint" +
      "Type\022\036\n\032SYSTEM_HINT_TYPE_CHAT_NONE\020\000\022%\n!" +
      "SYSTEM_HINT_TYPE_CHAT_ENTER_WORLD\020\001\022%\n!S" +
      "YSTEM_HINT_TYPE_CHAT_LEAVE_WORLD\020\002B\t\n\007co" +
    ...
    internal_static_ChatInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ChatInfo_descriptor,
        new java.lang.String[] { "IsRead", "Time", "ToUid", "Uid", "Unk3250PHBEHIGHOCD", "Text", "Icon", "SystemHint", "Content", });
    internal_static_ChatInfo_SystemHint_descriptor =
