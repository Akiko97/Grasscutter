...
public final class AbilityMetaUpdateBaseReactionDamageOuterClass {
  ...
  public interface AbilityMetaUpdateBaseReactionDamageOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_OIPAEGAMCLI = 2;</code>
     * @return The unk3250OIPAEGAMCLI.
     */
    int getUnk3250OIPAEGAMCLI();

    /**
     * <code>uint32 Unk3250_CAKEJCJKHOA = 13;</code>
     * @return The unk3250CAKEJCJKHOA.
     */
    int getUnk3250CAKEJCJKHOA();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              unk3250OIPAEGAMCLI_ = input.readUInt32();
              break;
            }
            case 50: {
            ...
            case 104: {
              ...
              unk3250CAKEJCJKHOA_ = input.readUInt32();
              break;
            }
            case 114: {
              emu.grasscutter.net.proto.AbilityStringOuterClass.AbilityString.Builder subBuilder = null;
    ...
    public static final int UNK3250_OIPAEGAMCLI_FIELD_NUMBER = 2;
    private int unk3250OIPAEGAMCLI_;
    /**
     * <code>uint32 Unk3250_OIPAEGAMCLI = 2;</code>
     * @return The unk3250OIPAEGAMCLI.
     */
    @java.lang.Override
    public int getUnk3250OIPAEGAMCLI() {
      return unk3250OIPAEGAMCLI_;
    }

    public static final int UNK3250_CAKEJCJKHOA_FIELD_NUMBER = 13;
    private int unk3250CAKEJCJKHOA_;
    /**
     * <code>uint32 Unk3250_CAKEJCJKHOA = 13;</code>
     * @return The unk3250CAKEJCJKHOA.
     */
    @java.lang.Override
    public int getUnk3250CAKEJCJKHOA() {
      return unk3250CAKEJCJKHOA_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250OIPAEGAMCLI_ != 0) {
        output.writeUInt32(2, unk3250OIPAEGAMCLI_);
      }
      if (abilityName_ != null) {
        output.writeMessage(6, getAbilityName());
      }
      if (unk3250CAKEJCJKHOA_ != 0) {
        output.writeUInt32(13, unk3250CAKEJCJKHOA_);
      }
      if (globalValueKey_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250OIPAEGAMCLI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, unk3250OIPAEGAMCLI_);
      }
      if (abilityName_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250CAKEJCJKHOA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, unk3250CAKEJCJKHOA_);
      }
      if (globalValueKey_ != null) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250OIPAEGAMCLI()
          != other.getUnk3250OIPAEGAMCLI()) return false;
      if (getUnk3250CAKEJCJKHOA()
          != other.getUnk3250CAKEJCJKHOA()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_OIPAEGAMCLI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250OIPAEGAMCLI();
      hash = (37 * hash) + UNK3250_CAKEJCJKHOA_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250CAKEJCJKHOA();
      if (hasAbilityName()) {
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250OIPAEGAMCLI_ = 0;

        unk3250CAKEJCJKHOA_ = 0;
      ...
      public emu.grasscutter.net.proto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage buildPartial() {
        ...
        result.unk3250OIPAEGAMCLI_ = unk3250OIPAEGAMCLI_;
        result.unk3250CAKEJCJKHOA_ = unk3250CAKEJCJKHOA_;
        if (abilityNameBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage other) {
        ...
        if (other.getUnk3250OIPAEGAMCLI() != 0) {
          setUnk3250OIPAEGAMCLI(other.getUnk3250OIPAEGAMCLI());
        }
        if (other.getUnk3250CAKEJCJKHOA() != 0) {
          setUnk3250CAKEJCJKHOA(other.getUnk3250CAKEJCJKHOA());
        }
      ...
      /**
       * <code>uint32 Unk3250_OIPAEGAMCLI = 2;</code>
       * @param value The unk3250OIPAEGAMCLI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250OIPAEGAMCLI(int value) {
        
        unk3250OIPAEGAMCLI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250OIPAEGAMCLI() {
      ...
      /**
       * <code>uint32 Unk3250_CAKEJCJKHOA = 13;</code>
       * @param value The unk3250CAKEJCJKHOA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250CAKEJCJKHOA(int value) {
        
        unk3250CAKEJCJKHOA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250CAKEJCJKHOA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "EGAMCLI\030\002 \001(\r\022\033\n\023Unk3250_CAKEJCJKHOA\030\r \001" +
    ...
    internal_static_AbilityMetaUpdateBaseReactionDamage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaUpdateBaseReactionDamage_descriptor,
        new java.lang.String[] { "Unk3250OIPAEGAMCLI", "Unk3250CAKEJCJKHOA", "AbilityName", "GlobalValueKey", });
    emu.grasscutter.net.proto.AbilityStringOuterClass.getDescriptor();
  }
