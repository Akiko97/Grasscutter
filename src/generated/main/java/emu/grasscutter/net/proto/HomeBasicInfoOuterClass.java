...
public final class HomeBasicInfoOuterClass {
  ...
  public interface HomeBasicInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_AKPAPPGOFGN = 11;</code>
     * @return The unk3250AKPAPPGOFGN.
     */
    int getUnk3250AKPAPPGOFGN();

    /**
     * <code>uint32 Unk3250_GNFGFIIGHEA = 14;</code>
     * @return The unk3250GNFGFIIGHEA.
     */
    int getUnk3250GNFGFIIGHEA();
    ...
    /**
     * <code>uint32 Unk3250_KGCBFKGGHDD = 4;</code>
     * @return The unk3250KGCBFKGGHDD.
     */
    int getUnk3250KGCBFKGGHDD();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              unk3250KGCBFKGGHDD_ = input.readUInt32();
              break;
            }
            case 50: {
            ...
            case 88: {
              ...
              unk3250AKPAPPGOFGN_ = input.readUInt32();
              break;
            }
            case 106: {
            ...
            case 112: {
              ...
              unk3250GNFGFIIGHEA_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_AKPAPPGOFGN_FIELD_NUMBER = 11;
    private int unk3250AKPAPPGOFGN_;
    /**
     * <code>uint32 Unk3250_AKPAPPGOFGN = 11;</code>
     * @return The unk3250AKPAPPGOFGN.
     */
    @java.lang.Override
    public int getUnk3250AKPAPPGOFGN() {
      return unk3250AKPAPPGOFGN_;
    }

    public static final int UNK3250_GNFGFIIGHEA_FIELD_NUMBER = 14;
    private int unk3250GNFGFIIGHEA_;
    /**
     * <code>uint32 Unk3250_GNFGFIIGHEA = 14;</code>
     * @return The unk3250GNFGFIIGHEA.
     */
    @java.lang.Override
    public int getUnk3250GNFGFIIGHEA() {
      return unk3250GNFGFIIGHEA_;
    }
    ...
    public static final int UNK3250_KGCBFKGGHDD_FIELD_NUMBER = 4;
    private int unk3250KGCBFKGGHDD_;
    /**
     * <code>uint32 Unk3250_KGCBFKGGHDD = 4;</code>
     * @return The unk3250KGCBFKGGHDD.
     */
    @java.lang.Override
    public int getUnk3250KGCBFKGGHDD() {
      return unk3250KGCBFKGGHDD_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250KGCBFKGGHDD_ != 0) {
        output.writeUInt32(4, unk3250KGCBFKGGHDD_);
      }
      ...
      if (unk3250AKPAPPGOFGN_ != 0) {
        output.writeUInt32(11, unk3250AKPAPPGOFGN_);
      }
      if (limitedShopInfo_ != null) {
        output.writeMessage(13, getLimitedShopInfo());
      }
      if (unk3250GNFGFIIGHEA_ != 0) {
        output.writeUInt32(14, unk3250GNFGFIIGHEA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250KGCBFKGGHDD_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, unk3250KGCBFKGGHDD_);
      }
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(ownerNickName_)) {
      ...
      if (unk3250AKPAPPGOFGN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, unk3250AKPAPPGOFGN_);
      }
      if (limitedShopInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250GNFGFIIGHEA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, unk3250GNFGFIIGHEA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250AKPAPPGOFGN()
          != other.getUnk3250AKPAPPGOFGN()) return false;
      if (getUnk3250GNFGFIIGHEA()
          != other.getUnk3250GNFGFIIGHEA()) return false;
      if (!getOwnerNickName()
          .equals(other.getOwnerNickName())) return false;
      if (getUnk3250KGCBFKGGHDD()
          != other.getUnk3250KGCBFKGGHDD()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getExp());
      hash = (37 * hash) + UNK3250_AKPAPPGOFGN_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250AKPAPPGOFGN();
      hash = (37 * hash) + UNK3250_GNFGFIIGHEA_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250GNFGFIIGHEA();
      hash = (37 * hash) + OWNER_NICK_NAME_FIELD_NUMBER;
      hash = (53 * hash) + getOwnerNickName().hashCode();
      hash = (37 * hash) + UNK3250_KGCBFKGGHDD_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250KGCBFKGGHDD();
      if (hasLimitedShopInfo()) {
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250AKPAPPGOFGN_ = 0;

        unk3250GNFGFIIGHEA_ = 0;

        ownerNickName_ = "";

        unk3250KGCBFKGGHDD_ = 0;
      ...
      public emu.grasscutter.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo buildPartial() {
        ...
        result.exp_ = exp_;
        result.unk3250AKPAPPGOFGN_ = unk3250AKPAPPGOFGN_;
        result.unk3250GNFGFIIGHEA_ = unk3250GNFGFIIGHEA_;
        result.ownerNickName_ = ownerNickName_;
        result.unk3250KGCBFKGGHDD_ = unk3250KGCBFKGGHDD_;
        if (limitedShopInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.HomeBasicInfoOuterClass.HomeBasicInfo other) {
        ...
        if (other.getUnk3250AKPAPPGOFGN() != 0) {
          setUnk3250AKPAPPGOFGN(other.getUnk3250AKPAPPGOFGN());
        }
        if (other.getUnk3250GNFGFIIGHEA() != 0) {
          setUnk3250GNFGFIIGHEA(other.getUnk3250GNFGFIIGHEA());
        }
        if (!other.getOwnerNickName().isEmpty()) {
          ownerNickName_ = other.ownerNickName_;
          onChanged();
        }
        if (other.getUnk3250KGCBFKGGHDD() != 0) {
          setUnk3250KGCBFKGGHDD(other.getUnk3250KGCBFKGGHDD());
        }
      ...
      /**
       * <code>uint32 Unk3250_AKPAPPGOFGN = 11;</code>
       * @param value The unk3250AKPAPPGOFGN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250AKPAPPGOFGN(int value) {
        
        unk3250AKPAPPGOFGN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250AKPAPPGOFGN() {
      ...
      /**
       * <code>uint32 Unk3250_GNFGFIIGHEA = 14;</code>
       * @param value The unk3250GNFGFIIGHEA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250GNFGFIIGHEA(int value) {
        
        unk3250GNFGFIIGHEA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250GNFGFIIGHEA() {
  ...
  checkByteStringIsUtf8(value);
      ...
      /**
       * <code>uint32 Unk3250_KGCBFKGGHDD = 4;</code>
       * @param value The unk3250KGCBFKGGHDD to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250KGCBFKGGHDD(int value) {
        
        unk3250KGCBFKGGHDD_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250KGCBFKGGHDD() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\033\n\023Unk3250_AKPAPPGOFGN\030\013 \001(\r\022\033\n\023Unk3250_" +
      "GNFGFIIGHEA\030\016 \001(\r\022\027\n\017owner_nick_name\030\006 \001" +
      "(\t\022\033\n\023Unk3250_KGCBFKGGHDD\030\004 \001(\r\022/\n\021limit" +
    ...
    internal_static_HomeBasicInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_HomeBasicInfo_descriptor,
        new java.lang.String[] { "Exp", "Unk3250AKPAPPGOFGN", "Unk3250GNFGFIIGHEA", "OwnerNickName", "Unk3250KGCBFKGGHDD", "LimitedShopInfo", "IsInEditMode", "Level", });
    emu.grasscutter.net.proto.HomeLimitedShopInfoOuterClass.getDescriptor();
  }
