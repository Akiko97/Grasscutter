...
public final class PlayerCookReqOuterClass {
  ...
  public interface PlayerCookReqOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_NDPHNNOFEBL = 5;</code>
     * @return The unk3250NDPHNNOFEBL.
     */
    int getUnk3250NDPHNNOFEBL();

    /**
     * <code>uint32 Unk3250_JPICLIDLIEC = 7;</code>
     * @return The unk3250JPICLIDLIEC.
     */
    int getUnk3250JPICLIDLIEC();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              unk3250NDPHNNOFEBL_ = input.readUInt32();
              break;
            }
            case 56: {

              unk3250JPICLIDLIEC_ = input.readUInt32();
              break;
            }
            case 96: {
    ...
    public static final int UNK3250_NDPHNNOFEBL_FIELD_NUMBER = 5;
    private int unk3250NDPHNNOFEBL_;
    /**
     * <code>uint32 Unk3250_NDPHNNOFEBL = 5;</code>
     * @return The unk3250NDPHNNOFEBL.
     */
    @java.lang.Override
    public int getUnk3250NDPHNNOFEBL() {
      return unk3250NDPHNNOFEBL_;
    }

    public static final int UNK3250_JPICLIDLIEC_FIELD_NUMBER = 7;
    private int unk3250JPICLIDLIEC_;
    /**
     * <code>uint32 Unk3250_JPICLIDLIEC = 7;</code>
     * @return The unk3250JPICLIDLIEC.
     */
    @java.lang.Override
    public int getUnk3250JPICLIDLIEC() {
      return unk3250JPICLIDLIEC_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250NDPHNNOFEBL_ != 0) {
        output.writeUInt32(5, unk3250NDPHNNOFEBL_);
      }
      if (unk3250JPICLIDLIEC_ != 0) {
        output.writeUInt32(7, unk3250JPICLIDLIEC_);
      }
      if (assistAvatar_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250NDPHNNOFEBL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, unk3250NDPHNNOFEBL_);
      }
      if (unk3250JPICLIDLIEC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250JPICLIDLIEC_);
      }
      if (assistAvatar_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250NDPHNNOFEBL()
          != other.getUnk3250NDPHNNOFEBL()) return false;
      if (getUnk3250JPICLIDLIEC()
          != other.getUnk3250JPICLIDLIEC()) return false;
      if (getAssistAvatar()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_NDPHNNOFEBL_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250NDPHNNOFEBL();
      hash = (37 * hash) + UNK3250_JPICLIDLIEC_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250JPICLIDLIEC();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250NDPHNNOFEBL_ = 0;

        unk3250JPICLIDLIEC_ = 0;
      ...
      public emu.grasscutter.net.proto.PlayerCookReqOuterClass.PlayerCookReq buildPartial() {
        ...
        result.unk3250NDPHNNOFEBL_ = unk3250NDPHNNOFEBL_;
        result.unk3250JPICLIDLIEC_ = unk3250JPICLIDLIEC_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PlayerCookReqOuterClass.PlayerCookReq other) {
        ...
        if (other.getUnk3250NDPHNNOFEBL() != 0) {
          setUnk3250NDPHNNOFEBL(other.getUnk3250NDPHNNOFEBL());
        }
        if (other.getUnk3250JPICLIDLIEC() != 0) {
          setUnk3250JPICLIDLIEC(other.getUnk3250JPICLIDLIEC());
        }
      ...
      /**
       * <code>uint32 Unk3250_NDPHNNOFEBL = 5;</code>
       * @param value The unk3250NDPHNNOFEBL to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NDPHNNOFEBL(int value) {
        
        unk3250NDPHNNOFEBL_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NDPHNNOFEBL() {
      ...
      /**
       * <code>uint32 Unk3250_JPICLIDLIEC = 7;</code>
       * @param value The unk3250JPICLIDLIEC to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250JPICLIDLIEC(int value) {
        
        unk3250JPICLIDLIEC_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250JPICLIDLIEC() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\trecipe_id\030\001 \001(\r\022\033\n\023Unk3250_NDPHNNOFEBL" +
      "\030\005 \001(\r\022\033\n\023Unk3250_JPICLIDLIEC\030\007 \001(\r\022\025\n\ra" +
    ...
    internal_static_PlayerCookReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerCookReq_descriptor,
        new java.lang.String[] { "RecipeId", "Unk3250NDPHNNOFEBL", "Unk3250JPICLIDLIEC", "AssistAvatar", });
  }
