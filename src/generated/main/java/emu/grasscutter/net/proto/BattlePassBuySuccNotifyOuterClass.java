...
public final class BattlePassBuySuccNotifyOuterClass {
  ...
  public interface BattlePassBuySuccNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_PJODFJKAFLG = 4;</code>
     * @return The unk3250PJODFJKAFLG.
     */
    int getUnk3250PJODFJKAFLG();

    /**
     * <code>uint32 Unk3250_IJOIKKDNKDE = 9;</code>
     * @return The unk3250IJOIKKDNKDE.
     */
    int getUnk3250IJOIKKDNKDE();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32: {
              ...
              unk3250PJODFJKAFLG_ = input.readUInt32();
              break;
            }
            case 72: {

              unk3250IJOIKKDNKDE_ = input.readUInt32();
              break;
            }
            case 82: {
    ...
    public static final int UNK3250_PJODFJKAFLG_FIELD_NUMBER = 4;
    private int unk3250PJODFJKAFLG_;
    /**
     * <code>uint32 Unk3250_PJODFJKAFLG = 4;</code>
     * @return The unk3250PJODFJKAFLG.
     */
    @java.lang.Override
    public int getUnk3250PJODFJKAFLG() {
      return unk3250PJODFJKAFLG_;
    }

    public static final int UNK3250_IJOIKKDNKDE_FIELD_NUMBER = 9;
    private int unk3250IJOIKKDNKDE_;
    /**
     * <code>uint32 Unk3250_IJOIKKDNKDE = 9;</code>
     * @return The unk3250IJOIKKDNKDE.
     */
    @java.lang.Override
    public int getUnk3250IJOIKKDNKDE() {
      return unk3250IJOIKKDNKDE_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250PJODFJKAFLG_ != 0) {
        output.writeUInt32(4, unk3250PJODFJKAFLG_);
      }
      if (unk3250IJOIKKDNKDE_ != 0) {
        output.writeUInt32(9, unk3250IJOIKKDNKDE_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250PJODFJKAFLG_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, unk3250PJODFJKAFLG_);
      }
      if (unk3250IJOIKKDNKDE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, unk3250IJOIKKDNKDE_);
      }
      for (int i = 0; i < itemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250PJODFJKAFLG()
          != other.getUnk3250PJODFJKAFLG()) return false;
      if (getUnk3250IJOIKKDNKDE()
          != other.getUnk3250IJOIKKDNKDE()) return false;
      if (getScheduleId()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_PJODFJKAFLG_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PJODFJKAFLG();
      hash = (37 * hash) + UNK3250_IJOIKKDNKDE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IJOIKKDNKDE();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250PJODFJKAFLG_ = 0;

        unk3250IJOIKKDNKDE_ = 0;
      ...
      public emu.grasscutter.net.proto.BattlePassBuySuccNotifyOuterClass.BattlePassBuySuccNotify buildPartial() {
        ...
        result.unk3250PJODFJKAFLG_ = unk3250PJODFJKAFLG_;
        result.unk3250IJOIKKDNKDE_ = unk3250IJOIKKDNKDE_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BattlePassBuySuccNotifyOuterClass.BattlePassBuySuccNotify other) {
        ...
        if (other.getUnk3250PJODFJKAFLG() != 0) {
          setUnk3250PJODFJKAFLG(other.getUnk3250PJODFJKAFLG());
        }
        if (other.getUnk3250IJOIKKDNKDE() != 0) {
          setUnk3250IJOIKKDNKDE(other.getUnk3250IJOIKKDNKDE());
        }
      ...
      /**
       * <code>uint32 Unk3250_PJODFJKAFLG = 4;</code>
       * @param value The unk3250PJODFJKAFLG to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PJODFJKAFLG(int value) {
        
        unk3250PJODFJKAFLG_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PJODFJKAFLG() {
      ...
      /**
       * <code>uint32 Unk3250_IJOIKKDNKDE = 9;</code>
       * @param value The unk3250IJOIKKDNKDE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IJOIKKDNKDE(int value) {
        
        unk3250IJOIKKDNKDE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IJOIKKDNKDE() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Unk3250_PJODFJKAFLG\030\004 \001(\r\022\033\n\023Unk3250_IJO" +
    ...
    internal_static_BattlePassBuySuccNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BattlePassBuySuccNotify_descriptor,
        new java.lang.String[] { "Unk3250PJODFJKAFLG", "Unk3250IJOIKKDNKDE", "ScheduleId", "ItemList", });
    emu.grasscutter.net.proto.ItemParamOuterClass.getDescriptor();
  }
