...
public final class AddNoGachaAvatarCardNotifyOuterClass {
  ...
  public interface AddNoGachaAvatarCardNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_MGAPHPOLKKE = 7;</code>
     * @return The unk3250MGAPHPOLKKE.
     */
    int getUnk3250MGAPHPOLKKE();
    ...
    /**
     * <code>uint32 Unk3250_GPBINALMFDF = 8;</code>
     * @return The unk3250GPBINALMFDF.
     */
    int getUnk3250GPBINALMFDF();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250MGAPHPOLKKE_ = input.readUInt32();
              break;
            }
            case 64: {

              unk3250GPBINALMFDF_ = input.readUInt32();
              break;
            }
            case 72: {
    ...
    public static final int UNK3250_MGAPHPOLKKE_FIELD_NUMBER = 7;
    private int unk3250MGAPHPOLKKE_;
    /**
     * <code>uint32 Unk3250_MGAPHPOLKKE = 7;</code>
     * @return The unk3250MGAPHPOLKKE.
     */
    @java.lang.Override
    public int getUnk3250MGAPHPOLKKE() {
      return unk3250MGAPHPOLKKE_;
    }
    ...
    public static final int UNK3250_GPBINALMFDF_FIELD_NUMBER = 8;
    private int unk3250GPBINALMFDF_;
    /**
     * <code>uint32 Unk3250_GPBINALMFDF = 8;</code>
     * @return The unk3250GPBINALMFDF.
     */
    @java.lang.Override
    public int getUnk3250GPBINALMFDF() {
      return unk3250GPBINALMFDF_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250MGAPHPOLKKE_ != 0) {
        output.writeUInt32(7, unk3250MGAPHPOLKKE_);
      }
      if (unk3250GPBINALMFDF_ != 0) {
        output.writeUInt32(8, unk3250GPBINALMFDF_);
      }
      if (reason_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250MGAPHPOLKKE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250MGAPHPOLKKE_);
      }
      if (unk3250GPBINALMFDF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, unk3250GPBINALMFDF_);
      }
      if (reason_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250MGAPHPOLKKE()
          != other.getUnk3250MGAPHPOLKKE()) return false;
      if (getItemId()
      ...
      if (getUnk3250GPBINALMFDF()
          != other.getUnk3250GPBINALMFDF()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_MGAPHPOLKKE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250MGAPHPOLKKE();
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsTransferToItem());
      hash = (37 * hash) + UNK3250_GPBINALMFDF_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250GPBINALMFDF();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.AddNoGachaAvatarCardNotifyOuterClass.AddNoGachaAvatarCardNotify buildPartial() {
        ...
        result.unk3250MGAPHPOLKKE_ = unk3250MGAPHPOLKKE_;
        result.itemId_ = itemId_;
        result.avatarId_ = avatarId_;
        result.isTransferToItem_ = isTransferToItem_;
        result.unk3250GPBINALMFDF_ = unk3250GPBINALMFDF_;
        if (transferItemListBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AddNoGachaAvatarCardNotifyOuterClass.AddNoGachaAvatarCardNotify other) {
        ...
        if (other.getUnk3250MGAPHPOLKKE() != 0) {
          setUnk3250MGAPHPOLKKE(other.getUnk3250MGAPHPOLKKE());
        }
        ...
        if (other.getUnk3250GPBINALMFDF() != 0) {
          setUnk3250GPBINALMFDF(other.getUnk3250GPBINALMFDF());
        }
        if (transferItemListBuilder_ == null) {
      ...
      /**
       * <code>uint32 Unk3250_MGAPHPOLKKE = 7;</code>
       * @param value The unk3250MGAPHPOLKKE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250MGAPHPOLKKE(int value) {
        
        unk3250MGAPHPOLKKE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250MGAPHPOLKKE() {
      ...
      /**
       * <code>uint32 Unk3250_GPBINALMFDF = 8;</code>
       * @param value The unk3250GPBINALMFDF to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250GPBINALMFDF(int value) {
        
        unk3250GPBINALMFDF_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250GPBINALMFDF() {
  ...
  static {
    ...
    internal_static_AddNoGachaAvatarCardNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AddNoGachaAvatarCardNotify_descriptor,
        new java.lang.String[] { "Reason", "Unk3250MGAPHPOLKKE", "ItemId", "AvatarId", "IsTransferToItem", "Unk3250GPBINALMFDF", "TransferItemList", });
    emu.grasscutter.net.proto.AddNoGachaAvatarCardTransferItemOuterClass.getDescriptor();
  }
