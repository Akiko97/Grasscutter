...
public final class FishCastRodReqOuterClass {
  ...
  public interface FishCastRodReqOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_PJFHEDDFOBM = 7;</code>
     * @return The unk3250PJFHEDDFOBM.
     */
    int getUnk3250PJFHEDDFOBM();

    /**
     * <code>uint32 Unk3250_ICALEIBJCDA = 13;</code>
     * @return The unk3250ICALEIBJCDA.
     */
    int getUnk3250ICALEIBJCDA();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56: {
              ...
              unk3250PJFHEDDFOBM_ = input.readUInt32();
              break;
            }
            case 64: {
            ...
            case 104: {
              ...
              unk3250ICALEIBJCDA_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_PJFHEDDFOBM_FIELD_NUMBER = 7;
    private int unk3250PJFHEDDFOBM_;
    /**
     * <code>uint32 Unk3250_PJFHEDDFOBM = 7;</code>
     * @return The unk3250PJFHEDDFOBM.
     */
    @java.lang.Override
    public int getUnk3250PJFHEDDFOBM() {
      return unk3250PJFHEDDFOBM_;
    }

    public static final int UNK3250_ICALEIBJCDA_FIELD_NUMBER = 13;
    private int unk3250ICALEIBJCDA_;
    /**
     * <code>uint32 Unk3250_ICALEIBJCDA = 13;</code>
     * @return The unk3250ICALEIBJCDA.
     */
    @java.lang.Override
    public int getUnk3250ICALEIBJCDA() {
      return unk3250ICALEIBJCDA_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250PJFHEDDFOBM_ != 0) {
        output.writeUInt32(7, unk3250PJFHEDDFOBM_);
      }
      if (rodEntityId_ != 0) {
      ...
      if (unk3250ICALEIBJCDA_ != 0) {
        output.writeUInt32(13, unk3250ICALEIBJCDA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250PJFHEDDFOBM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250PJFHEDDFOBM_);
      }
      if (rodEntityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250ICALEIBJCDA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, unk3250ICALEIBJCDA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250PJFHEDDFOBM()
          != other.getUnk3250PJFHEDDFOBM()) return false;
      if (getUnk3250ICALEIBJCDA()
          != other.getUnk3250ICALEIBJCDA()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_PJFHEDDFOBM_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PJFHEDDFOBM();
      hash = (37 * hash) + UNK3250_ICALEIBJCDA_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250ICALEIBJCDA();
      if (hasPos()) {
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250PJFHEDDFOBM_ = 0;

        unk3250ICALEIBJCDA_ = 0;
      ...
      public emu.grasscutter.net.proto.FishCastRodReqOuterClass.FishCastRodReq buildPartial() {
        ...
        result.unk3250PJFHEDDFOBM_ = unk3250PJFHEDDFOBM_;
        result.unk3250ICALEIBJCDA_ = unk3250ICALEIBJCDA_;
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FishCastRodReqOuterClass.FishCastRodReq other) {
        ...
        if (other.getUnk3250PJFHEDDFOBM() != 0) {
          setUnk3250PJFHEDDFOBM(other.getUnk3250PJFHEDDFOBM());
        }
        if (other.getUnk3250ICALEIBJCDA() != 0) {
          setUnk3250ICALEIBJCDA(other.getUnk3250ICALEIBJCDA());
        }
        if (other.hasPos()) {
      ...
      /**
       * <code>uint32 Unk3250_PJFHEDDFOBM = 7;</code>
       * @param value The unk3250PJFHEDDFOBM to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PJFHEDDFOBM(int value) {
        
        unk3250PJFHEDDFOBM_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PJFHEDDFOBM() {
      ...
      /**
       * <code>uint32 Unk3250_ICALEIBJCDA = 13;</code>
       * @param value The unk3250ICALEIBJCDA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250ICALEIBJCDA(int value) {
        
        unk3250ICALEIBJCDA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250ICALEIBJCDA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "FishCastRodReq\022\033\n\023Unk3250_PJFHEDDFOBM\030\007 " +
      "\001(\r\022\033\n\023Unk3250_ICALEIBJCDA\030\r \001(\r\022\024\n\003pos\030" +
    ...
    internal_static_FishCastRodReq_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FishCastRodReq_descriptor,
        new java.lang.String[] { "Unk3250PJFHEDDFOBM", "Unk3250ICALEIBJCDA", "Pos", "RodEntityId", });
    emu.grasscutter.net.proto.VectorOuterClass.getDescriptor();
  }
