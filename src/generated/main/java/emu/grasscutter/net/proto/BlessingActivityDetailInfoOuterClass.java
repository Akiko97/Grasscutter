...
public final class BlessingActivityDetailInfoOuterClass {
  ...
  public interface BlessingActivityDetailInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_JLADHEKJPBP = 1;</code>
     * @return The unk3250JLADHEKJPBP.
     */
    int getUnk3250JLADHEKJPBP();
    ...
    /**
     * <code>uint32 Unk3250_INOHLELBOAM = 7;</code>
     * @return The unk3250INOHLELBOAM.
     */
    int getUnk3250INOHLELBOAM();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              unk3250JLADHEKJPBP_ = input.readUInt32();
              break;
            }
            case 16: {
            ...
            case 56: {
              ...
              unk3250INOHLELBOAM_ = input.readUInt32();
              break;
            }
            case 64: {
    ...
    public static final int UNK3250_JLADHEKJPBP_FIELD_NUMBER = 1;
    private int unk3250JLADHEKJPBP_;
    /**
     * <code>uint32 Unk3250_JLADHEKJPBP = 1;</code>
     * @return The unk3250JLADHEKJPBP.
     */
    @java.lang.Override
    public int getUnk3250JLADHEKJPBP() {
      return unk3250JLADHEKJPBP_;
    }
    ...
    public static final int UNK3250_INOHLELBOAM_FIELD_NUMBER = 7;
    private int unk3250INOHLELBOAM_;
    /**
     * <code>uint32 Unk3250_INOHLELBOAM = 7;</code>
     * @return The unk3250INOHLELBOAM.
     */
    @java.lang.Override
    public int getUnk3250INOHLELBOAM() {
      return unk3250INOHLELBOAM_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250JLADHEKJPBP_ != 0) {
        output.writeUInt32(1, unk3250JLADHEKJPBP_);
      }
      ...
      if (unk3250INOHLELBOAM_ != 0) {
        output.writeUInt32(7, unk3250INOHLELBOAM_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250JLADHEKJPBP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, unk3250JLADHEKJPBP_);
      }
      if (isContentClosed_ != false) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250INOHLELBOAM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250INOHLELBOAM_);
      }
      if (contentCloseTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250JLADHEKJPBP()
          != other.getUnk3250JLADHEKJPBP()) return false;
      if (getNextRefreshTime()
          != other.getNextRefreshTime()) return false;
      if (getIsActivated()
          != other.getIsActivated()) return false;
      if (getUnk3250INOHLELBOAM()
          != other.getUnk3250INOHLELBOAM()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_JLADHEKJPBP_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250JLADHEKJPBP();
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsActivated());
      hash = (37 * hash) + UNK3250_INOHLELBOAM_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250INOHLELBOAM();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250JLADHEKJPBP_ = 0;

        nextRefreshTime_ = 0;

        isActivated_ = false;

        unk3250INOHLELBOAM_ = 0;
      ...
      public emu.grasscutter.net.proto.BlessingActivityDetailInfoOuterClass.BlessingActivityDetailInfo buildPartial() {
        ...
        result.unk3250JLADHEKJPBP_ = unk3250JLADHEKJPBP_;
        result.nextRefreshTime_ = nextRefreshTime_;
        result.isActivated_ = isActivated_;
        result.unk3250INOHLELBOAM_ = unk3250INOHLELBOAM_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BlessingActivityDetailInfoOuterClass.BlessingActivityDetailInfo other) {
        ...
        if (other.getUnk3250JLADHEKJPBP() != 0) {
          setUnk3250JLADHEKJPBP(other.getUnk3250JLADHEKJPBP());
        }
        ...
        if (other.getUnk3250INOHLELBOAM() != 0) {
          setUnk3250INOHLELBOAM(other.getUnk3250INOHLELBOAM());
        }
      ...
      /**
       * <code>uint32 Unk3250_JLADHEKJPBP = 1;</code>
       * @param value The unk3250JLADHEKJPBP to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250JLADHEKJPBP(int value) {
        
        unk3250JLADHEKJPBP_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250JLADHEKJPBP() {
      ...
      /**
       * <code>uint32 Unk3250_INOHLELBOAM = 7;</code>
       * @param value The unk3250INOHLELBOAM to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250INOHLELBOAM(int value) {
        
        unk3250INOHLELBOAM_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250INOHLELBOAM() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\033\n\023Unk3250_JLADHEKJPBP\030\001 \001(\r\022\031\n\021next_ref" +
      "resh_time\030\006 \001(\r\022\024\n\014is_activated\030\005 \001(\010\022\033\n" +
      "\023Unk3250_INOHLELBOAM\030\007 \001(\r\022\031\n\021is_content" +
    ...
    internal_static_BlessingActivityDetailInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BlessingActivityDetailInfo_descriptor,
        new java.lang.String[] { "CurDayScanNum", "ContentCloseTime", "Unk3250JLADHEKJPBP", "NextRefreshTime", "IsActivated", "Unk3250INOHLELBOAM", "IsContentClosed", "PicNumMap", });
    internal_static_BlessingActivityDetailInfo_PicNumMapEntry_descriptor =
