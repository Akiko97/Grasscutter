...
public final class BounceConjuringGallerySettleInfoOuterClass {
  ...
  public interface BounceConjuringGallerySettleInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_PELHBJDMKAE = 6;</code>
     * @return The unk3250PELHBJDMKAE.
     */
    int getUnk3250PELHBJDMKAE();
    ...
    /**
     * <code>uint32 Unk3250_CNGOBOFDEOE = 11;</code>
     * @return The unk3250CNGOBOFDEOE.
     */
    int getUnk3250CNGOBOFDEOE();

    /**
     * <code>uint32 Unk3250_NKGFKLGDFAC = 1;</code>
     * @return The unk3250NKGFKLGDFAC.
     */
    int getUnk3250NKGFKLGDFAC();
    ...
    /**
     * <code>uint32 Unk3250_BJHCDKNFDFN = 7;</code>
     * @return The unk3250BJHCDKNFDFN.
     */
    int getUnk3250BJHCDKNFDFN();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              unk3250NKGFKLGDFAC_ = input.readUInt32();
              break;
            }
            case 18: {
            ...
            case 48: {
              ...
              unk3250PELHBJDMKAE_ = input.readUInt32();
              break;
            }
            case 56: {

              unk3250BJHCDKNFDFN_ = input.readUInt32();
              break;
            }
            case 74: {
            ...
            case 88: {
              ...
              unk3250CNGOBOFDEOE_ = input.readUInt32();
              break;
            }
            case 101: {
    ...
    public static final int UNK3250_PELHBJDMKAE_FIELD_NUMBER = 6;
    private int unk3250PELHBJDMKAE_;
    /**
     * <code>uint32 Unk3250_PELHBJDMKAE = 6;</code>
     * @return The unk3250PELHBJDMKAE.
     */
    @java.lang.Override
    public int getUnk3250PELHBJDMKAE() {
      return unk3250PELHBJDMKAE_;
    }
    ...
    public static final int UNK3250_CNGOBOFDEOE_FIELD_NUMBER = 11;
    private int unk3250CNGOBOFDEOE_;
    /**
     * <code>uint32 Unk3250_CNGOBOFDEOE = 11;</code>
     * @return The unk3250CNGOBOFDEOE.
     */
    @java.lang.Override
    public int getUnk3250CNGOBOFDEOE() {
      return unk3250CNGOBOFDEOE_;
    }

    public static final int UNK3250_NKGFKLGDFAC_FIELD_NUMBER = 1;
    private int unk3250NKGFKLGDFAC_;
    /**
     * <code>uint32 Unk3250_NKGFKLGDFAC = 1;</code>
     * @return The unk3250NKGFKLGDFAC.
     */
    @java.lang.Override
    public int getUnk3250NKGFKLGDFAC() {
      return unk3250NKGFKLGDFAC_;
    }
    ...
    public static final int UNK3250_BJHCDKNFDFN_FIELD_NUMBER = 7;
    private int unk3250BJHCDKNFDFN_;
    /**
     * <code>uint32 Unk3250_BJHCDKNFDFN = 7;</code>
     * @return The unk3250BJHCDKNFDFN.
     */
    @java.lang.Override
    public int getUnk3250BJHCDKNFDFN() {
      return unk3250BJHCDKNFDFN_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250NKGFKLGDFAC_ != 0) {
        output.writeUInt32(1, unk3250NKGFKLGDFAC_);
      }
      if (playerInfo_ != null) {
      ...
      com.google.protobuf.GeneratedMessageV3
        .serializeIntegerMapTo(
          ...
          GadgetCountMapDefaultEntryHolder.defaultEntry,
          3);
      if (unk3250PELHBJDMKAE_ != 0) {
        output.writeUInt32(6, unk3250PELHBJDMKAE_);
      }
      if (unk3250BJHCDKNFDFN_ != 0) {
        output.writeUInt32(7, unk3250BJHCDKNFDFN_);
      }
      for (int i = 0; i < cardList_.size(); i++) {
        output.writeMessage(9, cardList_.get(i));
      }
      if (unk3250CNGOBOFDEOE_ != 0) {
        output.writeUInt32(11, unk3250CNGOBOFDEOE_);
      }
      if (damage_ != 0F) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250NKGFKLGDFAC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, unk3250NKGFKLGDFAC_);
      }
      if (playerInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250PELHBJDMKAE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(6, unk3250PELHBJDMKAE_);
      }
      if (unk3250BJHCDKNFDFN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(7, unk3250BJHCDKNFDFN_);
      }
      for (int i = 0; i < cardList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250CNGOBOFDEOE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, unk3250CNGOBOFDEOE_);
      }
      if (damage_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250PELHBJDMKAE()
          != other.getUnk3250PELHBJDMKAE()) return false;
      if (getScore()
          != other.getScore()) return false;
      if (!internalGetGadgetCountMap().equals(
          other.internalGetGadgetCountMap())) return false;
      if (getUnk3250CNGOBOFDEOE()
          != other.getUnk3250CNGOBOFDEOE()) return false;
      if (getUnk3250NKGFKLGDFAC()
          != other.getUnk3250NKGFKLGDFAC()) return false;
      ...
      if (getUnk3250BJHCDKNFDFN()
          != other.getUnk3250BJHCDKNFDFN()) return false;
      if (!getCardListList()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_PELHBJDMKAE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PELHBJDMKAE();
      ...
      hash = (37 * hash) + UNK3250_CNGOBOFDEOE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250CNGOBOFDEOE();
      hash = (37 * hash) + UNK3250_NKGFKLGDFAC_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250NKGFKLGDFAC();
      if (hasPlayerInfo()) {
      ...
      hash = (53 * hash) + java.lang.Float.floatToIntBits(
          getDamage());
      hash = (37 * hash) + UNK3250_BJHCDKNFDFN_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250BJHCDKNFDFN();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250PELHBJDMKAE_ = 0;

        score_ = 0;

        internalGetMutableGadgetCountMap().clear();
        unk3250CNGOBOFDEOE_ = 0;

        unk3250NKGFKLGDFAC_ = 0;
      ...
      public emu.grasscutter.net.proto.BounceConjuringGallerySettleInfoOuterClass.BounceConjuringGallerySettleInfo buildPartial() {
        ...
        result.unk3250PELHBJDMKAE_ = unk3250PELHBJDMKAE_;
        result.score_ = score_;
        result.gadgetCountMap_ = internalGetGadgetCountMap();
        result.gadgetCountMap_.makeImmutable();
        result.unk3250CNGOBOFDEOE_ = unk3250CNGOBOFDEOE_;
        result.unk3250NKGFKLGDFAC_ = unk3250NKGFKLGDFAC_;
        if (playerInfoBuilder_ == null) {
        ...
        result.unk3250BJHCDKNFDFN_ = unk3250BJHCDKNFDFN_;
        if (cardListBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.BounceConjuringGallerySettleInfoOuterClass.BounceConjuringGallerySettleInfo other) {
        ...
        if (other.getUnk3250PELHBJDMKAE() != 0) {
          setUnk3250PELHBJDMKAE(other.getUnk3250PELHBJDMKAE());
        }
        if (other.getScore() != 0) {
        ...
        if (other.getUnk3250CNGOBOFDEOE() != 0) {
          setUnk3250CNGOBOFDEOE(other.getUnk3250CNGOBOFDEOE());
        }
        if (other.getUnk3250NKGFKLGDFAC() != 0) {
          setUnk3250NKGFKLGDFAC(other.getUnk3250NKGFKLGDFAC());
        }
        ...
        if (other.getUnk3250BJHCDKNFDFN() != 0) {
          setUnk3250BJHCDKNFDFN(other.getUnk3250BJHCDKNFDFN());
        }
        if (cardListBuilder_ == null) {
      ...
      /**
       * <code>uint32 Unk3250_PELHBJDMKAE = 6;</code>
       * @param value The unk3250PELHBJDMKAE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PELHBJDMKAE(int value) {
        
        unk3250PELHBJDMKAE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PELHBJDMKAE() {
      ...
      /**
       * <code>uint32 Unk3250_CNGOBOFDEOE = 11;</code>
       * @param value The unk3250CNGOBOFDEOE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250CNGOBOFDEOE(int value) {
        
        unk3250CNGOBOFDEOE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250CNGOBOFDEOE() {
      ...
      /**
       * <code>uint32 Unk3250_NKGFKLGDFAC = 1;</code>
       * @param value The unk3250NKGFKLGDFAC to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NKGFKLGDFAC(int value) {
        
        unk3250NKGFKLGDFAC_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NKGFKLGDFAC() {
      ...
      /**
       * <code>uint32 Unk3250_BJHCDKNFDFN = 7;</code>
       * @param value The unk3250BJHCDKNFDFN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250BJHCDKNFDFN(int value) {
        
        unk3250BJHCDKNFDFN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250BJHCDKNFDFN() {
  ...
  static {
    ...
    internal_static_BounceConjuringGallerySettleInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_BounceConjuringGallerySettleInfo_descriptor,
        new java.lang.String[] { "Unk3250PELHBJDMKAE", "Score", "GadgetCountMap", "Unk3250CNGOBOFDEOE", "Unk3250NKGFKLGDFAC", "PlayerInfo", "Damage", "Unk3250BJHCDKNFDFN", "CardList", });
    internal_static_BounceConjuringGallerySettleInfo_GadgetCountMapEntry_descriptor =
