...
public final class TowerLevelEndNotifyOuterClass {
  ...
  public interface TowerLevelEndNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_BOPIBKGAMID = 2;</code>
     * @return The unk3250BOPIBKGAMID.
     */
    int getUnk3250BOPIBKGAMID();
    ...
    /**
     * <code>uint32 Unk3250_AHBGPMBHPMO = 4;</code>
     * @return The unk3250AHBGPMBHPMO.
     */
    int getUnk3250AHBGPMBHPMO();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              unk3250BOPIBKGAMID_ = input.readUInt32();
              break;
            }
            case 32: {

              unk3250AHBGPMBHPMO_ = input.readUInt32();
              break;
            }
            case 48: {
    ...
    public static final int UNK3250_BOPIBKGAMID_FIELD_NUMBER = 2;
    private int unk3250BOPIBKGAMID_;
    /**
     * <code>uint32 Unk3250_BOPIBKGAMID = 2;</code>
     * @return The unk3250BOPIBKGAMID.
     */
    @java.lang.Override
    public int getUnk3250BOPIBKGAMID() {
      return unk3250BOPIBKGAMID_;
    }
    ...
    public static final int UNK3250_AHBGPMBHPMO_FIELD_NUMBER = 4;
    private int unk3250AHBGPMBHPMO_;
    /**
     * <code>uint32 Unk3250_AHBGPMBHPMO = 4;</code>
     * @return The unk3250AHBGPMBHPMO.
     */
    @java.lang.Override
    public int getUnk3250AHBGPMBHPMO() {
      return unk3250AHBGPMBHPMO_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (unk3250BOPIBKGAMID_ != 0) {
        output.writeUInt32(2, unk3250BOPIBKGAMID_);
      }
      if (unk3250AHBGPMBHPMO_ != 0) {
        output.writeUInt32(4, unk3250AHBGPMBHPMO_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250BOPIBKGAMID_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, unk3250BOPIBKGAMID_);
      }
      if (unk3250AHBGPMBHPMO_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, unk3250AHBGPMBHPMO_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < finishedStarCondList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250BOPIBKGAMID()
          != other.getUnk3250BOPIBKGAMID()) return false;
      if (!getFinishedStarCondListList()
          .equals(other.getFinishedStarCondListList())) return false;
      if (getUnk3250AHBGPMBHPMO()
          != other.getUnk3250AHBGPMBHPMO()) return false;
      if (getIsSuccess()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_BOPIBKGAMID_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250BOPIBKGAMID();
      ...
      hash = (37 * hash) + UNK3250_AHBGPMBHPMO_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250AHBGPMBHPMO();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250BOPIBKGAMID_ = 0;

        finishedStarCondList_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        unk3250AHBGPMBHPMO_ = 0;
      ...
      public emu.grasscutter.net.proto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify buildPartial() {
        ...
        result.unk3250BOPIBKGAMID_ = unk3250BOPIBKGAMID_;
        if (((bitField0_ & 0x00000001) != 0)) {
          finishedStarCondList_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.finishedStarCondList_ = finishedStarCondList_;
        result.unk3250AHBGPMBHPMO_ = unk3250AHBGPMBHPMO_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.TowerLevelEndNotifyOuterClass.TowerLevelEndNotify other) {
        ...
        if (other.getUnk3250BOPIBKGAMID() != 0) {
          setUnk3250BOPIBKGAMID(other.getUnk3250BOPIBKGAMID());
        }
        ...
        if (other.getUnk3250AHBGPMBHPMO() != 0) {
          setUnk3250AHBGPMBHPMO(other.getUnk3250AHBGPMBHPMO());
        }
      ...
      /**
       * <code>uint32 Unk3250_BOPIBKGAMID = 2;</code>
       * @param value The unk3250BOPIBKGAMID to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250BOPIBKGAMID(int value) {
        
        unk3250BOPIBKGAMID_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250BOPIBKGAMID() {
      ...
      /**
       * <code>uint32 Unk3250_AHBGPMBHPMO = 4;</code>
       * @param value The unk3250AHBGPMBHPMO to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250AHBGPMBHPMO(int value) {
        
        unk3250AHBGPMBHPMO_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250AHBGPMBHPMO() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "list\030\006 \003(\r\022\033\n\023Unk3250_AHBGPMBHPMO\030\004 \001(\r\022" +
    ...
    internal_static_TowerLevelEndNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_TowerLevelEndNotify_descriptor,
        new java.lang.String[] { "Unk3250BOPIBKGAMID", "FinishedStarCondList", "Unk3250AHBGPMBHPMO", "IsSuccess", "RewardItemList", });
    emu.grasscutter.net.proto.ItemParamOuterClass.getDescriptor();
  }
