...
public final class AbilityMetaModifierChangeOuterClass {
  ...
  public interface AbilityMetaModifierChangeOrBuilder extends
    ...
    /**
     * <code>bool Unk3250_NOPKODKOHJK = 12;</code>
     * @return The unk3250NOPKODKOHJK.
     */
    boolean getUnk3250NOPKODKOHJK();
    ...
    /**
     * <code>bool Unk3250_PBNENPBMNCI = 8;</code>
     * @return The unk3250PBNENPBMNCI.
     */
    boolean getUnk3250PBNENPBMNCI();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 64: {
              ...
              unk3250PBNENPBMNCI_ = input.readBool();
              break;
            }
            case 72: {
            ...
            case 96: {
              ...
              unk3250NOPKODKOHJK_ = input.readBool();
              break;
            }
            case 106: {
    ...
    public static final int UNK3250_NOPKODKOHJK_FIELD_NUMBER = 12;
    private boolean unk3250NOPKODKOHJK_;
    /**
     * <code>bool Unk3250_NOPKODKOHJK = 12;</code>
     * @return The unk3250NOPKODKOHJK.
     */
    @java.lang.Override
    public boolean getUnk3250NOPKODKOHJK() {
      return unk3250NOPKODKOHJK_;
    }
    ...
    public static final int UNK3250_PBNENPBMNCI_FIELD_NUMBER = 8;
    private boolean unk3250PBNENPBMNCI_;
    /**
     * <code>bool Unk3250_PBNENPBMNCI = 8;</code>
     * @return The unk3250PBNENPBMNCI.
     */
    @java.lang.Override
    public boolean getUnk3250PBNENPBMNCI() {
      return unk3250PBNENPBMNCI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250PBNENPBMNCI_ != false) {
        output.writeBool(8, unk3250PBNENPBMNCI_);
      }
      if (serverBuffUid_ != 0) {
        output.writeUInt32(9, serverBuffUid_);
      }
      if (unk3250NOPKODKOHJK_ != false) {
        output.writeBool(12, unk3250NOPKODKOHJK_);
      }
      if (parentAbilityName_ != null) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250PBNENPBMNCI_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(8, unk3250PBNENPBMNCI_);
      }
      if (serverBuffUid_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250NOPKODKOHJK_ != false) {
        size += com.google.protobuf.CodedOutputStream
          .computeBoolSize(12, unk3250NOPKODKOHJK_);
      }
      if (parentAbilityName_ != null) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250NOPKODKOHJK()
          != other.getUnk3250NOPKODKOHJK()) return false;
      if (getModifierLocalId()
          != other.getModifierLocalId()) return false;
      if (getUnk3250PBNENPBMNCI()
          != other.getUnk3250PBNENPBMNCI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_NOPKODKOHJK_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getUnk3250NOPKODKOHJK());
      hash = (37 * hash) + MODIFIER_LOCAL_ID_FIELD_NUMBER;
      hash = (53 * hash) + getModifierLocalId();
      hash = (37 * hash) + UNK3250_PBNENPBMNCI_FIELD_NUMBER;
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getUnk3250PBNENPBMNCI());
      if (hasParentAbilityName()) {
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250NOPKODKOHJK_ = false;

        modifierLocalId_ = 0;

        unk3250PBNENPBMNCI_ = false;
      ...
      public emu.grasscutter.net.proto.AbilityMetaModifierChangeOuterClass.AbilityMetaModifierChange buildPartial() {
        ...
        result.unk3250NOPKODKOHJK_ = unk3250NOPKODKOHJK_;
        result.modifierLocalId_ = modifierLocalId_;
        result.unk3250PBNENPBMNCI_ = unk3250PBNENPBMNCI_;
        if (parentAbilityNameBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AbilityMetaModifierChangeOuterClass.AbilityMetaModifierChange other) {
        ...
        if (other.getUnk3250NOPKODKOHJK() != false) {
          setUnk3250NOPKODKOHJK(other.getUnk3250NOPKODKOHJK());
        }
        if (other.getModifierLocalId() != 0) {
          setModifierLocalId(other.getModifierLocalId());
        }
        if (other.getUnk3250PBNENPBMNCI() != false) {
          setUnk3250PBNENPBMNCI(other.getUnk3250PBNENPBMNCI());
        }
      ...
      /**
       * <code>bool Unk3250_NOPKODKOHJK = 12;</code>
       * @param value The unk3250NOPKODKOHJK to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NOPKODKOHJK(boolean value) {
        
        unk3250NOPKODKOHJK_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NOPKODKOHJK() {
      ...
      /**
       * <code>bool Unk3250_PBNENPBMNCI = 8;</code>
       * @param value The unk3250PBNENPBMNCI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PBNENPBMNCI(boolean value) {
        
        unk3250PBNENPBMNCI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PBNENPBMNCI() {
  ...
  static {
    ...
    internal_static_AbilityMetaModifierChange_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaModifierChange_descriptor,
        new java.lang.String[] { "AttachedInstancedModifier", "IsAttachedParentAbility", "Properties", "Unk3250NOPKODKOHJK", "ModifierLocalId", "Unk3250PBNENPBMNCI", "ParentAbilityName", "ServerBuffUid", "ApplyEntityId", "ParentAbilityOverride", "Action", });
    emu.grasscutter.net.proto.AbilityAttachedModifierOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AbilityStringOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ModifierActionOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ModifierPropertyOuterClass.getDescriptor();
