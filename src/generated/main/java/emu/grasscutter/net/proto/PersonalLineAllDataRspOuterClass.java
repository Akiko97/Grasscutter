...
public final class PersonalLineAllDataRspOuterClass {
  ...
  public interface PersonalLineAllDataRspOrBuilder extends
    ...
    /**
     * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
     * @return A list containing the unk3250BHLEGLEICFJ.
     */
    java.util.List<java.lang.Integer> getUnk3250BHLEGLEICFJList();
    /**
     * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
     * @return The count of unk3250BHLEGLEICFJ.
     */
    int getUnk3250BHLEGLEICFJCount();
    /**
     * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
     * @param index The index of the element to return.
     * @return The unk3250BHLEGLEICFJ at the given index.
     */
    int getUnk3250BHLEGLEICFJ(int index);

    /**
     * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
     * @return A list containing the unk3250BGCIGNEGBIN.
     */
    java.util.List<java.lang.Integer> getUnk3250BGCIGNEGBINList();
    /**
     * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
     * @return The count of unk3250BGCIGNEGBIN.
     */
    int getUnk3250BGCIGNEGBINCount();
    /**
     * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
     * @param index The index of the element to return.
     * @return The unk3250BGCIGNEGBIN at the given index.
     */
    int getUnk3250BGCIGNEGBIN(int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    private PersonalLineAllDataRsp() {
      ...
      unk3250BHLEGLEICFJ_ = emptyIntList();
      unk3250BGCIGNEGBIN_ = emptyIntList();
    }
    ...
    private PersonalLineAllDataRsp(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 8: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                unk3250BHLEGLEICFJ_ = newIntList();
                mutable_bitField0_ |= 0x00000002;
              }
              unk3250BHLEGLEICFJ_.addInt(input.readUInt32());
              break;
            }
            case 10: {
            ...
            case 48: {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                unk3250BGCIGNEGBIN_ = newIntList();
                mutable_bitField0_ |= 0x00000004;
              }
              unk3250BGCIGNEGBIN_.addInt(input.readUInt32());
              break;
            }
            case 50: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000002) != 0)) {
          unk3250BHLEGLEICFJ_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000004) != 0)) {
          unk3250BGCIGNEGBIN_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
    ...
    public static final int UNK3250_BHLEGLEICFJ_FIELD_NUMBER = 1;
    private com.google.protobuf.Internal.IntList unk3250BHLEGLEICFJ_;
    /**
     * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
     * @return A list containing the unk3250BHLEGLEICFJ.
     */
    ...
    public java.util.List<java.lang.Integer>
        getUnk3250BHLEGLEICFJList() {
      return unk3250BHLEGLEICFJ_;
    }
    /**
     * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
     * @return The count of unk3250BHLEGLEICFJ.
     */
    public int getUnk3250BHLEGLEICFJCount() {
      return unk3250BHLEGLEICFJ_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
     * @param index The index of the element to return.
     * @return The unk3250BHLEGLEICFJ at the given index.
     */
    public int getUnk3250BHLEGLEICFJ(int index) {
      return unk3250BHLEGLEICFJ_.getInt(index);
    }
    private int unk3250BHLEGLEICFJMemoizedSerializedSize = -1;

    public static final int UNK3250_BGCIGNEGBIN_FIELD_NUMBER = 6;
    private com.google.protobuf.Internal.IntList unk3250BGCIGNEGBIN_;
    /**
     * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
     * @return A list containing the unk3250BGCIGNEGBIN.
     */
    @java.lang.Override
    public java.util.List<java.lang.Integer>
        getUnk3250BGCIGNEGBINList() {
      return unk3250BGCIGNEGBIN_;
    }
    /**
     * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
     * @return The count of unk3250BGCIGNEGBIN.
     */
    public int getUnk3250BGCIGNEGBINCount() {
      return unk3250BGCIGNEGBIN_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
     * @param index The index of the element to return.
     * @return The unk3250BGCIGNEGBIN at the given index.
     */
    public int getUnk3250BGCIGNEGBIN(int index) {
      return unk3250BGCIGNEGBIN_.getInt(index);
    }
    private int unk3250BGCIGNEGBINMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (getUnk3250BHLEGLEICFJList().size() > 0) {
        output.writeUInt32NoTag(10);
        output.writeUInt32NoTag(unk3250BHLEGLEICFJMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250BHLEGLEICFJ_.size(); i++) {
        output.writeUInt32NoTag(unk3250BHLEGLEICFJ_.getInt(i));
      }
      if (retcode_ != 0) {
      ...
      if (getUnk3250BGCIGNEGBINList().size() > 0) {
        output.writeUInt32NoTag(50);
        output.writeUInt32NoTag(unk3250BGCIGNEGBINMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250BGCIGNEGBIN_.size(); i++) {
        output.writeUInt32NoTag(unk3250BGCIGNEGBIN_.getInt(i));
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < unk3250BHLEGLEICFJ_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250BHLEGLEICFJ_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250BHLEGLEICFJList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250BHLEGLEICFJMemoizedSerializedSize = dataSize;
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      }
      {
        ...
        for (int i = 0; i < unk3250BGCIGNEGBIN_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250BGCIGNEGBIN_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250BGCIGNEGBINList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250BGCIGNEGBINMemoizedSerializedSize = dataSize;
      }
      for (int i = 0; i < lockedPersonalLineList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getUnk3250BHLEGLEICFJList()
          .equals(other.getUnk3250BHLEGLEICFJList())) return false;
      if (!getUnk3250BGCIGNEGBINList()
          .equals(other.getUnk3250BGCIGNEGBINList())) return false;
    ...
    public int hashCode() {
      ...
      if (getUnk3250BHLEGLEICFJCount() > 0) {
        hash = (37 * hash) + UNK3250_BHLEGLEICFJ_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250BHLEGLEICFJList().hashCode();
      }
      if (getUnk3250BGCIGNEGBINCount() > 0) {
        hash = (37 * hash) + UNK3250_BGCIGNEGBIN_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250BGCIGNEGBINList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.PersonalLineAllDataRspOuterClass.PersonalLineAllDataRsp buildPartial() {
        ...
        if (((bitField0_ & 0x00000002) != 0)) {
          unk3250BHLEGLEICFJ_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000002);
        }
        result.unk3250BHLEGLEICFJ_ = unk3250BHLEGLEICFJ_;
        if (((bitField0_ & 0x00000004) != 0)) {
          unk3250BGCIGNEGBIN_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000004);
        }
        result.unk3250BGCIGNEGBIN_ = unk3250BGCIGNEGBIN_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PersonalLineAllDataRspOuterClass.PersonalLineAllDataRsp other) {
        ...
        if (!other.unk3250BHLEGLEICFJ_.isEmpty()) {
          if (unk3250BHLEGLEICFJ_.isEmpty()) {
            unk3250BHLEGLEICFJ_ = other.unk3250BHLEGLEICFJ_;
            bitField0_ = (bitField0_ & ~0x00000002);
          } else {
            ensureUnk3250BHLEGLEICFJIsMutable();
            unk3250BHLEGLEICFJ_.addAll(other.unk3250BHLEGLEICFJ_);
          }
          onChanged();
        }
        if (!other.unk3250BGCIGNEGBIN_.isEmpty()) {
          if (unk3250BGCIGNEGBIN_.isEmpty()) {
            unk3250BGCIGNEGBIN_ = other.unk3250BGCIGNEGBIN_;
            bitField0_ = (bitField0_ & ~0x00000004);
          } else {
            ensureUnk3250BGCIGNEGBINIsMutable();
            unk3250BGCIGNEGBIN_.addAll(other.unk3250BGCIGNEGBIN_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList unk3250BHLEGLEICFJ_ = emptyIntList();
      private void ensureUnk3250BHLEGLEICFJIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          unk3250BHLEGLEICFJ_ = mutableCopy(unk3250BHLEGLEICFJ_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000002) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250BHLEGLEICFJ_) : unk3250BHLEGLEICFJ_;
      }
      /**
       * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
       * @return The count of unk3250BHLEGLEICFJ.
       ...
       * @param value The unk3250BHLEGLEICFJ to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250BHLEGLEICFJ(
          int index, int value) {
        ensureUnk3250BHLEGLEICFJIsMutable();
        unk3250BHLEGLEICFJ_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
       * @param value The unk3250BHLEGLEICFJ to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250BHLEGLEICFJ(int value) {
        ensureUnk3250BHLEGLEICFJIsMutable();
        unk3250BHLEGLEICFJ_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_BHLEGLEICFJ = 1;</code>
       * @param values The unk3250BHLEGLEICFJ to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250BHLEGLEICFJ(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250BHLEGLEICFJIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250BHLEGLEICFJ_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250BHLEGLEICFJ() {
        unk3250BHLEGLEICFJ_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000002);
        onChanged();
        return this;
      ...
      private com.google.protobuf.Internal.IntList unk3250BGCIGNEGBIN_ = emptyIntList();
      private void ensureUnk3250BGCIGNEGBINIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          unk3250BGCIGNEGBIN_ = mutableCopy(unk3250BGCIGNEGBIN_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000004) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250BGCIGNEGBIN_) : unk3250BGCIGNEGBIN_;
      }
      /**
       * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
       * @return The count of unk3250BGCIGNEGBIN.
       ...
       * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
       * @param index The index to set the value at.
       * @param value The unk3250BGCIGNEGBIN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250BGCIGNEGBIN(
          int index, int value) {
        ensureUnk3250BGCIGNEGBINIsMutable();
        unk3250BGCIGNEGBIN_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
       * @param value The unk3250BGCIGNEGBIN to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250BGCIGNEGBIN(int value) {
        ensureUnk3250BGCIGNEGBINIsMutable();
        unk3250BGCIGNEGBIN_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_BGCIGNEGBIN = 6;</code>
       * @param values The unk3250BGCIGNEGBIN to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250BGCIGNEGBIN(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250BGCIGNEGBINIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250BGCIGNEGBIN_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250BGCIGNEGBIN() {
        unk3250BGCIGNEGBIN_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000004);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\001(\005\022\033\n\023Unk3250_BHLEGLEICFJ\030\001 \003(\r\022\033\n\023Unk3" +
      "250_BGCIGNEGBIN\030\006 \003(\r\022\033\n\023legendary_key_c" +
    ...
    internal_static_PersonalLineAllDataRsp_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PersonalLineAllDataRsp_descriptor,
        new java.lang.String[] { "CurFinishedDailyTaskCount", "LockedPersonalLineList", "Retcode", "Unk3250BHLEGLEICFJ", "Unk3250BGCIGNEGBIN", "LegendaryKeyCount", });
    emu.grasscutter.net.proto.LockedPersonallineDataOuterClass.getDescriptor();
  }
