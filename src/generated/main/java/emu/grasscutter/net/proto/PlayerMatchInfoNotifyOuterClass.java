...
public final class PlayerMatchInfoNotifyOuterClass {
  ...
  public interface PlayerMatchInfoNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_BNEIANJBLBL = 5;</code>
     * @return The unk3250BNEIANJBLBL.
     */
    int getUnk3250BNEIANJBLBL();

    /**
     * <code>uint32 Unk3250_OCILKHJPJED = 10;</code>
     * @return The unk3250OCILKHJPJED.
     */
    int getUnk3250OCILKHJPJED();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 40: {
              ...
              unk3250BNEIANJBLBL_ = input.readUInt32();
              break;
            }
            case 56: {
            ...
            case 80: {
              ...
              unk3250OCILKHJPJED_ = input.readUInt32();
              break;
            }
            case 88: {
    ...
    public static final int UNK3250_BNEIANJBLBL_FIELD_NUMBER = 5;
    private int unk3250BNEIANJBLBL_;
    /**
     * <code>uint32 Unk3250_BNEIANJBLBL = 5;</code>
     * @return The unk3250BNEIANJBLBL.
     */
    @java.lang.Override
    public int getUnk3250BNEIANJBLBL() {
      return unk3250BNEIANJBLBL_;
    }

    public static final int UNK3250_OCILKHJPJED_FIELD_NUMBER = 10;
    private int unk3250OCILKHJPJED_;
    /**
     * <code>uint32 Unk3250_OCILKHJPJED = 10;</code>
     * @return The unk3250OCILKHJPJED.
     */
    @java.lang.Override
    public int getUnk3250OCILKHJPJED() {
      return unk3250OCILKHJPJED_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250BNEIANJBLBL_ != 0) {
        output.writeUInt32(5, unk3250BNEIANJBLBL_);
      }
      if (matchId_ != 0) {
        output.writeUInt32(7, matchId_);
      }
      if (unk3250OCILKHJPJED_ != 0) {
        output.writeUInt32(10, unk3250OCILKHJPJED_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250BNEIANJBLBL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, unk3250BNEIANJBLBL_);
      }
      if (matchId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250OCILKHJPJED_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250OCILKHJPJED_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < matchParamList_.size(); i++) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250BNEIANJBLBL()
          != other.getUnk3250BNEIANJBLBL()) return false;
      if (getUnk3250OCILKHJPJED()
          != other.getUnk3250OCILKHJPJED()) return false;
      if (getHostUid()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_BNEIANJBLBL_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250BNEIANJBLBL();
      hash = (37 * hash) + UNK3250_OCILKHJPJED_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250OCILKHJPJED();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250BNEIANJBLBL_ = 0;

        unk3250OCILKHJPJED_ = 0;
      ...
      public emu.grasscutter.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify buildPartial() {
        ...
        result.unk3250BNEIANJBLBL_ = unk3250BNEIANJBLBL_;
        result.unk3250OCILKHJPJED_ = unk3250OCILKHJPJED_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify other) {
        ...
        if (other.getUnk3250BNEIANJBLBL() != 0) {
          setUnk3250BNEIANJBLBL(other.getUnk3250BNEIANJBLBL());
        }
        if (other.getUnk3250OCILKHJPJED() != 0) {
          setUnk3250OCILKHJPJED(other.getUnk3250OCILKHJPJED());
        }
      ...
      /**
       * <code>uint32 Unk3250_BNEIANJBLBL = 5;</code>
       * @param value The unk3250BNEIANJBLBL to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250BNEIANJBLBL(int value) {
        
        unk3250BNEIANJBLBL_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250BNEIANJBLBL() {
      ...
      /**
       * <code>uint32 Unk3250_OCILKHJPJED = 10;</code>
       * @param value The unk3250OCILKHJPJED to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250OCILKHJPJED(int value) {
        
        unk3250OCILKHJPJED_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250OCILKHJPJED() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "eon_id\030\004 \001(\r\022\033\n\023Unk3250_BNEIANJBLBL\030\005 \001(" +
      "\r\022\033\n\023Unk3250_OCILKHJPJED\030\n \001(\r\022\020\n\010host_u" +
    ...
    internal_static_PlayerMatchInfoNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_PlayerMatchInfoNotify_descriptor,
        new java.lang.String[] { "DungeonId", "Unk3250BNEIANJBLBL", "Unk3250OCILKHJPJED", "HostUid", "MatchType", "MechanicusDifficultLevel", "MpPlayId", "MatchId", "MatchParamList", });
    emu.grasscutter.net.proto.MatchTypeOuterClass.getDescriptor();
  }
