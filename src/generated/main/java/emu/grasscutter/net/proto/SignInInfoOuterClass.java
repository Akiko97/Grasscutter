...
public final class SignInInfoOuterClass {
  ...
  public interface SignInInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_MNJELIDKMCF = 5;</code>
     * @return The unk3250MNJELIDKMCF.
     */
    int getUnk3250MNJELIDKMCF();
    ...
    /**
     * <code>uint32 Unk3250_NFNOKBNBLGE = 3;</code>
     * @return The unk3250NFNOKBNBLGE.
     */
    int getUnk3250NFNOKBNBLGE();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 24: {
              ...
              unk3250NFNOKBNBLGE_ = input.readUInt32();
              break;
            }
            case 32: {
            ...
            case 40: {
              ...
              unk3250MNJELIDKMCF_ = input.readUInt32();
              break;
            }
            case 48: {
    ...
    public static final int UNK3250_MNJELIDKMCF_FIELD_NUMBER = 5;
    private int unk3250MNJELIDKMCF_;
    /**
     * <code>uint32 Unk3250_MNJELIDKMCF = 5;</code>
     * @return The unk3250MNJELIDKMCF.
     */
    @java.lang.Override
    public int getUnk3250MNJELIDKMCF() {
      return unk3250MNJELIDKMCF_;
    }
    ...
    public static final int UNK3250_NFNOKBNBLGE_FIELD_NUMBER = 3;
    private int unk3250NFNOKBNBLGE_;
    /**
     * <code>uint32 Unk3250_NFNOKBNBLGE = 3;</code>
     * @return The unk3250NFNOKBNBLGE.
     */
    @java.lang.Override
    public int getUnk3250NFNOKBNBLGE() {
      return unk3250NFNOKBNBLGE_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250NFNOKBNBLGE_ != 0) {
        output.writeUInt32(3, unk3250NFNOKBNBLGE_);
      }
      ...
      if (unk3250MNJELIDKMCF_ != 0) {
        output.writeUInt32(5, unk3250MNJELIDKMCF_);
      }
      if (beginTime_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250NFNOKBNBLGE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, unk3250NFNOKBNBLGE_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < rewardDayList_.size(); i++) {
      ...
      if (unk3250MNJELIDKMCF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(5, unk3250MNJELIDKMCF_);
      }
      if (beginTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250MNJELIDKMCF()
          != other.getUnk3250MNJELIDKMCF()) return false;
      if (getScheduleId()
          != other.getScheduleId()) return false;
      if (getUnk3250NFNOKBNBLGE()
          != other.getUnk3250NFNOKBNBLGE()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_MNJELIDKMCF_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250MNJELIDKMCF();
      hash = (37 * hash) + SCHEDULE_ID_FIELD_NUMBER;
      hash = (53 * hash) + getScheduleId();
      hash = (37 * hash) + UNK3250_NFNOKBNBLGE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250NFNOKBNBLGE();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250MNJELIDKMCF_ = 0;

        scheduleId_ = 0;

        unk3250NFNOKBNBLGE_ = 0;
      ...
      public emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo buildPartial() {
        ...
        result.unk3250MNJELIDKMCF_ = unk3250MNJELIDKMCF_;
        result.scheduleId_ = scheduleId_;
        result.unk3250NFNOKBNBLGE_ = unk3250NFNOKBNBLGE_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SignInInfoOuterClass.SignInInfo other) {
        ...
        if (other.getUnk3250MNJELIDKMCF() != 0) {
          setUnk3250MNJELIDKMCF(other.getUnk3250MNJELIDKMCF());
        }
        if (other.getScheduleId() != 0) {
          setScheduleId(other.getScheduleId());
        }
        if (other.getUnk3250NFNOKBNBLGE() != 0) {
          setUnk3250NFNOKBNBLGE(other.getUnk3250NFNOKBNBLGE());
        }
      ...
      /**
       * <code>uint32 Unk3250_MNJELIDKMCF = 5;</code>
       * @param value The unk3250MNJELIDKMCF to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250MNJELIDKMCF(int value) {
        
        unk3250MNJELIDKMCF_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250MNJELIDKMCF() {
      ...
      /**
       * <code>uint32 Unk3250_NFNOKBNBLGE = 3;</code>
       * @param value The unk3250NFNOKBNBLGE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250NFNOKBNBLGE(int value) {
        
        unk3250NFNOKBNBLGE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250NFNOKBNBLGE() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\023Unk3250_MNJELIDKMCF\030\005 \001(\r\022\023\n\013schedule_i" +
      "d\030\007 \001(\r\022\033\n\023Unk3250_NFNOKBNBLGE\030\003 \001(\r\022\027\n\017" +
    ...
    internal_static_SignInInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SignInInfo_descriptor,
        new java.lang.String[] { "IsCondSatisfied", "SigninDataList", "Unk3250MNJELIDKMCF", "ScheduleId", "Unk3250NFNOKBNBLGE", "RewardDayList", "BeginTime", "ConfigId", "EndTime", });
    emu.grasscutter.net.proto.SignInDataOuterClass.getDescriptor();
  }
