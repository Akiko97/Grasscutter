...
public final class SumoSetNoSwitchPunishTimeNotifyOuterClass {
  ...
  public interface SumoSetNoSwitchPunishTimeNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_CBAMLHDMKJF = 10;</code>
     * @return The unk3250CBAMLHDMKJF.
     */
    int getUnk3250CBAMLHDMKJF();
    ...
    /**
     * <code>uint32 Unk3250_BNJBIGHIJOC = 3;</code>
     * @return The unk3250BNJBIGHIJOC.
     */
    int getUnk3250BNJBIGHIJOC();

    /**
     * <code>uint32 Unk3250_DJBJACGHGDM = 9;</code>
     * @return The unk3250DJBJACGHGDM.
     */
    int getUnk3250DJBJACGHGDM();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 24: {
              ...
              unk3250BNJBIGHIJOC_ = input.readUInt32();
              break;
            }
            case 40: {
            ...
            case 72: {
              ...
              unk3250DJBJACGHGDM_ = input.readUInt32();
              break;
            }
            case 80: {

              unk3250CBAMLHDMKJF_ = input.readUInt32();
              break;
            }
            case 120: {
    ...
    public static final int UNK3250_CBAMLHDMKJF_FIELD_NUMBER = 10;
    private int unk3250CBAMLHDMKJF_;
    /**
     * <code>uint32 Unk3250_CBAMLHDMKJF = 10;</code>
     * @return The unk3250CBAMLHDMKJF.
     */
    @java.lang.Override
    public int getUnk3250CBAMLHDMKJF() {
      return unk3250CBAMLHDMKJF_;
    }
    ...
    public static final int UNK3250_BNJBIGHIJOC_FIELD_NUMBER = 3;
    private int unk3250BNJBIGHIJOC_;
    /**
     * <code>uint32 Unk3250_BNJBIGHIJOC = 3;</code>
     * @return The unk3250BNJBIGHIJOC.
     */
    @java.lang.Override
    public int getUnk3250BNJBIGHIJOC() {
      return unk3250BNJBIGHIJOC_;
    }

    public static final int UNK3250_DJBJACGHGDM_FIELD_NUMBER = 9;
    private int unk3250DJBJACGHGDM_;
    /**
     * <code>uint32 Unk3250_DJBJACGHGDM = 9;</code>
     * @return The unk3250DJBJACGHGDM.
     */
    @java.lang.Override
    public int getUnk3250DJBJACGHGDM() {
      return unk3250DJBJACGHGDM_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250BNJBIGHIJOC_ != 0) {
        output.writeUInt32(3, unk3250BNJBIGHIJOC_);
      }
      if (activityId_ != 0) {
        output.writeUInt32(5, activityId_);
      }
      if (unk3250DJBJACGHGDM_ != 0) {
        output.writeUInt32(9, unk3250DJBJACGHGDM_);
      }
      if (unk3250CBAMLHDMKJF_ != 0) {
        output.writeUInt32(10, unk3250CBAMLHDMKJF_);
      }
      if (stageId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250BNJBIGHIJOC_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, unk3250BNJBIGHIJOC_);
      }
      if (activityId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250DJBJACGHGDM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, unk3250DJBJACGHGDM_);
      }
      if (unk3250CBAMLHDMKJF_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(10, unk3250CBAMLHDMKJF_);
      }
      if (stageId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250CBAMLHDMKJF()
          != other.getUnk3250CBAMLHDMKJF()) return false;
      if (getActivityId()
          != other.getActivityId()) return false;
      if (getUnk3250BNJBIGHIJOC()
          != other.getUnk3250BNJBIGHIJOC()) return false;
      if (getUnk3250DJBJACGHGDM()
          != other.getUnk3250DJBJACGHGDM()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_CBAMLHDMKJF_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250CBAMLHDMKJF();
      hash = (37 * hash) + ACTIVITY_ID_FIELD_NUMBER;
      hash = (53 * hash) + getActivityId();
      hash = (37 * hash) + UNK3250_BNJBIGHIJOC_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250BNJBIGHIJOC();
      hash = (37 * hash) + UNK3250_DJBJACGHGDM_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250DJBJACGHGDM();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250CBAMLHDMKJF_ = 0;

        activityId_ = 0;

        unk3250BNJBIGHIJOC_ = 0;

        unk3250DJBJACGHGDM_ = 0;
      ...
      public emu.grasscutter.net.proto.SumoSetNoSwitchPunishTimeNotifyOuterClass.SumoSetNoSwitchPunishTimeNotify buildPartial() {
        ...
        result.unk3250CBAMLHDMKJF_ = unk3250CBAMLHDMKJF_;
        result.activityId_ = activityId_;
        result.unk3250BNJBIGHIJOC_ = unk3250BNJBIGHIJOC_;
        result.unk3250DJBJACGHGDM_ = unk3250DJBJACGHGDM_;
        if (dungeonTeamListBuilder_ == null) {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SumoSetNoSwitchPunishTimeNotifyOuterClass.SumoSetNoSwitchPunishTimeNotify other) {
        ...
        if (other.getUnk3250CBAMLHDMKJF() != 0) {
          setUnk3250CBAMLHDMKJF(other.getUnk3250CBAMLHDMKJF());
        }
        if (other.getActivityId() != 0) {
          setActivityId(other.getActivityId());
        }
        if (other.getUnk3250BNJBIGHIJOC() != 0) {
          setUnk3250BNJBIGHIJOC(other.getUnk3250BNJBIGHIJOC());
        }
        if (other.getUnk3250DJBJACGHGDM() != 0) {
          setUnk3250DJBJACGHGDM(other.getUnk3250DJBJACGHGDM());
        }
        if (dungeonTeamListBuilder_ == null) {
      ...
      /**
       * <code>uint32 Unk3250_CBAMLHDMKJF = 10;</code>
       * @param value The unk3250CBAMLHDMKJF to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250CBAMLHDMKJF(int value) {
        
        unk3250CBAMLHDMKJF_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250CBAMLHDMKJF() {
      ...
      /**
       * <code>uint32 Unk3250_BNJBIGHIJOC = 3;</code>
       * @param value The unk3250BNJBIGHIJOC to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250BNJBIGHIJOC(int value) {
        
        unk3250BNJBIGHIJOC_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250BNJBIGHIJOC() {
      ...
      /**
       * <code>uint32 Unk3250_DJBJACGHGDM = 9;</code>
       * @param value The unk3250DJBJACGHGDM to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250DJBJACGHGDM(int value) {
        
        unk3250DJBJACGHGDM_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250DJBJACGHGDM() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Unk3250_CBAMLHDMKJF\030\n \001(\r\022\023\n\013activity_id" +
      "\030\005 \001(\r\022\033\n\023Unk3250_BNJBIGHIJOC\030\003 \001(\r\022\033\n\023U" +
      "nk3250_DJBJACGHGDM\030\t \001(\r\022+\n\021dungeon_team" +
    ...
    internal_static_SumoSetNoSwitchPunishTimeNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SumoSetNoSwitchPunishTimeNotify_descriptor,
        new java.lang.String[] { "StageId", "Unk3250CBAMLHDMKJF", "ActivityId", "Unk3250BNJBIGHIJOC", "Unk3250DJBJACGHGDM", "DungeonTeamList", });
    emu.grasscutter.net.proto.SumoDungeonTeamOuterClass.getDescriptor();
  }
