...
public final class MassiveEntityElementOpBatchNotifyOuterClass {
  ...
  public interface MassiveEntityElementOpBatchNotifyOrBuilder extends
    ...
    /**
     * <code>int32 Unk3250_PNANGDNNFCH = 2;</code>
     * @return The unk3250PNANGDNNFCH.
     */
    int getUnk3250PNANGDNNFCH();
    ...
    /**
     * <code>int32 Unk3250_KNLDJPEMCKP = 7;</code>
     * @return The unk3250KNLDJPEMCKP.
     */
    int getUnk3250KNLDJPEMCKP();
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              unk3250PNANGDNNFCH_ = input.readInt32();
              break;
            }
            case 37: {
            ...
            case 56: {
              ...
              unk3250KNLDJPEMCKP_ = input.readInt32();
              break;
            }
            case 64: {
    ...
    public static final int UNK3250_PNANGDNNFCH_FIELD_NUMBER = 2;
    private int unk3250PNANGDNNFCH_;
    /**
     * <code>int32 Unk3250_PNANGDNNFCH = 2;</code>
     * @return The unk3250PNANGDNNFCH.
     */
    @java.lang.Override
    public int getUnk3250PNANGDNNFCH() {
      return unk3250PNANGDNNFCH_;
    }
    ...
    public static final int UNK3250_KNLDJPEMCKP_FIELD_NUMBER = 7;
    private int unk3250KNLDJPEMCKP_;
    /**
     * <code>int32 Unk3250_KNLDJPEMCKP = 7;</code>
     * @return The unk3250KNLDJPEMCKP.
     */
    @java.lang.Override
    public int getUnk3250KNLDJPEMCKP() {
      return unk3250KNLDJPEMCKP_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250PNANGDNNFCH_ != 0) {
        output.writeInt32(2, unk3250PNANGDNNFCH_);
      }
      if (attackElementDurability_ != 0F) {
        output.writeFloat(4, attackElementDurability_);
      }
      if (unk3250KNLDJPEMCKP_ != 0) {
        output.writeInt32(7, unk3250KNLDJPEMCKP_);
      }
      if (attackerId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250PNANGDNNFCH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(2, unk3250PNANGDNNFCH_);
      }
      if (attackElementDurability_ != 0F) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250KNLDJPEMCKP_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeInt32Size(7, unk3250KNLDJPEMCKP_);
      }
      if (attackerId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250PNANGDNNFCH()
          != other.getUnk3250PNANGDNNFCH()) return false;
      if (getEntityType()
          != other.getEntityType()) return false;
      if (getUnk3250KNLDJPEMCKP()
          != other.getUnk3250KNLDJPEMCKP()) return false;
      if (getOpIdx()
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_PNANGDNNFCH_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PNANGDNNFCH();
      hash = (37 * hash) + ENTITY_TYPE_FIELD_NUMBER;
      hash = (53 * hash) + getEntityType();
      hash = (37 * hash) + UNK3250_KNLDJPEMCKP_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250KNLDJPEMCKP();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250PNANGDNNFCH_ = 0;

        entityType_ = 0;

        unk3250KNLDJPEMCKP_ = 0;
      ...
      public emu.grasscutter.net.proto.MassiveEntityElementOpBatchNotifyOuterClass.MassiveEntityElementOpBatchNotify buildPartial() {
        ...
        result.unk3250PNANGDNNFCH_ = unk3250PNANGDNNFCH_;
        result.entityType_ = entityType_;
        result.unk3250KNLDJPEMCKP_ = unk3250KNLDJPEMCKP_;
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.MassiveEntityElementOpBatchNotifyOuterClass.MassiveEntityElementOpBatchNotify other) {
        ...
        if (other.getUnk3250PNANGDNNFCH() != 0) {
          setUnk3250PNANGDNNFCH(other.getUnk3250PNANGDNNFCH());
        }
        if (other.getEntityType() != 0) {
          setEntityType(other.getEntityType());
        }
        if (other.getUnk3250KNLDJPEMCKP() != 0) {
          setUnk3250KNLDJPEMCKP(other.getUnk3250KNLDJPEMCKP());
        }
        if (other.getOpIdx() != 0) {
      ...
      /**
       * <code>int32 Unk3250_PNANGDNNFCH = 2;</code>
       * @param value The unk3250PNANGDNNFCH to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PNANGDNNFCH(int value) {
        
        unk3250PNANGDNNFCH_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PNANGDNNFCH() {
      ...
      /**
       * <code>int32 Unk3250_KNLDJPEMCKP = 7;</code>
       * @param value The unk3250KNLDJPEMCKP to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250KNLDJPEMCKP(int value) {
        
        unk3250KNLDJPEMCKP_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250KNLDJPEMCKP() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lity\030\004 \001(\002\022\033\n\023Unk3250_PNANGDNNFCH\030\002 \001(\005\022" +
      "\023\n\013entity_type\030\n \001(\005\022\033\n\023Unk3250_KNLDJPEM" +
    ...
    internal_static_MassiveEntityElementOpBatchNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_MassiveEntityElementOpBatchNotify_descriptor,
        new java.lang.String[] { "AttackerId", "AttackElementDurability", "Unk3250PNANGDNNFCH", "EntityType", "Unk3250KNLDJPEMCKP", "OpIdx", "UserId", "ShapeSphere", "ShapeBox", "CheckShape", });
    emu.grasscutter.net.proto.ShapeBoxOuterClass.getDescriptor();
    emu.grasscutter.net.proto.ShapeSphereOuterClass.getDescriptor();
  }
