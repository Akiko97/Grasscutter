...
public final class ProudSkillExtraLevelNotifyOuterClass {
  ...
  public interface ProudSkillExtraLevelNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_ODIOPLHJHAE = 4;</code>
     * @return The unk3250ODIOPLHJHAE.
     */
    int getUnk3250ODIOPLHJHAE();

    /**
     * <code>uint32 Unk3250_LKNFMODMEIA = 8;</code>
     * @return The unk3250LKNFMODMEIA.
     */
    int getUnk3250LKNFMODMEIA();

    /**
     * <code>uint32 Unk3250_IPDBADAAHBA = 2;</code>
     * @return The unk3250IPDBADAAHBA.
     */
    int getUnk3250IPDBADAAHBA();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16: {
              ...
              unk3250IPDBADAAHBA_ = input.readUInt32();
              break;
            }
            case 32: {

              unk3250ODIOPLHJHAE_ = input.readUInt32();
              break;
            }
            case 64: {

              unk3250LKNFMODMEIA_ = input.readUInt32();
              break;
            }
            case 104: {
    ...
    public static final int UNK3250_ODIOPLHJHAE_FIELD_NUMBER = 4;
    private int unk3250ODIOPLHJHAE_;
    /**
     * <code>uint32 Unk3250_ODIOPLHJHAE = 4;</code>
     * @return The unk3250ODIOPLHJHAE.
     */
    @java.lang.Override
    public int getUnk3250ODIOPLHJHAE() {
      return unk3250ODIOPLHJHAE_;
    }

    public static final int UNK3250_LKNFMODMEIA_FIELD_NUMBER = 8;
    private int unk3250LKNFMODMEIA_;
    /**
     * <code>uint32 Unk3250_LKNFMODMEIA = 8;</code>
     * @return The unk3250LKNFMODMEIA.
     */
    @java.lang.Override
    public int getUnk3250LKNFMODMEIA() {
      return unk3250LKNFMODMEIA_;
    }

    public static final int UNK3250_IPDBADAAHBA_FIELD_NUMBER = 2;
    private int unk3250IPDBADAAHBA_;
    /**
     * <code>uint32 Unk3250_IPDBADAAHBA = 2;</code>
     * @return The unk3250IPDBADAAHBA.
     */
    @java.lang.Override
    public int getUnk3250IPDBADAAHBA() {
      return unk3250IPDBADAAHBA_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250IPDBADAAHBA_ != 0) {
        output.writeUInt32(2, unk3250IPDBADAAHBA_);
      }
      if (unk3250ODIOPLHJHAE_ != 0) {
        output.writeUInt32(4, unk3250ODIOPLHJHAE_);
      }
      if (unk3250LKNFMODMEIA_ != 0) {
        output.writeUInt32(8, unk3250LKNFMODMEIA_);
      }
      if (avatarGuid_ != 0L) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250IPDBADAAHBA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(2, unk3250IPDBADAAHBA_);
      }
      if (unk3250ODIOPLHJHAE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, unk3250ODIOPLHJHAE_);
      }
      if (unk3250LKNFMODMEIA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, unk3250LKNFMODMEIA_);
      }
      if (avatarGuid_ != 0L) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250ODIOPLHJHAE()
          != other.getUnk3250ODIOPLHJHAE()) return false;
      if (getUnk3250LKNFMODMEIA()
          != other.getUnk3250LKNFMODMEIA()) return false;
      if (getUnk3250IPDBADAAHBA()
          != other.getUnk3250IPDBADAAHBA()) return false;
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
          getAvatarGuid());
      hash = (37 * hash) + UNK3250_ODIOPLHJHAE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250ODIOPLHJHAE();
      hash = (37 * hash) + UNK3250_LKNFMODMEIA_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LKNFMODMEIA();
      hash = (37 * hash) + UNK3250_IPDBADAAHBA_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250IPDBADAAHBA();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250ODIOPLHJHAE_ = 0;

        unk3250LKNFMODMEIA_ = 0;

        unk3250IPDBADAAHBA_ = 0;
      ...
      public emu.grasscutter.net.proto.ProudSkillExtraLevelNotifyOuterClass.ProudSkillExtraLevelNotify buildPartial() {
        ...
        result.unk3250ODIOPLHJHAE_ = unk3250ODIOPLHJHAE_;
        result.unk3250LKNFMODMEIA_ = unk3250LKNFMODMEIA_;
        result.unk3250IPDBADAAHBA_ = unk3250IPDBADAAHBA_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ProudSkillExtraLevelNotifyOuterClass.ProudSkillExtraLevelNotify other) {
        ...
        if (other.getUnk3250ODIOPLHJHAE() != 0) {
          setUnk3250ODIOPLHJHAE(other.getUnk3250ODIOPLHJHAE());
        }
        if (other.getUnk3250LKNFMODMEIA() != 0) {
          setUnk3250LKNFMODMEIA(other.getUnk3250LKNFMODMEIA());
        }
        if (other.getUnk3250IPDBADAAHBA() != 0) {
          setUnk3250IPDBADAAHBA(other.getUnk3250IPDBADAAHBA());
        }
      ...
      /**
       * <code>uint32 Unk3250_ODIOPLHJHAE = 4;</code>
       * @param value The unk3250ODIOPLHJHAE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250ODIOPLHJHAE(int value) {
        
        unk3250ODIOPLHJHAE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250ODIOPLHJHAE() {
      ...
      /**
       * <code>uint32 Unk3250_LKNFMODMEIA = 8;</code>
       * @param value The unk3250LKNFMODMEIA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LKNFMODMEIA(int value) {
        
        unk3250LKNFMODMEIA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LKNFMODMEIA() {
      ...
      /**
       * <code>uint32 Unk3250_IPDBADAAHBA = 2;</code>
       * @param value The unk3250IPDBADAAHBA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250IPDBADAAHBA(int value) {
        
        unk3250IPDBADAAHBA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250IPDBADAAHBA() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\r \001(\004\022\033\n\023Unk3250_ODIOPLHJHAE\030\004 \001(\r\022\033\n\023U" +
      "nk3250_LKNFMODMEIA\030\010 \001(\r\022\033\n\023Unk3250_IPDB" +
    ...
    internal_static_ProudSkillExtraLevelNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ProudSkillExtraLevelNotify_descriptor,
        new java.lang.String[] { "AvatarGuid", "Unk3250ODIOPLHJHAE", "Unk3250LKNFMODMEIA", "Unk3250IPDBADAAHBA", });
  }
