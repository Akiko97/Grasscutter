...
public final class SceneGalleryHomeSeekFurnitureInfoOuterClass {
  ...
  public interface SceneGalleryHomeSeekFurnitureInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_DAEEBIEAOMN = 3;</code>
     * @return The unk3250DAEEBIEAOMN.
     */
    int getUnk3250DAEEBIEAOMN();

    /**
     * <code>uint32 Unk3250_ENKOGPIEHFD = 14;</code>
     * @return The unk3250ENKOGPIEHFD.
     */
    int getUnk3250ENKOGPIEHFD();
    ...
    /**
     * <code>uint32 Unk3250_LGEAPLJCJFH = 12;</code>
     * @return The unk3250LGEAPLJCJFH.
     */
    int getUnk3250LGEAPLJCJFH();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 24: {
              ...
              unk3250DAEEBIEAOMN_ = input.readUInt32();
              break;
            }
            case 82: {
            ...
            case 96: {
              ...
              unk3250LGEAPLJCJFH_ = input.readUInt32();
              break;
            }
            case 112: {

              unk3250ENKOGPIEHFD_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_DAEEBIEAOMN_FIELD_NUMBER = 3;
    private int unk3250DAEEBIEAOMN_;
    /**
     * <code>uint32 Unk3250_DAEEBIEAOMN = 3;</code>
     * @return The unk3250DAEEBIEAOMN.
     */
    @java.lang.Override
    public int getUnk3250DAEEBIEAOMN() {
      return unk3250DAEEBIEAOMN_;
    }

    public static final int UNK3250_ENKOGPIEHFD_FIELD_NUMBER = 14;
    private int unk3250ENKOGPIEHFD_;
    /**
     * <code>uint32 Unk3250_ENKOGPIEHFD = 14;</code>
     * @return The unk3250ENKOGPIEHFD.
     */
    @java.lang.Override
    public int getUnk3250ENKOGPIEHFD() {
      return unk3250ENKOGPIEHFD_;
    }
    ...
    public static final int UNK3250_LGEAPLJCJFH_FIELD_NUMBER = 12;
    private int unk3250LGEAPLJCJFH_;
    /**
     * <code>uint32 Unk3250_LGEAPLJCJFH = 12;</code>
     * @return The unk3250LGEAPLJCJFH.
     */
    @java.lang.Override
    public int getUnk3250LGEAPLJCJFH() {
      return unk3250LGEAPLJCJFH_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250DAEEBIEAOMN_ != 0) {
        output.writeUInt32(3, unk3250DAEEBIEAOMN_);
      }
      com.google.protobuf.GeneratedMessageV3
        .serializeIntegerMapTo(
          ...
          PlayerScoreMapDefaultEntryHolder.defaultEntry,
          10);
      if (unk3250LGEAPLJCJFH_ != 0) {
        output.writeUInt32(12, unk3250LGEAPLJCJFH_);
      }
      if (unk3250ENKOGPIEHFD_ != 0) {
        output.writeUInt32(14, unk3250ENKOGPIEHFD_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250DAEEBIEAOMN_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(3, unk3250DAEEBIEAOMN_);
      }
      ...
      if (unk3250LGEAPLJCJFH_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(12, unk3250LGEAPLJCJFH_);
      }
      if (unk3250ENKOGPIEHFD_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, unk3250ENKOGPIEHFD_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250DAEEBIEAOMN()
          != other.getUnk3250DAEEBIEAOMN()) return false;
      if (getUnk3250ENKOGPIEHFD()
          != other.getUnk3250ENKOGPIEHFD()) return false;
      if (!internalGetPlayerScoreMap().equals(
          other.internalGetPlayerScoreMap())) return false;
      if (getUnk3250LGEAPLJCJFH()
          != other.getUnk3250LGEAPLJCJFH()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_DAEEBIEAOMN_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250DAEEBIEAOMN();
      hash = (37 * hash) + UNK3250_ENKOGPIEHFD_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250ENKOGPIEHFD();
      ...
      hash = (37 * hash) + UNK3250_LGEAPLJCJFH_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250LGEAPLJCJFH();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250DAEEBIEAOMN_ = 0;

        unk3250ENKOGPIEHFD_ = 0;

        internalGetMutablePlayerScoreMap().clear();
        unk3250LGEAPLJCJFH_ = 0;
      ...
      public emu.grasscutter.net.proto.SceneGalleryHomeSeekFurnitureInfoOuterClass.SceneGalleryHomeSeekFurnitureInfo buildPartial() {
        ...
        result.unk3250DAEEBIEAOMN_ = unk3250DAEEBIEAOMN_;
        result.unk3250ENKOGPIEHFD_ = unk3250ENKOGPIEHFD_;
        result.playerScoreMap_ = internalGetPlayerScoreMap();
        result.playerScoreMap_.makeImmutable();
        result.unk3250LGEAPLJCJFH_ = unk3250LGEAPLJCJFH_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.SceneGalleryHomeSeekFurnitureInfoOuterClass.SceneGalleryHomeSeekFurnitureInfo other) {
        ...
        if (other.getUnk3250DAEEBIEAOMN() != 0) {
          setUnk3250DAEEBIEAOMN(other.getUnk3250DAEEBIEAOMN());
        }
        if (other.getUnk3250ENKOGPIEHFD() != 0) {
          setUnk3250ENKOGPIEHFD(other.getUnk3250ENKOGPIEHFD());
        }
        internalGetMutablePlayerScoreMap().mergeFrom(
            other.internalGetPlayerScoreMap());
        if (other.getUnk3250LGEAPLJCJFH() != 0) {
          setUnk3250LGEAPLJCJFH(other.getUnk3250LGEAPLJCJFH());
        }
      ...
      /**
       * <code>uint32 Unk3250_DAEEBIEAOMN = 3;</code>
       * @param value The unk3250DAEEBIEAOMN to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250DAEEBIEAOMN(int value) {
        
        unk3250DAEEBIEAOMN_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250DAEEBIEAOMN() {
      ...
      /**
       * <code>uint32 Unk3250_ENKOGPIEHFD = 14;</code>
       * @param value The unk3250ENKOGPIEHFD to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250ENKOGPIEHFD(int value) {
        
        unk3250ENKOGPIEHFD_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250ENKOGPIEHFD() {
      ...
      /**
       * <code>uint32 Unk3250_LGEAPLJCJFH = 12;</code>
       * @param value The unk3250LGEAPLJCJFH to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250LGEAPLJCJFH(int value) {
        
        unk3250LGEAPLJCJFH_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250LGEAPLJCJFH() {
  ...
  static {
    ...
    internal_static_SceneGalleryHomeSeekFurnitureInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_SceneGalleryHomeSeekFurnitureInfo_descriptor,
        new java.lang.String[] { "Unk3250DAEEBIEAOMN", "Unk3250ENKOGPIEHFD", "PlayerScoreMap", "Unk3250LGEAPLJCJFH", });
    internal_static_SceneGalleryHomeSeekFurnitureInfo_PlayerScoreMapEntry_descriptor =
