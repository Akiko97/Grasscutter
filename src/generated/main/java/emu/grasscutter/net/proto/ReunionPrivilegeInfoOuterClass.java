...
public final class ReunionPrivilegeInfoOuterClass {
  ...
  public interface ReunionPrivilegeInfoOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_GJBEAFPMFAA = 14;</code>
     * @return The unk3250GJBEAFPMFAA.
     */
    int getUnk3250GJBEAFPMFAA();
    ...
    /**
     * <code>uint32 Unk3250_ALOLACFGMHI = 1;</code>
     * @return The unk3250ALOLACFGMHI.
     */
    int getUnk3250ALOLACFGMHI();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 8: {
              ...
              unk3250ALOLACFGMHI_ = input.readUInt32();
              break;
            }
            case 16: {
            ...
            case 112: {
              ...
              unk3250GJBEAFPMFAA_ = input.readUInt32();
              break;
            }
            default: {
    ...
    public static final int UNK3250_GJBEAFPMFAA_FIELD_NUMBER = 14;
    private int unk3250GJBEAFPMFAA_;
    /**
     * <code>uint32 Unk3250_GJBEAFPMFAA = 14;</code>
     * @return The unk3250GJBEAFPMFAA.
     */
    @java.lang.Override
    public int getUnk3250GJBEAFPMFAA() {
      return unk3250GJBEAFPMFAA_;
    }
    ...
    public static final int UNK3250_ALOLACFGMHI_FIELD_NUMBER = 1;
    private int unk3250ALOLACFGMHI_;
    /**
     * <code>uint32 Unk3250_ALOLACFGMHI = 1;</code>
     * @return The unk3250ALOLACFGMHI.
     */
    @java.lang.Override
    public int getUnk3250ALOLACFGMHI() {
      return unk3250ALOLACFGMHI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250ALOLACFGMHI_ != 0) {
        output.writeUInt32(1, unk3250ALOLACFGMHI_);
      }
      if (privilegeId_ != 0) {
        output.writeUInt32(2, privilegeId_);
      }
      if (unk3250GJBEAFPMFAA_ != 0) {
        output.writeUInt32(14, unk3250GJBEAFPMFAA_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (unk3250ALOLACFGMHI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(1, unk3250ALOLACFGMHI_);
      }
      if (privilegeId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250GJBEAFPMFAA_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(14, unk3250GJBEAFPMFAA_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250GJBEAFPMFAA()
          != other.getUnk3250GJBEAFPMFAA()) return false;
      if (getPrivilegeId()
          != other.getPrivilegeId()) return false;
      if (getUnk3250ALOLACFGMHI()
          != other.getUnk3250ALOLACFGMHI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_GJBEAFPMFAA_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250GJBEAFPMFAA();
      hash = (37 * hash) + PRIVILEGE_ID_FIELD_NUMBER;
      hash = (53 * hash) + getPrivilegeId();
      hash = (37 * hash) + UNK3250_ALOLACFGMHI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250ALOLACFGMHI();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        super.clear();
        unk3250GJBEAFPMFAA_ = 0;

        privilegeId_ = 0;

        unk3250ALOLACFGMHI_ = 0;
      ...
      public emu.grasscutter.net.proto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo buildPartial() {
        ...
        result.unk3250GJBEAFPMFAA_ = unk3250GJBEAFPMFAA_;
        result.privilegeId_ = privilegeId_;
        result.unk3250ALOLACFGMHI_ = unk3250ALOLACFGMHI_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo other) {
        ...
        if (other.getUnk3250GJBEAFPMFAA() != 0) {
          setUnk3250GJBEAFPMFAA(other.getUnk3250GJBEAFPMFAA());
        }
        if (other.getPrivilegeId() != 0) {
          setPrivilegeId(other.getPrivilegeId());
        }
        if (other.getUnk3250ALOLACFGMHI() != 0) {
          setUnk3250ALOLACFGMHI(other.getUnk3250ALOLACFGMHI());
        }
      ...
      /**
       * <code>uint32 Unk3250_GJBEAFPMFAA = 14;</code>
       * @param value The unk3250GJBEAFPMFAA to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250GJBEAFPMFAA(int value) {
        
        unk3250GJBEAFPMFAA_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250GJBEAFPMFAA() {
      ...
      /**
       * <code>uint32 Unk3250_ALOLACFGMHI = 1;</code>
       * @param value The unk3250ALOLACFGMHI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250ALOLACFGMHI(int value) {
        
        unk3250ALOLACFGMHI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250ALOLACFGMHI() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rivilegeInfo\022\033\n\023Unk3250_GJBEAFPMFAA\030\016 \001(" +
    ...
    internal_static_ReunionPrivilegeInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ReunionPrivilegeInfo_descriptor,
        new java.lang.String[] { "Unk3250GJBEAFPMFAA", "PrivilegeId", "Unk3250ALOLACFGMHI", });
  }
