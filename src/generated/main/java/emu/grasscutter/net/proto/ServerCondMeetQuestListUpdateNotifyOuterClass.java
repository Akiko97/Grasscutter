...
public final class ServerCondMeetQuestListUpdateNotifyOuterClass {
  ...
  public interface ServerCondMeetQuestListUpdateNotifyOrBuilder extends
    ...
    /**
     * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
     * @return A list containing the unk3250MGBDKFMBGBO.
     */
    java.util.List<java.lang.Integer> getUnk3250MGBDKFMBGBOList();
    /**
     * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
     * @return The count of unk3250MGBDKFMBGBO.
     */
    int getUnk3250MGBDKFMBGBOCount();
    /**
     * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
     * @param index The index of the element to return.
     * @return The unk3250MGBDKFMBGBO at the given index.
     */
    int getUnk3250MGBDKFMBGBO(int index);

    /**
     * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
     * @return A list containing the unk3250HIEMKEJOFPO.
     */
    java.util.List<java.lang.Integer> getUnk3250HIEMKEJOFPOList();
    /**
     * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
     * @return The count of unk3250HIEMKEJOFPO.
     */
    int getUnk3250HIEMKEJOFPOCount();
    /**
     * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
     * @param index The index of the element to return.
     * @return The unk3250HIEMKEJOFPO at the given index.
     */
    int getUnk3250HIEMKEJOFPO(int index);
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    private ServerCondMeetQuestListUpdateNotify() {
      unk3250MGBDKFMBGBO_ = emptyIntList();
      unk3250HIEMKEJOFPO_ = emptyIntList();
    }
    ...
    private ServerCondMeetQuestListUpdateNotify(
      ...
      try {
          ...
          switch (tag) {
            ...
            case 32: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                unk3250HIEMKEJOFPO_ = newIntList();
                mutable_bitField0_ |= 0x00000002;
              }
              unk3250HIEMKEJOFPO_.addInt(input.readUInt32());
              break;
            }
            case 34: {
            ...
            case 80: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                unk3250MGBDKFMBGBO_ = newIntList();
                mutable_bitField0_ |= 0x00000001;
              }
              unk3250MGBDKFMBGBO_.addInt(input.readUInt32());
              break;
            }
            case 82: {
              int length = input.readRawVarint32();
        ...
        if (((mutable_bitField0_ & 0x00000002) != 0)) {
          unk3250HIEMKEJOFPO_.makeImmutable(); // C
        }
        if (((mutable_bitField0_ & 0x00000001) != 0)) {
          unk3250MGBDKFMBGBO_.makeImmutable(); // C
        }
    ...
    public static final int UNK3250_MGBDKFMBGBO_FIELD_NUMBER = 10;
    private com.google.protobuf.Internal.IntList unk3250MGBDKFMBGBO_;
    /**
     * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
     * @return A list containing the unk3250MGBDKFMBGBO.
     */
    ...
    public java.util.List<java.lang.Integer>
        getUnk3250MGBDKFMBGBOList() {
      return unk3250MGBDKFMBGBO_;
    }
    /**
     * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
     * @return The count of unk3250MGBDKFMBGBO.
     */
    public int getUnk3250MGBDKFMBGBOCount() {
      return unk3250MGBDKFMBGBO_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
     * @param index The index of the element to return.
     * @return The unk3250MGBDKFMBGBO at the given index.
     */
    public int getUnk3250MGBDKFMBGBO(int index) {
      return unk3250MGBDKFMBGBO_.getInt(index);
    }
    private int unk3250MGBDKFMBGBOMemoizedSerializedSize = -1;

    public static final int UNK3250_HIEMKEJOFPO_FIELD_NUMBER = 4;
    private com.google.protobuf.Internal.IntList unk3250HIEMKEJOFPO_;
    /**
     * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
     * @return A list containing the unk3250HIEMKEJOFPO.
     */
    @java.lang.Override
    public java.util.List<java.lang.Integer>
        getUnk3250HIEMKEJOFPOList() {
      return unk3250HIEMKEJOFPO_;
    }
    /**
     * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
     * @return The count of unk3250HIEMKEJOFPO.
     */
    public int getUnk3250HIEMKEJOFPOCount() {
      return unk3250HIEMKEJOFPO_.size();
    }
    /**
     * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
     * @param index The index of the element to return.
     * @return The unk3250HIEMKEJOFPO at the given index.
     */
    public int getUnk3250HIEMKEJOFPO(int index) {
      return unk3250HIEMKEJOFPO_.getInt(index);
    }
    private int unk3250HIEMKEJOFPOMemoizedSerializedSize = -1;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (getUnk3250HIEMKEJOFPOList().size() > 0) {
        output.writeUInt32NoTag(34);
        output.writeUInt32NoTag(unk3250HIEMKEJOFPOMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250HIEMKEJOFPO_.size(); i++) {
        output.writeUInt32NoTag(unk3250HIEMKEJOFPO_.getInt(i));
      }
      if (getUnk3250MGBDKFMBGBOList().size() > 0) {
        output.writeUInt32NoTag(82);
        output.writeUInt32NoTag(unk3250MGBDKFMBGBOMemoizedSerializedSize);
      }
      for (int i = 0; i < unk3250MGBDKFMBGBO_.size(); i++) {
        output.writeUInt32NoTag(unk3250MGBDKFMBGBO_.getInt(i));
      }
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < unk3250HIEMKEJOFPO_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250HIEMKEJOFPO_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250HIEMKEJOFPOList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250HIEMKEJOFPOMemoizedSerializedSize = dataSize;
      }
      {
        int dataSize = 0;
        for (int i = 0; i < unk3250MGBDKFMBGBO_.size(); i++) {
          dataSize += com.google.protobuf.CodedOutputStream
            .computeUInt32SizeNoTag(unk3250MGBDKFMBGBO_.getInt(i));
        }
        size += dataSize;
        if (!getUnk3250MGBDKFMBGBOList().isEmpty()) {
          size += 1;
          size += com.google.protobuf.CodedOutputStream
              .computeInt32SizeNoTag(dataSize);
        }
        unk3250MGBDKFMBGBOMemoizedSerializedSize = dataSize;
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getUnk3250MGBDKFMBGBOList()
          .equals(other.getUnk3250MGBDKFMBGBOList())) return false;
      if (!getUnk3250HIEMKEJOFPOList()
          .equals(other.getUnk3250HIEMKEJOFPOList())) return false;
    ...
    public int hashCode() {
      ...
      if (getUnk3250MGBDKFMBGBOCount() > 0) {
        hash = (37 * hash) + UNK3250_MGBDKFMBGBO_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250MGBDKFMBGBOList().hashCode();
      }
      if (getUnk3250HIEMKEJOFPOCount() > 0) {
        hash = (37 * hash) + UNK3250_HIEMKEJOFPO_FIELD_NUMBER;
        hash = (53 * hash) + getUnk3250HIEMKEJOFPOList().hashCode();
      }
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.ServerCondMeetQuestListUpdateNotifyOuterClass.ServerCondMeetQuestListUpdateNotify buildPartial() {
        ...
        if (((bitField0_ & 0x00000001) != 0)) {
          unk3250MGBDKFMBGBO_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000001);
        }
        result.unk3250MGBDKFMBGBO_ = unk3250MGBDKFMBGBO_;
        if (((bitField0_ & 0x00000002) != 0)) {
          unk3250HIEMKEJOFPO_.makeImmutable();
          bitField0_ = (bitField0_ & ~0x00000002);
        }
        result.unk3250HIEMKEJOFPO_ = unk3250HIEMKEJOFPO_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.ServerCondMeetQuestListUpdateNotifyOuterClass.ServerCondMeetQuestListUpdateNotify other) {
        ...
        if (!other.unk3250MGBDKFMBGBO_.isEmpty()) {
          if (unk3250MGBDKFMBGBO_.isEmpty()) {
            unk3250MGBDKFMBGBO_ = other.unk3250MGBDKFMBGBO_;
            bitField0_ = (bitField0_ & ~0x00000001);
          } else {
            ensureUnk3250MGBDKFMBGBOIsMutable();
            unk3250MGBDKFMBGBO_.addAll(other.unk3250MGBDKFMBGBO_);
          }
          onChanged();
        }
        if (!other.unk3250HIEMKEJOFPO_.isEmpty()) {
          if (unk3250HIEMKEJOFPO_.isEmpty()) {
            unk3250HIEMKEJOFPO_ = other.unk3250HIEMKEJOFPO_;
            bitField0_ = (bitField0_ & ~0x00000002);
          } else {
            ensureUnk3250HIEMKEJOFPOIsMutable();
            unk3250HIEMKEJOFPO_.addAll(other.unk3250HIEMKEJOFPO_);
          }
          onChanged();
        }
      ...
      private com.google.protobuf.Internal.IntList unk3250MGBDKFMBGBO_ = emptyIntList();
      private void ensureUnk3250MGBDKFMBGBOIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          unk3250MGBDKFMBGBO_ = mutableCopy(unk3250MGBDKFMBGBO_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000001) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250MGBDKFMBGBO_) : unk3250MGBDKFMBGBO_;
      }
      /**
       * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
       * @return The count of unk3250MGBDKFMBGBO.
       ...
       * @param value The unk3250MGBDKFMBGBO to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250MGBDKFMBGBO(
          int index, int value) {
        ensureUnk3250MGBDKFMBGBOIsMutable();
        unk3250MGBDKFMBGBO_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
       * @param value The unk3250MGBDKFMBGBO to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250MGBDKFMBGBO(int value) {
        ensureUnk3250MGBDKFMBGBOIsMutable();
        unk3250MGBDKFMBGBO_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_MGBDKFMBGBO = 10;</code>
       * @param values The unk3250MGBDKFMBGBO to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250MGBDKFMBGBO(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250MGBDKFMBGBOIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250MGBDKFMBGBO_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250MGBDKFMBGBO() {
        unk3250MGBDKFMBGBO_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000001);
        onChanged();
        return this;
      ...
      private com.google.protobuf.Internal.IntList unk3250HIEMKEJOFPO_ = emptyIntList();
      private void ensureUnk3250HIEMKEJOFPOIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          unk3250HIEMKEJOFPO_ = mutableCopy(unk3250HIEMKEJOFPO_);
      ...
      public java.util.List<java.lang.Integer>
        ...
        return ((bitField0_ & 0x00000002) != 0) ?
                 java.util.Collections.unmodifiableList(unk3250HIEMKEJOFPO_) : unk3250HIEMKEJOFPO_;
      }
      /**
       * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
       * @return The count of unk3250HIEMKEJOFPO.
       ...
       * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
       * @param index The index to set the value at.
       * @param value The unk3250HIEMKEJOFPO to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250HIEMKEJOFPO(
          int index, int value) {
        ensureUnk3250HIEMKEJOFPOIsMutable();
        unk3250HIEMKEJOFPO_.setInt(index, value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
       * @param value The unk3250HIEMKEJOFPO to add.
       * @return This builder for chaining.
       */
      public Builder addUnk3250HIEMKEJOFPO(int value) {
        ensureUnk3250HIEMKEJOFPOIsMutable();
        unk3250HIEMKEJOFPO_.addInt(value);
        onChanged();
        return this;
      }
      /**
       * <code>repeated uint32 Unk3250_HIEMKEJOFPO = 4;</code>
       * @param values The unk3250HIEMKEJOFPO to add.
       * @return This builder for chaining.
       */
      public Builder addAllUnk3250HIEMKEJOFPO(
          java.lang.Iterable<? extends java.lang.Integer> values) {
        ensureUnk3250HIEMKEJOFPOIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, unk3250HIEMKEJOFPO_);
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250HIEMKEJOFPO() {
        unk3250HIEMKEJOFPO_ = emptyIntList();
        bitField0_ = (bitField0_ & ~0x00000002);
        onChanged();
        return this;
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fy\022\033\n\023Unk3250_MGBDKFMBGBO\030\n \003(\r\022\033\n\023Unk32" +
      "50_HIEMKEJOFPO\030\004 \003(\rB\033\n\031emu.grasscutter." +
    ...
    internal_static_ServerCondMeetQuestListUpdateNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_ServerCondMeetQuestListUpdateNotify_descriptor,
        new java.lang.String[] { "Unk3250MGBDKFMBGBO", "Unk3250HIEMKEJOFPO", });
  }
