...
public final class FlightActivitySettleNotifyOuterClass {
  ...
  public interface FlightActivitySettleNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 Unk3250_MEEKFJJIOKE = 9;</code>
     * @return The unk3250MEEKFJJIOKE.
     */
    int getUnk3250MEEKFJJIOKE();
    ...
    /**
     * <code>uint32 Unk3250_PLFMJPNPPLI = 11;</code>
     * @return The unk3250PLFMJPNPPLI.
     */
    int getUnk3250PLFMJPNPPLI();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 72: {
              ...
              unk3250MEEKFJJIOKE_ = input.readUInt32();
              break;
            }
            case 80: {
            ...
            case 88: {
              ...
              unk3250PLFMJPNPPLI_ = input.readUInt32();
              break;
            }
            case 104: {
    ...
    public static final int UNK3250_MEEKFJJIOKE_FIELD_NUMBER = 9;
    private int unk3250MEEKFJJIOKE_;
    /**
     * <code>uint32 Unk3250_MEEKFJJIOKE = 9;</code>
     * @return The unk3250MEEKFJJIOKE.
     */
    @java.lang.Override
    public int getUnk3250MEEKFJJIOKE() {
      return unk3250MEEKFJJIOKE_;
    }
    ...
    public static final int UNK3250_PLFMJPNPPLI_FIELD_NUMBER = 11;
    private int unk3250PLFMJPNPPLI_;
    /**
     * <code>uint32 Unk3250_PLFMJPNPPLI = 11;</code>
     * @return The unk3250PLFMJPNPPLI.
     */
    @java.lang.Override
    public int getUnk3250PLFMJPNPPLI() {
      return unk3250PLFMJPNPPLI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unk3250MEEKFJJIOKE_ != 0) {
        output.writeUInt32(9, unk3250MEEKFJJIOKE_);
      }
      if (leftTime_ != 0) {
        output.writeUInt32(10, leftTime_);
      }
      if (unk3250PLFMJPNPPLI_ != 0) {
        output.writeUInt32(11, unk3250PLFMJPNPPLI_);
      }
      if (groupId_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (unk3250MEEKFJJIOKE_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(9, unk3250MEEKFJJIOKE_);
      }
      if (leftTime_ != 0) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (unk3250PLFMJPNPPLI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, unk3250PLFMJPNPPLI_);
      }
      if (groupId_ != 0) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getUnk3250MEEKFJJIOKE()
          != other.getUnk3250MEEKFJJIOKE()) return false;
      if (getIsNewRecord()
          != other.getIsNewRecord()) return false;
      if (getIsSuccess()
          != other.getIsSuccess()) return false;
      if (getUnk3250PLFMJPNPPLI()
          != other.getUnk3250PLFMJPNPPLI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + UNK3250_MEEKFJJIOKE_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250MEEKFJJIOKE();
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(
          getIsSuccess());
      hash = (37 * hash) + UNK3250_PLFMJPNPPLI_FIELD_NUMBER;
      hash = (53 * hash) + getUnk3250PLFMJPNPPLI();
    ...
    public static final class Builder extends
      ...
      public Builder clear() {
        ...
        unk3250MEEKFJJIOKE_ = 0;

        isNewRecord_ = false;

        isSuccess_ = false;

        unk3250PLFMJPNPPLI_ = 0;
      ...
      public emu.grasscutter.net.proto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify buildPartial() {
        ...
        result.unk3250MEEKFJJIOKE_ = unk3250MEEKFJJIOKE_;
        result.isNewRecord_ = isNewRecord_;
        result.isSuccess_ = isSuccess_;
        result.unk3250PLFMJPNPPLI_ = unk3250PLFMJPNPPLI_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify other) {
        ...
        if (other.getUnk3250MEEKFJJIOKE() != 0) {
          setUnk3250MEEKFJJIOKE(other.getUnk3250MEEKFJJIOKE());
        }
        ...
        if (other.getUnk3250PLFMJPNPPLI() != 0) {
          setUnk3250PLFMJPNPPLI(other.getUnk3250PLFMJPNPPLI());
        }
      ...
      /**
       * <code>uint32 Unk3250_MEEKFJJIOKE = 9;</code>
       * @param value The unk3250MEEKFJJIOKE to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250MEEKFJJIOKE(int value) {
        
        unk3250MEEKFJJIOKE_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250MEEKFJJIOKE() {
      ...
      /**
       * <code>uint32 Unk3250_PLFMJPNPPLI = 11;</code>
       * @param value The unk3250PLFMJPNPPLI to set.
       * @return This builder for chaining.
       */
      public Builder setUnk3250PLFMJPNPPLI(int value) {
        
        unk3250PLFMJPNPPLI_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearUnk3250PLFMJPNPPLI() {
  ...
  static {
    ...
    internal_static_FlightActivitySettleNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_FlightActivitySettleNotify_descriptor,
        new java.lang.String[] { "LeftTime", "TotalNum", "GroupId", "Score", "Unk3250MEEKFJJIOKE", "IsNewRecord", "IsSuccess", "Unk3250PLFMJPNPPLI", });
  }
